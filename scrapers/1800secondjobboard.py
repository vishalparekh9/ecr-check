...
# Token
token = '1800SECONDJOBBOARD'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://boards.greenhouse.io/1800secondjobboard/jobs/3856565'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/1800secondjobboard'

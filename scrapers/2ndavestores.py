...
#Token
token = '2NDAVESTORES'.upper()

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'http://www.2ndavestores.com/'
    ...
    def process_logic(self):
        try:
            jobid = ""
            cid = '0c9e0111-535a-4877-8260-50585d4ec006'
            icids = '614186161_14013'

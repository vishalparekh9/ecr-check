...
#Token
token = '360TRAINING'.upper()

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'http://www.360training.com/'
    ...
    def process_logic(self):
        try:
            jobid = ""
            cid = 'bd8bf7ff-547b-4c6a-99a3-b3dbe7d521d5'
            icids = '1586553139337957_5997'

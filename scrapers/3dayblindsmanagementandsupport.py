...
# Token
token = '3DAYBLINDSMANAGEMENTANDSUPPORT'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://boards.greenhouse.io/3dayblindsmanagementandsupport/jobs/4793828003'
        ...
        self.domain = '3dayblindsmanagementandsupport.com'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/3dayblindsmanagementandsupport'

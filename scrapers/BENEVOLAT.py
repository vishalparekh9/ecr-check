...
# Token
token = 'glassdoor.co.in'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = '"https://www.glassdoor.co.in/Overview/Working-at-B%C3%A9n%C3%A9volat-EI_IE1127036.11'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/BENEVOLAT'

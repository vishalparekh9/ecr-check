...
# Token
token = 'CHARLIECRISTFORGOVERNOR'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://jobs.lever.co/CharlieCristForGovernor'
    ...
    def process_logic(self):
        try:
            url = 'https://jobs.lever.co/CharlieCristForGovernor'

...
# Token
token = 'GREENERTECHNOLOGIES'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://jobs.lever.co/GreenerTechnologies'
        ...
        self.domain = 'greenertechnologies.com.au'
    ...
    def process_logic(self):
        try:
            url = 'https://jobs.lever.co/GreenerTechnologies'

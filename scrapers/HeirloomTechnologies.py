...
# Token
token = 'HEIRLOOMTECHNOLOGIES'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://jobs.lever.co/HeirloomTechnologies'
        ...
        self.domain = 'heirloomcarbon.com'
    ...
    def process_logic(self):
        try:
            url = 'https://jobs.lever.co/HeirloomTechnologies'

...
token = 'UNITED%20STATES&PLACEID=CHIJORY6NXUWJ4ARZ3B1NVL1HW4&FACETCITYSTATE=PALO%20ALTO'
class CRAWLER(object):
    def __init__(self):
        self.baseUrl = '"https://holmanautogroup.wd1.myworkdayjobs.com/HolmanAutoCareers?location=Palo%20Alto'

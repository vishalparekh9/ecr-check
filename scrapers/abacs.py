...
class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://behavioralconcepts-learnbehavioral.icims.com/jobs/search?ss=1&hashed=-435653992'
    ...
    def process_logic(self):
        try:
            jobid = ""
            url = 'https://behavioralconcepts-learnbehavioral.icims.com/jobs/search?pr=1&in_iframe=1'

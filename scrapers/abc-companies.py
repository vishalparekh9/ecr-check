...
class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://recruitingbypaycor.com/career/CareerHomeSearch.action?clientId=8a7883c66439e9820164811e5f356ab1'
        ...
        self.getHeaders = {
            ...
            'clientId': '8a7883c66439e9820164811e5f356ab1',
            'parentUrl': 'https://recruitingbypaycor.com/career/',
            'gns': '',
        }
        self.session = requests.session()
        self.domain = 'abc-companies.com'
    ...
    def process_logic(self):
        try:
            url = 'https://recruitingbypaycor.com/career/CareerHomeSearch.action?clientId=8a7883c66439e9820164811e5f356ab1&parentUrl=https%3A%2F%2Fwww.aauw.org%2Fabout%2Fcareers%2F&gns='

...
class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://abc-imaging.breezy.hr/'
    ...
    def process_logic(self):
        try:
            url = 'https://abc-imaging.breezy.hr/'
            ...
            if isloaded:
                ...
                if links:
                    for link in links:
                        ...
                        url = str("https://abc-imaging.breezy.hr") + str(link.find('a').get('href'))
                        jobObj['url'] = url

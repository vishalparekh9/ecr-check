...
#Token
token = 'ABILITYFIRST'.upper()

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'http://www.abilityfirst.org/businessservices.aspx'
        ...
        self.domain = 'abilityfirst.orgbusinessservices.aspx'
    ...
    def process_logic(self):
        try:
            jobid = ""
            cid = '09ecdf7e-8ae5-4e46-b084-be10d619828e'

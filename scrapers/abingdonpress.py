...
#Token
token = 'ABINGDONPRESS'.upper()

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.abingdonpress.com/'
    ...
    def process_logic(self):
        try:
            jobid = ""
            cid = '531a64bd-46dd-48a2-8bc7-433cf22426e9'
            icids = '9200007188921_2'

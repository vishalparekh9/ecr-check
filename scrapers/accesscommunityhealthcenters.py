...
#Token
token = 'ACCESSCOMMUNITYHEALTHCENTERS'.upper()

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://accesscommunityhealthcenters.org'
        ...
        self.domain = 'accesscommunityhealthcenters.org'
    ...
    def process_logic(self):
        try:
            jobid = ""
            cid = 'd0f8f767-6ad8-445b-93d9-fa577399cac9'

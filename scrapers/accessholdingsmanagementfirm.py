...
# Token
token = 'ACCESSHOLDINGSMANAGEMENTFIRM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.accessholdings.com/'
        ...
        self.domain = 'accessholdings.com'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/accessholdingsmanagementfirm'

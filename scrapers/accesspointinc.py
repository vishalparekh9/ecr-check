...
#Token
token = 'ACCESSPOINTINC'.upper()

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'http://www.accesspointinc.com'
        ...
        self.domain = 'accesspointinc.com'
    ...
    def process_logic(self):
        try:
            jobid = ""
            cid = 'f42453ed-f699-4435-8d04-39835e9969f3'
            icids = '1586553090674602_2977'

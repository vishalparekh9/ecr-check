...
# Token
token = 'ACHIEVERSEARLYCOLLEGEPREP'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://achieversecp.org/'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/achieversearlycollegeprep'

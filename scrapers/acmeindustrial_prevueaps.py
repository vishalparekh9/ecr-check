...
# Token
token = 'PREVUEAPS_ACMEINDUSTRIAL_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.acmeindustrial.com'
        ...
        self.domain = 'acmeindustrial.com'
    ...
    def process_logic(self):
        try:
            url = f'https://acmeindustrial.prevueaps.com/jobs/'
            print(url)

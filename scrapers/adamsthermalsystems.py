...
#Token
token = 'ADAMSTHERMALSYSTEMS'.upper()

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'http://adamsthermalsystems.com'
        ...
        self.domain = 'adamsthermalsystems.com'
    ...
    def process_logic(self):
        try:
            jobid = ""
            cid = '3a4de9fc-f1d2-44ed-8948-7226bde151a8'
            icids = '273829613796_5148'

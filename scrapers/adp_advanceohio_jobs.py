...
#Token
token = 'ADP_ADVANCEOHIO_JOBS'

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://recruiting.adp.com/srccar/public/RTI.home?c=2171807&d=AdvanceLocalExternalCareerSite&country=USA&state=OH' 

...
#Token
token = 'ADP_ASSOCIAONLINE_JOBS'

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://recruiting.adp.com/srccar/public/RTI.home?c=2174407&d=ExternalCareerSite?c=2174407&d=ExternalCareerSite' 

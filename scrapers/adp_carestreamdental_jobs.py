...
#Token
token = 'ADP_CARESTREAMDENTAL_JOBS'

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://recruiting.adp.com/srccar/public/RTI.home?c=2153813&d=ExternalCareerSite#/' 
        ...
        self.domain = 'carestreamdental.com'

...
#Token
token = 'ADP_CARLISLEIT_JOBS'

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://recruiting.adp.com/srccar/public/RTI.home?_fromPublish=true&c=1218401&d=ExternalCareerSite-CIT#/' 

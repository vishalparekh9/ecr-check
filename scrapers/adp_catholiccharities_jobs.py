...
#Token
token = 'ADP_CATHOLICCHARITIES_JOBS'

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://recruiting.adp.com/srccar/public/RTI.home?c=2172307&d=CCExternalCareerSite#/' 
        ...
        self.domain = 'catholiccharities.net'

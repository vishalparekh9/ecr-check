...
#Token
token = 'ADP_COMMONWEALTHCAREALLIANCE_JOBS'

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://recruiting.adp.com/srccar/public/RTI.home?c=1171951&d=ExternalCareerSite' 
        ...
        self.domain = 'commonwealthcarealliance.org'

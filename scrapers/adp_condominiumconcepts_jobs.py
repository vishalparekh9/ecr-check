...
#Token
token = 'ADP_CONDOMINIUMCONCEPTS_JOBS'

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://recruiting.adp.com/srccar/public/RTI.home?d=External&c=1143507&state=GA' 
        ...
        self.domain = 'condominiumconcepts.com'

...
#Token
token = 'ADP_CONNECTICUTCHILDRENS_JOBS'

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://recruiting.adp.com/srccar/public/RTI.home?d=External&c=1122041' 
        ...
        self.domain = 'connecticutchildrens.org'

...
#Token
token = 'ADP_CONVEYHEALTHSOLUTIONS_JOBS'

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://recruiting.adp.com/srccar/public/RTI.home?c=1154351&d=External' 
        ...
        self.domain = 'conveyhealthsolutions.com'

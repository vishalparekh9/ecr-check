...
#Token
token = 'ADP_CORALSPRINGSCHARTER_JOBS'

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://recruiting.adp.com/srccar/public/RTI.home?c=1166151&d=CharterSchoolsUSA' 
        ...
        self.domain = 'coralspringscharter.org'

...
#Token
token = 'ADP_CRYSTALROCK_JOBS'

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://recruiting.adp.com/srccar/public/RTI.home?d=DSServExternalCareerSite&c=1132807' 

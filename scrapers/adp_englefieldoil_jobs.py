...
#Token
token = 'ADP_ENGLEFIELDOIL_JOBS'

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://recruiting.adp.com/srccar/public/RTI.home?c=1160251&d=ExternalCareerSiteEnglefieldDuchess' 

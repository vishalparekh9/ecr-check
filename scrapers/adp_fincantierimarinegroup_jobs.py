...
#Token
token = 'ADP_FINCANTIERIMARINEGROUP_JOBS'

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://recruiting.adp.com/srccar/public/RTI.home?c=2155013&d=FMG-External' 
        ...
        self.domain = 'fincantierimarinegroup.com'

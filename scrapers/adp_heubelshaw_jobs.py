...
#Token
token = 'ADP_HEUBELSHAW_JOBS'

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://recruiting.adp.com/srccar/public/RTI.home?d=HeubelShawExternalCareerCenter&c=1127807' 

...
# Token
token = 'ADVANCEDNAVIGATION'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://jobs.lever.co/advancednavigation'
        ...
        self.domain = 'advancednavigation.com'
    ...
    def process_logic(self):
        try:
            url = 'https://jobs.lever.co/advancednavigation'

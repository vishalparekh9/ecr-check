...
#Token
token = 'ADVANTAGEENGINEERS'.upper()

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'http://advantageengineers.com'
        ...
        self.domain = 'advantageengineers.com'
    ...
    def process_logic(self):
        try:
            jobid = ""
            cid = '0598372e-6ebf-42a5-b9ce-8212cf904745'
            icids = '9151571472759_2'

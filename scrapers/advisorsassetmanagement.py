...
# Token
token = 'ADVISORSASSETMANAGEMENT'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://recruitingbypaycor.com/career/CareerHomeSearch.action?clientId=8acda11036822040013683632b6b2a43'
        ...
        self.getHeaders = {
            ...
            'clientId': '8acda11036822040013683632b6b2a43',
            'parentUrl': 'https://recruitingbypaycor.com/career/',
            'gns': '',
        }
        self.session = requests.session()
        self.domain = 'aamlive.com'
    ...
    def process_logic(self):
        try:
            url = 'https://recruitingbypaycor.com/career/CareerHomeSearch.action?clientId=8acda11036822040013683632b6b2a43'

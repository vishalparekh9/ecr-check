...
#Token
token = 'AGILITYFUELSOLUTIONS'.upper()

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'http://www.agilityfuelsolutions.com/'
        ...
        self.domain = 'agilityfuelsolutions.com'
    ...
    def process_logic(self):
        try:
            jobid = ""
            cid = 'd39efbae-97cc-43b1-90e7-38605da59969'

...
token = 'AGILITYRECOVERY'

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://agilityrecovery.bamboohr.com/jobs/embed2.php?version=1.0.0'
        ...
        self.domain = 'agilityrecovery.com'
    ...
    def process_logic(self):
        try:
            url = 'https://agilityrecovery.bamboohr.com/jobs/embed2.php?version=1.0.0'

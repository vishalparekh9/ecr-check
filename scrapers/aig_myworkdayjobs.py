...
# Token
token = 'AIG_WORKDAY_JOBS_CAREER_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://aig.wd1.myworkdayjobs.com/wday/cxs/aig/aig/jobs'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://aig.wd1.myworkdayjobs.com/wday/cxs/aig/aig/jobs'
                ...
                if isloaded:
                    ...
                    if len(data) > 0:
                        for rd in data:
                            ...
                            url = "https://aig.wd1.myworkdayjobs.com/en-US/aig" + str(rd['externalPath'])
                            jobObj['url'] = url

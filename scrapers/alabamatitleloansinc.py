...
# Token
token = 'ALABAMATITLELOANSINC'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.alabamatitleloans.net/'
        ...
        self.domain = 'alabamatitleloans.net'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/alabamatitleloansinc'

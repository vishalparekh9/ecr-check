...
# Token
token = 'ALCON_WORKDAY_JOBS_CAREER_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://alcon.wd5.myworkdayjobs.com/careers_alcon'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://alcon.wd5.myworkdayjobs.com/wday/cxs/alcon/careers_alcon/jobs'
                ...
                if isloaded:
                    ...
                    if len(data) > 0:
                        for rd in data:
                            ...
                            url = "https://alcon.wd5.myworkdayjobs.com/careers_alcon" + str(rd['externalPath'])
                            jobObj['url'] = url

...
# Token
token = 'ALERTEMS_PAYCOMONLINE'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.alertems.com'
    ...
    def process_logic(self):
        try:
            url = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=E4164746693CC0E7C756460019655143#'

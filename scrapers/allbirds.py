...
class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.allbirds.com'
    ...
    def process_logic(self):
        try:
            url = 'https://boards-api.greenhouse.io/v1/boards/allbirds/jobs'
                    ...
                    for data in res.json()["jobs"]:
                        if data:
                            ...
                            if 'gh_jid=' in str(url):
                                isloaded, res = self.get_request('https://boards.greenhouse.io/embed/job_app?for=allbirds&token='+str(url).split('gh_jid=')[1])
                                ...
                                isloaded, res = self.get_request \
                                    ('https://boards.greenhouse.io/embed/job_app?for=allbirds&token='+str(url).split('/jobs/')[1])

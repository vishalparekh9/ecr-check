...
# Token
token = 'ALLBIRDSREFERRALS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://boards.greenhouse.io/allbirdsreferrals'
        ...
        self.domain = 'allbirdsreferrals.com'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/allbirdsreferrals'

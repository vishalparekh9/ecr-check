...
# Token
token = 'ALLENINTEGRATEDSOLUTIONS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.allenintegratedsolutions.com/'
        ...
        self.domain = 'allenintegratedsolutions.com'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/allenintegratedsolutions'

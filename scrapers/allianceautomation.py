...
token = 'ALLIANCEAUTOMATION'

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://allianceautomation.com/careers/'
        ...
        self.domain = 'allianceautomation.com'
    ...
    def process_logic(self):
        try:
            url = 'https://allianceautomation.bamboohr.com/jobs/embed2.php?version=1.0.0'

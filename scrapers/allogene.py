...
class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://careers.jobscore.com/careers/allogene' 
            ...
            if isloaded:
                ...
                for link in spanTag:
                    ...
                    if isloaded:
                        ...
                        jobObj['location'] = str(jobDetails.find('h2',{'class':'js-subtitle'}).text.split('|')[1].strip())
                        jobObj['description'] = str(jobDetails.find('div',{'class':'js-area-container js-section-job-description'}))

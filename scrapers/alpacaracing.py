...
class CRAWLER(object):
    def __init__(self):
        self.baseUrl = '"https://www.glassdoor.co.in/Overview/Working-at-Alpaca-Racing-EI_IE1775008.11'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/alpacaracing'

...
# Token
token = 'ALPHASIGHTSRESUMEDROP'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://boards.greenhouse.io/alphasightsresumedrop/jobs/3376819'
        ...
        self.domain = 'alphasightsresumedrop.com'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/alphasightsresumedrop'

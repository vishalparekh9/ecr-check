...
# Token
token = 'ALTALANGUAGESERVICESINC'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://recruitingbypaycor.com/career/CareerHomeSearch.action?clientId=8a7883d06a9aaadd016a9e0cbdea0501'
    ...
    def process_logic(self):
        try:
            url = 'https://recruitingbypaycor.com/career/CareerHomeSearch.action?clientId=8a7883d06a9aaadd016a9e0cbdea0501'

...
token = 'ALZHEIMERSCOMMUNITYCARE'

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://alzheimerscommunitycare.bamboohr.com/jobs/embed2.php?version=1.0.0'
        ...
        self.domain = 'alzheimerscommunitycare.com'
    ...
    def process_logic(self):
        try:
            url = 'https://alzheimerscommunitycare.bamboohr.com/jobs/embed2.php?version=1.0.0'

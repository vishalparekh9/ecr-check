...
# Token
token = 'AMAZON_CAREER_ANNAPURNA_LABS_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://annapurnalabs.com'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://www.amazon.jobs/en-gb/search.json?radius=24km&facets[]=normalized_country_code&facets[]=normalized_state_name&facets[]=normalized_city_name&facets[]=location&facets[]=business_category&facets[]=category&facets[]=schedule_type_id&facets[]=employee_class&facets[]=normalized_location&facets[]=job_function_id&facets[]=is_manager&facets[]=is_intern&offset={page}&result_limit=100&sort=recent&latitude=&longitude=&loc_group_id=&loc_query=&base_query=annapurna&city=&country=&region=&county=&query_options=&'

...
# Token
token = 'AMAZON_CAREER_ROBOTICS_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://amazonrobotics.com'
        ...
        self.domain = 'amazonrobotics.com'

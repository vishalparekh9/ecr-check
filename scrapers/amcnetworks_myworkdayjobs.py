...
# Token
token = 'AMC_NETWORKS_WORKDAY_JOBS_CAREER_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://amcn.wd5.myworkdayjobs.com/amcnetworks'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://amcn.wd5.myworkdayjobs.com/wday/cxs/amcn/amcnetworks/jobs'
                ...
                if isloaded:
                    ...
                    if len(data) > 0:
                        for rd in data:
                            ...
                            url = "https://amcn.wd5.myworkdayjobs.com/amcnetworks" + str(rd['externalPath'])
                            jobObj['url'] = url

...
#Token
token = 'AMERICANBUSINESSBANK'.upper()

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'http://americanbusinessbank.com'
        ...
        self.domain = 'americanbusinessbank.com'
    ...
    def process_logic(self):
        try:
            jobid = ""
            cid = '73636650-7d68-438a-ab70-e68cd3ec560d'

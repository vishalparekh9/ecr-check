...
# Token
token = 'AMERICANHORIZONFINANCIAL'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.linkedin.com/company/american-horizon-financial-llc'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/americanhorizonfinancial'

...
#Token
token = 'AMERICANPETROLEUMINSTITUTE'.upper()

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'http://www.americanpetroleuminstitute.com'
        ...
        self.domain = 'americanpetroleuminstitute.com'
    ...
    def process_logic(self):
        try:
            jobid = ""
            cid = '1a24f36f-f740-4396-81f5-7319e3dee147'

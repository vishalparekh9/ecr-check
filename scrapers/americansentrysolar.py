...
#Token
token = 'AMERICANSENTRYSOLAR'.upper()

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'http://www.americansentrysolar.com'
        ...
        self.domain = 'americansentrysolar.com'
    ...
    def process_logic(self):
        try:
            jobid = ""
            cid = '937f2820-2935-4aa9-b06e-a731bfb812ae'

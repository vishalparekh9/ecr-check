...
# Token
token = 'AMERICANVETERINARYGROUP'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://jobs.lever.co/americanveterinarygroup'
        ...
        self.domain = 'americanveterinarygroup.com'
    ...
    def process_logic(self):
        try:
            url = 'https://jobs.lever.co/americanveterinarygroup'

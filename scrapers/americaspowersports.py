...
#Token
token = 'AMERICASPOWERSPORTS'.upper()

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'http://www.americaspowersports.com'
        ...
        self.domain = 'americaspowersports.com'
    ...
    def process_logic(self):
        try:
            jobid = ""
            cid = '9fcb17a8-9a07-49d5-931e-d9032d281313'

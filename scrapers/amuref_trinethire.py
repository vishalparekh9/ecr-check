...
# Token
token = 'JOB_BOARD_TRINETHIRE_AMUREF_CAREER_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://amuref.com/'
    ...
    def process_logic(self):
        try:
            url = f'https://app.trinethire.com/companies/6805-amur-equipment-finance/jobs'

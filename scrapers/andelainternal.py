...
# Token
token = 'ANDELAINTERNAL'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://remoteful.dev/remote_companies/andelainternal'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/andelainternal'

...
# Token
token = 'APPLICANT_PRO_CLEARSPRINGS_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://clearsprings.com/'
    ...
    def process_logic(self):
        try:
            url = 'https://www.applicantpro.com/openings/clearsprings/jobs'

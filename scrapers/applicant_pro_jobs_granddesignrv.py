...
# Token
token = 'APPLICANT_PRO_GRANDDESIGNRV_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://granddesignrv.com/'
    ...
    def process_logic(self):
        try:
            url = 'https://www.applicantpro.com/openings/granddesignrv/jobs'

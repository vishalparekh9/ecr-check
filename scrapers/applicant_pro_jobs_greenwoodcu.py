...
# Token
token = 'APPLICANT_PRO_GREENWOODCU_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://greenwoodcu.org/'
    ...
    def process_logic(self):
        try:
            url = 'https://www.applicantpro.com/openings/greenwoodcu/jobs'

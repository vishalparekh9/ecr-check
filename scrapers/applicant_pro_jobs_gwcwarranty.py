...
# Token
token = 'APPLICANT_PRO_GWCWARRANTY_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://gwcwarranty.com/'
    ...
    def process_logic(self):
        try:
            url = 'https://www.applicantpro.com/openings/gwcwarranty/jobs'

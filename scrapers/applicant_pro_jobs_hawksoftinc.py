...
# Token
token = 'APPLICANT_PRO_HAWKSOFTINC_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://hawksoftinc.com/'
    ...
    def process_logic(self):
        try:
            url = 'https://www.applicantpro.com/openings/hawksoftinc/jobs'

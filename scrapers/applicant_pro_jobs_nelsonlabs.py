...
# Token
token = 'APPLICANT_PRO_NELSONLABS_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://gibraltarlabsinc.com/'
        ...
        self.domain = 'gibraltarlabsinc.com'
    ...
    def process_logic(self):
        try:
            url = 'https://www.applicantpro.com/openings/nelsonlabs/jobs'

...
# Token
token = 'APPLICANT_PRO_SYMPLR_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://healthcaresource.com/'
        ...
        self.domain = 'healthcaresource.com'
    ...
    def process_logic(self):
        try:
            url = 'https://www.applicantpro.com/openings/symplr/jobs'

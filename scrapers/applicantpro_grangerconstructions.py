...
# Token
token = 'GANGER_CONSTRUCTIONS_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://grangerconstruction.com/'
        ...
        self.domain = 'grangerconstruction.com'
    ...
    def process_logic(self):
        try:
            url = 'https://www.applicantpro.com/openings/grangerconstruction/jobs'

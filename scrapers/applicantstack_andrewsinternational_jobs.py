...
#Token
token = 'APPLICANTSTACK_ANDREWSINTERNATIONAL_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://andrewsinternational.applicantstack.com/x/allopenings' 
        ...
        self.domain = 'andrewsinternational.com'

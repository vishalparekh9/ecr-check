...
#Token
token = 'APPLICANTSTACK_BLUEEAGLECREDITUNION_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://blueeaglecreditunion.applicantstack.com/x/openings' 
        ...
        self.domain = 'blueeaglecreditunion.com'

...
#Token
token = 'APPLICANTSTACK_CLEVELANDCONSTRUCTION_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://clevelandconstruction.applicantstack.com/x/openings' 
        ...
        self.domain = 'clevelandconstruction.com'

...
# Token
token = 'APPLYTOJOB_BSIENGR_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://recruitingbypaycor.com/career/CareerHomeSearch.action?clientId=8a7883d07c195425017c3cff266e0c46'
        ...
        self.getHeaders = {
            ...
            'clientId': '8a7883d07c195425017c3cff266e0c46',
            'parentUrl': 'https://recruitingbypaycor.com/career/',
            'gns': '',
        }
        self.session = requests.session()
        self.domain = 'bsiengr.com'
    ...
    def process_logic(self):
        try:
            url = 'https://recruitingbypaycor.com/career/CareerHomeSearch.action?clientId=8a7883d07c195425017c3cff266e0c46'

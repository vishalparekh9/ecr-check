...
# Token
token = 'APPLYTOJOB_FOCAL_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.focal.systems/'
    ...
    def process_logic(self):
        try:
            url = 'https://boards-api.greenhouse.io/v1/boards/' + str("focalsystems") + '/jobs'
                        ...
                        if data:
                            ...
                            if 'gh_jid=' in str(url):
                                isloaded, res = self.get_request(
                                    'https://boards.greenhouse.io/embed/job_app?for=focalsystems&token=' +
                                    str(url).split('gh_jid=')[1])

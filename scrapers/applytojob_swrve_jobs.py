...
token = 'APPLYTOJOB_SWRVE_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://apply.workable.com/swrve/'
        ...
        try:
            ...
            if isloaded:
                ...
                while True:
                    ...
                    url = 'https://apply.workable.com/api/v3/accounts/swrve/jobs'
                    params = '{"token":"' + str(

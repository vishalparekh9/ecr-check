...
# Token
token = 'ARCHETYPEENTERTAINMENT'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.archetype-entertainment.com/'
        ...
        self.domain = 'archetype-entertainment.com'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/archetypeentertainment'

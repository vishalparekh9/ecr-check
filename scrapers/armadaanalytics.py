...
#Token
token = 'ARMADAANALYTICS'.upper()

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'http://www.armadaanalytics.com/'
        ...
        self.domain = 'armadaanalytics.com'
    ...
    def process_logic(self):
        try:
            jobid = ""
            cid = '37090890-1b3b-4d0c-9365-d0fd8ec1a522'
            icids = '168104388410_3140'

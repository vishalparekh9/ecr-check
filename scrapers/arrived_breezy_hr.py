...
token = 'ARRIVED_HOMES_BREEZY_HR_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://arrived.breezy.hr/'
            ...
            if isloaded:
                ...
                if links:
                    for link in links:
                        ...
                        url = str("https://arrived.breezy.hr") + str(link.find('a').get('href'))
                        jobObj['url'] = url

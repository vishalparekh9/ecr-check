...
token = 'ASCENT_ROBOTICS_AI_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://ascent-robotics.breezy.hr/'
    ...
    def process_logic(self):
        try:
            url = 'https://ascent-robotics.breezy.hr/'
            ...
            if isloaded:
                ...
                if links:
                    for link in links:
                        ...
                        url = str("https://ascent-robotics.breezy.hr") + str(link.find('a').get('href'))
                        jobObj['url'] = url

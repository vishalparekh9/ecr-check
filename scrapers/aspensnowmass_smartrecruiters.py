...
# Token
token = 'SMARTRECRUITERS_ASPEN_SKIING_COMPNY_JOBS'.upper()


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.smartrecruiters.com/job-api/public/search/widgets/AspenSkiingCompany/postings?&offset=0&limit=5000&langCode=en&callback=jQuery321039221376362208304_1646217716102&_=1646217716103'
            ...
            if isloaded:
                ...
                if jsonText:
                    for vacancies in jsonText['results']:
                        ...
                        url = 'https://www.smartrecruiters.com/AspenSkiingCompany/' + str(vacancies['publicationId']) + str(

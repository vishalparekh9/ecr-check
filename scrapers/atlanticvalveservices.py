...
# Token
token = 'ATLANTICVALVESERVICES'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://atlanticvalveservices.com/'
        ...
        self.domain = 'atlanticvalveservices.com'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/atlanticvalveservices'

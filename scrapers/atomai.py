...
class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.dnb.com/business-directory/company-profiles.atomai_inc.de88ec031b78aaf90fee5f89bfd24027.html'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/atomai'

...
# Token
token = 'AUTISM_SOCIETY_PAYCOMONLINE'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.autismsociety-nc.org'
        ...
        self.domain = 'autismsociety-nc.org'
    ...
    def process_logic(self):
        try:
            url = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=910368C17DEF8C14035722D5EDA716E3#'

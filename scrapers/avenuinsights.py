...
#Token
token = 'AVENUINSIGHTS'.upper()

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.avenuinsights.com/'
    ...
    def process_logic(self):
        try:
            jobid = ""
            cid = '56dad57d-81b7-4889-9f75-7ef29807fa05'
            icids = '1990797403_6352'

...
# Token
token = 'AVOCADOSFROMMEXICO'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://jobs.lever.co/avocadosfrommexico'
        ...
        self.domain = 'avocadosfrommexico.com'
    ...
    def process_logic(self):
        try:
            url = 'https://jobs.lever.co/avocadosfrommexico'

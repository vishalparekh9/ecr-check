...
token = 'AXISHEALTHSYSTEM'

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://axishealthsystem.bamboohr.com/jobs/embed2.php?version=1.0.0'
        ...
        self.domain = 'axishealthsystem.com'
    ...
    def process_logic(self):
        try:
            url = 'https://axishealthsystem.bamboohr.com/jobs/embed2.php?version=1.0.0'

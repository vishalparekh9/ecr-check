...
# Token
token = 'AZUREOFPALMCOAST'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://m.facebook.com/TheAzurePalmCoast/reviews/'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/azureofpalmcoast'

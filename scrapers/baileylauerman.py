...
token = 'BAILEYLAUERMAN'

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://baileylauerman.bamboohr.com/jobs/embed2.php?version=1.0.0'
        ...
        self.domain = 'baileylauerman.com'
    ...
    def process_logic(self):
        try:
            url = 'https://baileylauerman.bamboohr.com/jobs/embed2.php?version=1.0.0'

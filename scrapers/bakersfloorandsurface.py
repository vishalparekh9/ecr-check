...
# Token
token = 'BAKERSFLOORANDSURFACE'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://jobs.lever.co/bakersfloorandsurface'
        ...
        self.domain = 'bakersfloorandsurface.com'
    ...
    def process_logic(self):
        try:
            url = 'https://jobs.lever.co/bakersfloorandsurface'

...
token = 'BANDERAELECTRIC'

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://banderaelectric.bamboohr.com/jobs/embed2.php?version=1.0.0'
        ...
        self.domain = 'banderaelectric.com'
    ...
    def process_logic(self):
        try:
            url = 'https://banderaelectric.bamboohr.com/jobs/embed2.php?version=1.0.0'

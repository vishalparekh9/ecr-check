...
# Token
token = 'BARDELBOOTCAMP'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.linkedin.com/posts/diwakar-gandhi-ba707053_bardelvibes-workatbardel-bardelbootcamp-activity-6870051533942345728-qeMu'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/bardelbootcamp'

...
# Token
token = 'BATTLVICTORYRECORDS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://battl-victory-records.com/'
        ...
        self.domain = 'battl-victory-records.com'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/battlvictoryrecords'

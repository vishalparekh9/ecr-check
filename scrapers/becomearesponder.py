...
# Token
token = 'BECOMEARESPONDER'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://respondology.com/become-a-responder/'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/becomearesponder'

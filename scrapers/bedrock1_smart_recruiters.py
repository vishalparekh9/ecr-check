...
# Token
token = 'SMARTRECRUITERS_BEDROCK1_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.smartrecruiters.com/job-api/public/search/widgets/Bedrock1/postings?&offset=0&limit=5000&langCode=en&callback=jQuery321039221376362208304_1646217716102&_=1646217716103'
        ...
        self.domain = 'bedrockspecialprojects.com'
            ...
            if isloaded:
                ...
                if jsonText:
                    for vacancies in jsonText['results']:
                        ...
                        url = 'https://www.smartrecruiters.com/Bedrock1/' + str(vacancies['publicationId']) + str(

...
# Token
token = 'INFORCLOUDSUITE_BENCHMARK'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://css-benchmark-prd.inforcloudsuite.com/hcm/CandidateSelfService/controller.servlet?dataarea=hcm&context.session.key.HROrganization=1&context.session.key.JobBoard=EXTERNAL&context.session.key.noheader=True#'
    ...
    def process_logic(self):
        try:
            url = f'https://css-benchmark-prd.inforcloudsuite.com/hcm/soapExt/ldrest/JobPosting/JobPostingListWebServices_ListOperation?_clientType=INTERNAL&JobBoard=EXTERNAL&LocationOfJob=+&Category=+&SubCategory=+&WorkType=+&JobRequisition=+&__Description_translation___=+&JobPosting=+&PostingStatus=2&PostingDateRange.Begin=+&PostingDateRange.End=+&JobRequisitionPriority=+&csk.IsoLocale=en&HROrganization=1&_limit=-1&AtApplicationLimit=+&_=1650210261136'
            print(url)

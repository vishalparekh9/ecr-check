...
# Token
token = 'BENSONINTEGRATEDMARKETINGSOLUTIONS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://recruitingbypaycor.com/career/CareerHomeSearch.action?clientId=8a788267574b28b701574ecf6d140298'
    ...
    def process_logic(self):
        try:
            url = 'https://recruitingbypaycor.com/career/CareerHomeSearch.action?clientId=8a788267574b28b701574ecf6d140298'

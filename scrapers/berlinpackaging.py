...
token = 'BERLINPACKAGING'

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://berlinpackaging.bamboohr.com/jobs/embed2.php?version=1.0.0'
        ...
        self.domain = 'berlinpackaging.com'
    ...
    def process_logic(self):
        try:
            url = 'https://berlinpackaging.bamboohr.com/jobs/embed2.php?version=1.0.0'

...
# Token
token = 'E3APPLICANTS_BERTNASH_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.bertnash.org'
    ...
    def process_logic(self):
        try:
            url = f'https://bertnash.e3applicants.com/careers/'
            print(url)
                ...
                if len(links) > 0:
                    for link in links:
                        try:
                            ...
                            url = "https://bertnash.e3applicants.com" + str(link.find("a").get("href"))

...
# Token
token = 'BERTRAMCAPITALMANAGEMENT'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.bertramcapital.com/'
        ...
        self.domain = 'bertramcapital.com'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/bertramcapitalmanagement'

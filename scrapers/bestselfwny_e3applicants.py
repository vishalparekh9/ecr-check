...
# Token
token = 'E3APPLICANTS_BESTSELFWNY_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.bestselfwny.org'
    ...
    def process_logic(self):
        try:
            url = f'https://bestselfwny.e3applicants.com/careers/'
            print(url)
                ...
                if len(links) > 0:
                    for link in links:
                        try:
                            ...
                            url = "https://bestselfwny.e3applicants.com" + str(link.find("a").get("href"))

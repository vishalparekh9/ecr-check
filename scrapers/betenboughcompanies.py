...
# Token
token = 'BETENBOUGHCOMPANIES'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://betenboughcompanies.com/'
        ...
        self.domain = 'betenboughcompanies.com'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/betenboughcompanies'

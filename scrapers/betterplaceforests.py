...
# Token
token = 'BETTERPLACEFORESTS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://jobs.lever.co/betterplaceforests'
        ...
        self.domain = 'betterplaceforests.com'
    ...
    def process_logic(self):
        try:
            url = 'https://jobs.lever.co/betterplaceforests'

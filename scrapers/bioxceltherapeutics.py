...
# Token
token = 'BIOXCELTHERAPEUTICS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://jobs.lever.co/bioxceltherapeutics'
        ...
        self.domain = 'bioxceltherapeutics.com'
    ...
    def process_logic(self):
        try:
            url = 'https://jobs.lever.co/bioxceltherapeutics'

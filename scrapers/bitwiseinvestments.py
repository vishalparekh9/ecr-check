...
# Token
token = 'BITWISEINVESTMENTS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://jobs.lever.co/bitwiseinvestments'
        ...
        self.domain = 'bitwiseinvestments.com'
    ...
    def process_logic(self):
        try:
            url = 'https://jobs.lever.co/bitwiseinvestments'

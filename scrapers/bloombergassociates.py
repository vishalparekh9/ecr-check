...
# Token
token = 'BLOOMBERGASSOCIATES'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://associates.bloomberg.org/'
        ...
        self.domain = 'associates.bloomberg.org'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/bloombergassociates'

...
# Token
token = 'BLUECRESTCAPITALMANAGEMENT'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://en.wikipedia.org/wiki/BlueCrest_Capital_Management'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/bluecrestcapitalmanagement'

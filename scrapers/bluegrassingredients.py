...
#Token
token = 'BLUEGRASSINGREDIENTS'.upper()

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'http://bluegrassingredients.com'
        ...
        self.domain = 'bluegrassingredients.com'
    ...
    def process_logic(self):
        try:
            jobid = ""
            cid = 'b444cd72-03d5-44e1-ab6b-e30db4528ae6'
            icids = '9200021686968_2'

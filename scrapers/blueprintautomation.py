...
#Token
token = 'BLUEPRINTAUTOMATION'.upper()

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'http://www.blueprintautomation.com'
        ...
        self.domain = 'blueprintautomation.com'
    ...
    def process_logic(self):
        try:
            jobid = ""
            cid = '34cc7251-678b-48e8-91b6-b7bcb25a0726'

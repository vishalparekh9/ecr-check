...
# Token
token = 'BOTTLEROCKETSTUDIOS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://jobs.lever.co/bottlerocketstudios'
        ...
        self.domain = 'bottlerocketstudios.com'
    ...
    def process_logic(self):
        try:
            url = 'https://jobs.lever.co/bottlerocketstudios'

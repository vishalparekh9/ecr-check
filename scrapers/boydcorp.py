...
class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://boydcorp.jibeapply.com/working-here/jobs'
        ...
        self.domain = 'boydcorp.jibeapply.com'
    ...
    def process_logic(self):
        try:
            jobid = ""
            url = 'https://boydcorp.jibeapply.com/api/jobs?page=1'
            isloaded, res = self.get_request(url)
            if isloaded:
                pages = res.json()['totalCount']
                isdata = True
                for page in range(1, pages):
                    url = 'https://boydcorp.jibeapply.com/api/jobs?page='+str(page)+''

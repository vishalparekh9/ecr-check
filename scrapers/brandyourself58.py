...
# Token
token = 'BRANDYOURSELF58'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://boards.greenhouse.io/brandyourself58/jobs/4381393004'
        ...
        self.domain = 'brandyourself58.com'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/brandyourself58'

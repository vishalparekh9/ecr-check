...
# Token
token = 'BREAKTHROUGHENERGY38'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://boards.greenhouse.io/breakthroughenergy38/jobs/4179830004'
        ...
        self.domain = 'breakthroughenergy38.com'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/breakthroughenergy38'

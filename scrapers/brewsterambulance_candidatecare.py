...
# Token
token = 'CANDIDATE_CARE_JOBS_BREWSTERAMBULANCE'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.brewsterambulance.com'
        ...
        self.domain = 'brewsterambulance.com'
    ...
    def process_logic(self):
        try:
            url = f'https://brewsterambulance.candidatecare.jobs/job_positions/browse'
            print(url)

...
# Token
token = 'E3APPLICANTS_BHR_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.bhr.org'
    ...
    def process_logic(self):
        try:
            url = f'https://bhr.e3applicants.com/careers/'
            print(url)
                ...
                if len(links) > 0:
                    for link in links:
                        try:
                            ...
                            url = "https://bhr.e3applicants.com" + str(link.find("a").get("href"))

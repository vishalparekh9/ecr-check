...
# Token
token = 'BROADWAYTECHNOLOGY'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://jobs.lever.co/broadwaytechnology'
        ...
        self.domain = 'broadwaytechnology.com'
    ...
    def process_logic(self):
        try:
            url = 'https://jobs.lever.co/broadwaytechnology'

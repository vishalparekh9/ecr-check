...
class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://brocktec.bamboohr.com/jobs/embed2.php?version=1.0.0'
    ...
    def process_logic(self):
        try:
            url = 'https://brocktec.bamboohr.com/jobs/embed2.php?version=1.0.0'

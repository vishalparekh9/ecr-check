...
# Token
token = 'BROOKFIELDPROPERTIES'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.brookfieldproperties.com/en.html'
        ...
        self.domain = 'brookfieldproperties.com'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/brookfieldproperties'

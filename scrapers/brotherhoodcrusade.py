...
# Token
token = 'BROTHERHOODCRUSADE'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://jobs.lever.co/brotherhoodcrusade'
        ...
        self.domain = 'brotherhoodcrusade.org'
    ...
    def process_logic(self):
        try:
            url = 'https://jobs.lever.co/brotherhoodcrusade'

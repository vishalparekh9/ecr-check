...
# Token
token = 'BTSECONDARYBOARD'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://boards.greenhouse.io/btsecondaryboard/jobs/4726745003'
        ...
        self.domain = 'btsecondaryboard.com'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/btsecondaryboard'

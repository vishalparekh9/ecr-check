...
token = 'CALCASIEULIBRARY'

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://calcasieulibrary.bamboohr.com/jobs/embed2.php?version=1.0.0'
        ...
        self.domain = 'calcasieulibrary.com'
    ...
    def process_logic(self):
        try:
            url = 'https://calcasieulibrary.bamboohr.com/jobs/embed2.php?version=1.0.0'

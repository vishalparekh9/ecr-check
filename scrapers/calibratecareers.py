...
# Token
token = 'CALIBRATECAREERS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://boards.greenhouse.io/calibratecareers'
        ...
        self.domain = 'calibratecareers.com'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/calibratecareers'

...
#Token
token = 'CALIFORNIAFAMILYFITNESS'.upper()

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'http://www.californiafamilyfitness.com/'
        ...
        self.domain = 'californiafamilyfitness.com'
    ...
    def process_logic(self):
        try:
            jobid = ""
            cid = '81cac7da-bc9d-43ea-9cbc-23ef7a366931'

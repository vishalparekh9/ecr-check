...
# Token
token = 'CALIFORNIAPSYCHICS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.californiapsychics.com/'
        ...
        self.domain = 'californiapsychics.com'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/californiapsychics'

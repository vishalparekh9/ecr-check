...
class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://us61e2.dayforcehcm.com/CandidatePortal/en-US/calumet?'
        ...
        self.domain = 'calumetspecialty.com'
        ...
        try:
            ...
            while isPage:
                ...
                isloaded, res = self.get_request(
                    f'https://us61e2.dayforcehcm.com/CandidatePortal/en-US/calumet?page={page}')
                if isloaded:

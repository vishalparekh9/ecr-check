...
# Token
token = 'CAMBIUMNETWORKS_LEVER_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://jobs.lever.co/cambiumnetworks'
        ...
        self.domain = 'cambiumnetworks.com'
    ...
    def process_logic(self):
        try:
            url = 'https://jobs.lever.co/cambiumnetworks'

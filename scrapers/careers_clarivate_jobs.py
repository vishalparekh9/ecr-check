...
# Token
token = 'CLARIVATE_WORKDAY_JOBS_CAREER_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.clarivate.com'
                    ...
                    if len(data) > 0:
                        for rd in data:
                            try:
                                ...
                                url = "https://clarivate.wd3.myworkdayjobs.com/en-US/Clarivate_Careers" + str(
                                    rd['externalPath'])
                                print(url)
                                jobObj['url'] = url

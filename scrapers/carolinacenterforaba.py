...
# Token
token = 'CAROLINACENTERFORABA'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://jobs.lever.co/carolinacenterforaba'
        ...
        self.domain = 'CarolinaCenterForABA.com'
    ...
    def process_logic(self):
        try:
            url = 'https://jobs.lever.co/carolinacenterforaba'

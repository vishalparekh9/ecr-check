...
# Token
token = 'CAROLINAPAYDAYLOANSINC'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://carolinapaydayloansinc.com/'
        ...
        self.domain = 'carolinapaydayloansinc.com'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/carolinapaydayloansinc'

...
#Token
token = 'CARTAMUNDIUSA'.upper()

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'http://cartamundiusa.com'
    ...
    def process_logic(self):
        try:
            jobid = ""
            cid = 'c5000cfb-6829-49c4-a140-83fac296ce02'
            icids = '1586553192490536_503'

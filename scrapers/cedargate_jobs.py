...
# Token
token = 'CEDARGATE_PAYCOMONLINE'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.cedargate.com'
    ...
    def process_logic(self):
        try:
            url = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=F93B786E10C9962CD9786556B8F5FEA1#'

...
# Token
token = 'CENTRALTEXASFOODBANK'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://jobs.lever.co/centraltexasfoodbank'
        ...
        self.domain = 'centraltexasfoodbank.org'
    ...
    def process_logic(self):
        try:
            url = 'https://jobs.lever.co/centraltexasfoodbank'

...
# Token
token = 'CENTRIBUSINESSCONSULTING'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://centriconsulting.com/'
        ...
        self.domain = 'centriconsulting.com'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/centribusinessconsulting'

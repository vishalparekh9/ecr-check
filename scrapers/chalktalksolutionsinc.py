...
# Token
token = 'CHALKTALKSOLUTIONSINC'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.crunchbase.com/organization/chalk-talk-solutions-inc'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/chalktalksolutionsinc'

...
# Token
token = 'CHARLESANDLYNNSHUSTERMANFAMILYFOUNDATION'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.schusterman.org/'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/charlesandlynnshustermanfamilyfoundation'

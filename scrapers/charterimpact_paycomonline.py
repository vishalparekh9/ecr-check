...
# Token
token = 'CHARTER_IMPACT_PAYCOMONLINE'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.charterimpact.com'
    ...
    def process_logic(self):
        try:
            url = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=074E578385B7E8C5568C24D842FC1684#'

...
#Token
token = 'CHARTEROAKCOMMUNITIES'.upper()

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://charteroakcommunities.org/'
        ...
        self.domain = 'charteroakcommunities.org'
    ...
    def process_logic(self):
        try:
            jobid = ""
            cid = '8fb55b8a-9b7f-417a-868f-da1932a8dbd3'

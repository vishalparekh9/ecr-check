...
class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.hfma.org/education-and-events/certifications/certified-healthcare-financial-professional.html'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/chfp'

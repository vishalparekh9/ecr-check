...
# Token
token = 'CHILDANDFAMILY'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.unicef.org/early-childhood-development/10-ways-companies-can-be-more-family-friendly'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/childandfamily'

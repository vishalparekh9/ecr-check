...
specialid = 'KEN1007KENDL'
id = 'ac19e28b-a6c0-49ba-a0f8-6e40299ce08a'
...
class CRAWLER(object):
    def __init__(self):
        ...
        self.token = 'CH.KENDAL'
        self.domain = 'ch.kendal.org'
        self.obj = {'title': '', 'location': '', 'description': '', 'domain': self.domain, 'url': ''}
        self.allJobs = []
        self.iserror = False

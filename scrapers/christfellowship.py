...
# Token
token = 'CHRISTFELLOWSHIP'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.christfellowship.church/'
        ...
        self.domain = 'christfellowship.church'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/christfellowship'

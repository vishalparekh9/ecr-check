...
token = 'CIVITASCAPITAL'

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://civitascapital.bamboohr.com/jobs/embed2.php?version=1.0.0'
        ...
        self.domain = 'civitascapital.com'
    ...
    def process_logic(self):
        try:
            url = 'https://civitascapital.bamboohr.com/jobs/embed2.php?version=1.0.0'

...
class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://hi-in.facebook.com/GulfBusiness/posts/clark-71-was-originally-set-to-retire-in-june-2020-but-stayed-on-to-help-guide-e/3985607578226941/'
        ...
        self.domain = 'hi-in.facebook.com'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/clark71'

...
# Token
token = 'CLASSICALCHARTERSCHOOLS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://classicalcharterschools.org/'
        ...
        self.domain = 'classicalcharterschools.org'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/classicalcharterschools'

...
token = 'CLEANMARKLABLES'

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://cleanmarklabels.bamboohr.com/jobs/embed2.php?version=1.0.0'
        ...
        self.domain = 'cleanmarklabels.com'
    ...
    def process_logic(self):
        try:
            url = 'https://cleanmarklabels.bamboohr.com/jobs/embed2.php?version=1.0.0'

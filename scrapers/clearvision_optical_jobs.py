...
import json
#Token
token = 'CVOPTIONAL_JOBS'

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://jobs.ourcareerpages.com/WebServices/ccp_jobs.aspx?AutoGenerate=yes&GroupBy=&CCPCode=ClearVisionOptical&InAccountID=0&ElementID=BDHRJobListingsCustom&JobOrderBy=' 

...
# Token
token = 'CLOVERTHERAPEUTICS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.clovertherapeutics.com/'
        ...
        self.domain = 'clovertherapeutics.com'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/clovertherapeutics'

...
# Token
token = 'COMMERCE_BANKS_CAREER_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://commercebank.wd1.myworkdayjobs.com/CommerceJobs/jobs?clientRequestID=31e0aeb66b544a6095663835aa3bff4b'
    ...
    def process_logic(self):
        try:
            ...
            while isdata:
                isdata = False
                url = 'https://commercebank.wd1.myworkdayjobs.com/CommerceJobs/jobs?clientRequestID=31e0aeb66b544a6095663835aa3bff4b'
                ...
                if isloaded:
                    ...
                    if 'listItems' in res.json()['body']['children'][0]['children'][0]:
                        ...
                        for link in lis:
                            ...
                            url = f'https://commercebank.wd1.myworkdayjobs.com{a}'
                            jobObj['url'] = url

...
# Token
token = 'APPLERIVERSTATEBANK_JOBS_EFFICIENTAPPLY'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.appleriverstatebank.com'
        ...
        self.domain = 'appleriverstatebank.com'
    ...
    def process_logic(self):
        try:
            url = f'https://communitybankgalena.efficientapply.com/jobs/'
            print(url)

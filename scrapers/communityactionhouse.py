...
# Token
token = 'COMMUNITYACTIONHOUSE'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://jobs.lever.co/communityactionhouse'
        ...
        self.domain = 'communityactionhouse.org'
    ...
    def process_logic(self):
        try:
            url = 'https://jobs.lever.co/communityactionhouse'

...
#Token
token = 'COMMUNITYREACHCENTER'.upper()

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.communityreachcenter.org'
        ...
        self.domain = 'communityreachcenter.org'
    ...
    def process_logic(self):
        try:
            jobid = ""
            cid = 'cd91c296-5d30-4a2a-93e0-f36fbbf254ca'

...
#Token
token = '2020COMPANIES_JOBS'

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://careers-2020companies.icims.com/jobs/search?ss=1&hashed=-435739549&mobile=false&width=1100&height=500&bga=true&needsRedirect=false&jan1offset=330&jun1offset=330' 
    ...
    def process_logic(self):
        try:
            ...
            page = 0
            while isdata:
                url = 'https://careers-2020companies.icims.com/jobs/search?pr='+str(page)+'&in_iframe=1&mobile=false&width=1100&height=500&bga=true&needsRedirect=false&jan1offset=330&jun1offset=330'
                    ...
                    if links:
                        for link in links:
                            ...
                            for job in jsn:
                                ...
                                url ='https://careers-2020companies.icims.com/jobs/'+str(job['idRaw'])+'/samsung-experience-consultant-%28pt%29/job?in_iframe=1'
                                jobObj['url'] = url

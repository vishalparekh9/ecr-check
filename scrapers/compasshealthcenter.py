...
# Token
token = 'COMPASSHEALTHCENTER'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://compasshealthcenter.net/'
        ...
        self.domain = 'compasshealthcenter.net'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/compasshealthcenter'

...
#Token
token = 'CONCEPTTECHNOLOGYINC'.upper()

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'http://concepttechnologyinc.com'
        ...
        self.domain = 'concepttechnologyinc.com'
    ...
    def process_logic(self):
        try:
            jobid = ""
            cid = '9613376a-1de3-474e-be3d-c359fb92f5ab'
            icids = '1979592374_13899'

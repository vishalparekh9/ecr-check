...
# Token
token = 'CONFERENCEAPPLICATIONS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://courses.lumenlearning.com/wm-computerapplicationsmgrs-2/chapter/instant-messaging-applications/'
        ...
        self.domain = 'courses.lumenlearning.com'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/conferenceapplications'

...
# Token
token = 'CONFIDENTIALNONPROFIT'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.linkedin.com/company/non-profit-organization---confidential'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/confidentialnonprofit'

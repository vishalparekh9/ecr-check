...
# Token
token = 'CONNECTEDCANNABISCO'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.connectedcannabisco.com/'
        ...
        self.domain = 'connectedcannabisco.com'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/connectedcannabisco'

...
# Token
token = 'CONSTANT_AVIATION_PAYCOMONLINE'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.constantaviation.com'
        ...
        self.domain = 'constantaviation.com'
    ...
    def process_logic(self):
        try:
            url = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=5664070B0EBB9BA4AAAAFF43363D18CD#'

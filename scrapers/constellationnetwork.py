...
# Token
token = 'CONSTELLATIONNETWORK'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://jobs.lever.co/constellationnetwork'
        ...
        self.domain = 'constellationnetwork.io'
    ...
    def process_logic(self):
        try:
            url = 'https://jobs.lever.co/constellationnetwork'

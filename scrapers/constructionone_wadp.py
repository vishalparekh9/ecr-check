...
# Token
token = 'CONSTRUCTION_ONE_ADP_CAREER_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.constructionone.com'
        ...
        self.domain = 'constructionone.com'
    ...
    def process_logic(self):
        try:
            jobid = ""
            cid = 'c684e669-fec0-4cf4-a8ec-e77f5650e308'

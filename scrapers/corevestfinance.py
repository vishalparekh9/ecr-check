...
#Token
token = 'COREVESTFINANCE'.upper()

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.corevestfinance.com'
        ...
        self.domain = 'corevestfinance.com'
    ...
    def process_logic(self):
        try:
            jobid = ""
            cid = '1367e3fe-0095-4657-b0e2-9265cc103f80'
            icids = '9200031561699_2'

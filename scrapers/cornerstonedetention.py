...
token = 'CORNERSTONEDETENTION'

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://cornerstonedetention.bamboohr.com/jobs/embed2.php?version=1.0.0'
        ...
        self.domain = 'cornerstonedetention.com'
    ...
    def process_logic(self):
        try:
            url = 'https://cornerstonedetention.bamboohr.com/jobs/embed2.php?version=1.0.0'

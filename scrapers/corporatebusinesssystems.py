...
#Token
token = 'CORPORATEBUSINESSSYSTEMS'.upper()

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'http://corporatebusinesssystems.com'
        ...
        self.domain = 'corporatebusinesssystems.com'
    ...
    def process_logic(self):
        try:
            jobid = ""
            cid = 'b9ecaf1c-726f-428f-9462-cb3d2480daeb'

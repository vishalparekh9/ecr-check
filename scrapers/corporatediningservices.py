...
#Token
token = 'CORPORATEDININGSERVICES'.upper()

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.corporatediningservices.com'
        ...
        self.domain = 'corporatediningservices.com'
    ...
    def process_logic(self):
        try:
            jobid = ""
            cid = 'ea4cb821-c7a2-4f78-a6b2-91ba6f31d4fc'
            icids = '9200155899289_2'

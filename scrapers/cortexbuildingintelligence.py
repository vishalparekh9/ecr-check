...
# Token
token = 'CORTEXBUILDINGINTELLIGENCE'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.crunchbase.com/organization/cortex-building-intelligence'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/cortexbuildingintelligence'

...
class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.clickpost.ai/blog/top-10-best-ecommerce-courier-services-provider-companies-in-india'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/couriers'

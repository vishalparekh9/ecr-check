...
#Token
token = 'COVERCRAFT'.upper()

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.covercraft.com/us/en/'
        ...
        self.domain = 'covercraft.comusen'
    ...
    def process_logic(self):
        try:
            jobid = ""
            cid = 'f9508983-7a3a-4b75-b416-1eb570593c7e'
            icids = '9200043314687_2'

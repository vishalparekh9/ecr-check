...
# Token
token = 'CRAGENERALAPPLICATION'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://boards.greenhouse.io/crageneralapplication/jobs/3757829'
        ...
        self.domain = 'crageneralapplication.com'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/crageneralapplication'

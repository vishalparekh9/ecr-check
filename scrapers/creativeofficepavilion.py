...
#Token
token = 'CREATIVEOFFICEPAVILION'.upper()

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://creativeofficepavilion.com/'
        ...
        self.domain = 'creativeofficepavilion.com'
    ...
    def process_logic(self):
        try:
            jobid = ""
            cid = '642bfb6e-bb4b-46e5-b098-63a63952be72'

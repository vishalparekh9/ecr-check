...
token = 'CREDIT_REPAIR_JOBS_BAMBOOHR'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://creditrepaircloud.bamboohr.com/jobs/embed2.php?version=1.0.0'
        ...
        self.domain = 'creditrepaircloud.com'
    ...
    def process_logic(self):
        try:
            url = 'https://creditrepaircloud.bamboohr.com/jobs/embed2.php?version=1.0.0'

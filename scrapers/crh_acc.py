...
# Token
token = 'CRH_AMERICAN_CEMENT_CORPORATION_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://jobs.crh.com/search/?q=american%20cement%20corporation&searchby=location&d=10&startrow=0'
        ...
        self.domain = 'americancementcompany.com'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                page = page + 25
                url = f'https://jobs.crh.com/search/?q=american%20cement%20corporation&searchby=location&d=10&startrow={page}'
                print(url)

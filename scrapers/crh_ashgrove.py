...
# Token
token = 'CRH_ASH_GROVE_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://jobs.crh.com/search/?q=ash%20grove&searchby=location&d=10&startrow=0'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                page = page + 25
                url = f'https://jobs.crh.com/search/?q=ash%20grove&searchby=location&d=10&startrow={page}'
                print(url)

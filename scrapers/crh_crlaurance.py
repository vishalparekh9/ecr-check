...
# Token
token = 'CRH_CR_LAURENCE_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://jobs.crh.com/search/?q=CRLaurence&searchby=location&d=10&startrow=0'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                page = page + 25
                url = f'https://jobs.crh.com/search/?q=CRLaurence&searchby=location&d=10&startrow={page}'
                print(url)

...
# Token
token = 'CRISISTEXTLINE86'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://boards.greenhouse.io/crisistextline86/jobs/4812908003'
        ...
        self.domain = 'crisistextline86.com'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/crisistextline86'

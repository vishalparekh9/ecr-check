...
# Token
token = 'CROCSCORPORATE'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://careers.crocs.com/about-us/default.aspx'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/crocscorporate'

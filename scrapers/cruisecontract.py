...
# Token
token = 'CRUISECONTRACT'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://disneycruise.disney.go.com/contracts-terms-safety/cruise-contract/united-states/'
        ...
        self.domain = 'disneycruise.disney.go.com'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/cruisecontract'

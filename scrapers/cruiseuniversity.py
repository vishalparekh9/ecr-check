...
# Token
token = 'CRUISEUNIVERSITY'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://boards.greenhouse.io/cruiseuniversity'
        ...
        self.domain = 'cruiseuniversity.com'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/cruiseuniversity'

...
# Token
token = 'CUMULUSMEDIA_CAREER_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://cumulusmedia.jobs.net'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                page = page + 1
                url = f'https://cumulusmedia.jobs.net/en-US/search?pagenumber={page}'
                    ...
                    if len(links) > 0:
                        for link in links:
                            if link.find('a') is not None:
                                ...
                                url = "https://cumulusmedia.jobs.net" + link.find('a').get('href')
                                jobObj['url'] = url

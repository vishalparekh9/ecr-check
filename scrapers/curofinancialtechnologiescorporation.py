...
# Token
token = 'CUROFINANCIALTECHNOLOGIESCORPORATION'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.linkedin.com/company/curo-financial-technologies-corp'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/curofinancialtechnologiescorporation'

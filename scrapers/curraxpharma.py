...
#Token
token = 'CURRAXPHARMA'.upper()

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'http://www.curraxpharma.com/'
    ...
    def process_logic(self):
        try:
            jobid = ""
            cid = 'cbaa944a-8f84-49e9-bd2c-d8391111f8e7'
            icids = '273953047203_7441'

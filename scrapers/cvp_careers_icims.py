...
# Token
token = 'CAREERS_CVP_CORP_ICIMS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://careers-cvpcorp.icims.com/jobs/search?ss=1&hashed=-626002120'
    ...
    def process_logic(self):
        try:
            url = 'https://careers-cvpcorp.icims.com/jobs/search?ss=1&hashed=-626002120'

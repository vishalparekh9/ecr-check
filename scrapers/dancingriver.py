...
class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.dandb.com/businessdirectory/dancingriverinc-sanmarcos-tx-31189534.html'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/dancingriver'

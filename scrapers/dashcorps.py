...
class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.dnb.com/business-directory/company-profiles.dash_corporation.983e227cda4944118fc9a512d87dfbc7.html'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/dashcorps'

...
# Token
token = 'DATA_BANK_CAREERS_PROD_KONG'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.databankcareers.com/'
        ...
        self.domain = 'databankcareers.com'
                ...
                if isloaded:
                    ...
                    if len(links) > 0:
                        for link in links:
                            ...
                            url = f"https://www.databankcareers.com/clients/{clientId}/posting/{jobId}/en"
                            jobObj['url'] = url

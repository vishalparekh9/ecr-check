...
token = 'DATACORESYSTEMS'

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://datacoresystems.bamboohr.com/jobs/embed2.php?version=1.0.0'
        ...
        self.domain = 'datacoresystems.com'
    ...
    def process_logic(self):
        try:
            url = 'https://datacoresystems.bamboohr.com/jobs/embed2.php?version=1.0.0'

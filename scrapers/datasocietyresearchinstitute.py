...
# Token
token = 'DATASOCIETYRESEARCHINSTITUTE'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://datasociety.net/'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/datasocietyresearchinstitute'

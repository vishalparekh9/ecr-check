...
# Token
token = 'DAYFORCEHCM_BEACONCOMMUNITIESLLC_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://us61.dayforcehcm.com/CandidatePortal/en-US/beaconresidential'
        ...
        self.domain = 'beaconcommunitiesllc.com'

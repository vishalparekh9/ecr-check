...
# Token
token = 'DAYFORCEHCM_CHERRYCREEKMORTGAGE_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://us61e2.dayforcehcm.com/CandidatePortal/en-US/cherrycreek'
        ...
        self.domain = 'cherrycreekmortgage.com'

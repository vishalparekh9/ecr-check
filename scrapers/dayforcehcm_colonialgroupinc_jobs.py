...
# Token
token = 'DAYFORCEHCM_COLONIALGROUPINC_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://globalus61e2.dayforcehcm.com/CandidatePortal/en-US/colonialgroup'
        ...
        self.domain = 'colonialgroupinc.com'

...
# Token
token = 'DAYFORCEHCM_CORNERSTONEBUILDINGBRANDS_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://us61e2.dayforcehcm.com/CandidatePortal/en-US/cbb'
        ...
        self.domain = 'cornerstonebuildingbrands.com'

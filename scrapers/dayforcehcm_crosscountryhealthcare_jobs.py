...
# Token
token = 'DAYFORCEHCM_CROSSCOUNTRYHEALTHCARE_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://us61e2.dayforcehcm.com/CandidatePortal/en-US/crosscountry'
        ...
        self.domain = 'crosscountryhealthcare.com'

...
# Token
token = 'DAYFORCEHCM_MIDWESTBANKCENTRE_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://us59.dayforcehcm.com/CandidatePortal/en-US/midwestbankcentre/'
        ...
        self.domain = 'midwestbankcentre.com'

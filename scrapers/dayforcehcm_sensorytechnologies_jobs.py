...
# Token
token = 'DAYFORCEHCM_SENSORYTECHNOLOGIES_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://usr54.dayforcehcm.com/CandidatePortal/en-US/diversified/'
        ...
        self.domain = 'sensorytechnologies.com'

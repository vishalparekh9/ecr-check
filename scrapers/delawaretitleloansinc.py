...
# Token
token = 'DELAWARETITLELOANSINC'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.dnb.com/business-directory/company-profiles.delaware_title_loans_inc.dcec3557f7ed2f51fc20d0adaa1a531d.html'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/delawaretitleloansinc'

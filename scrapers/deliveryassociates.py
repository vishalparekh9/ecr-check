...
# Token
token = 'DELIVERYASSOCIATES'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.deliveryassociates.com/'
        ...
        self.domain = 'deliveryassociates.com'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/deliveryassociates'

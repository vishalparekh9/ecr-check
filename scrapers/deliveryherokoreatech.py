...
# Token
token = 'DELIVERYHEROKOREATECH'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.crunchbase.com/organization/delivery-hero-korea/technology'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/deliveryherokoreatech'

...
# Token
token = 'DELIVERYHEROSTORESKOREA'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'http://koreabizwire.com/delivery-apps-compete-over-instant-delivery-services/169714'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/deliveryherostoreskorea'

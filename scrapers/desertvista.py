...
class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.dnb.com/business-directory/company-profiles.desert_vista_inc.56153bdffba21315ba671ff411f2644d.html'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/desertvista'

...
# Token
token = 'DESIGNTECHNICA'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.dnb.com/business-directory/company-profiles.designtechnica_corporation.b25492c88ae02798c4d313e79de4ddbd.html'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/designtechnica'

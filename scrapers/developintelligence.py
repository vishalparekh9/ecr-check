...
# Token
token = 'DEVELOPINTELLIGENCE'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://jobs.lever.co/developintelligence'
        ...
        self.domain = 'developintelligence.com'
    ...
    def process_logic(self):
        try:
            url = 'https://jobs.lever.co/developintelligence'

...
# Token
token = 'DFMDEVELOPMENTSERVICES'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.dfmdevelopment.com/'
        ...
        self.domain = 'dfmdevelopment.com'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/dfmdevelopmentservices'

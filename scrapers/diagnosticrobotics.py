...
# Token
token = 'DIAGNOSTICROBOTICS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.diagnosticrobotics.com/'
        ...
        self.domain = 'diagnosticrobotics.com'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/diagnosticrobotics'

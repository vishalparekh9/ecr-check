...
class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.dialexa.com/'
    ...
    def process_logic(self):
        try:
            url = 'https://boards-api.greenhouse.io/v1/boards/dialexa/jobs'
                ...
                if "jobs" in str(res.json()):
                    for data in res.json()["jobs"]:
                        if data:
                            ...
                            isloaded, res = self.get_request('https://boards.greenhouse.io/embed/job_app?for=dialexa&token='+url.split('gh_jid=')[1]+'&b=https%3A%2F%2Fwww.dialexa.com%2Fcareers')

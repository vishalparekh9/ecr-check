...
# Token
token = 'DIGITALFUTURESCAREERS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://digitalfutures.com/about-us/careers/'
        ...
        self.domain = 'digitalfutures.com'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/digitalfuturescareers'

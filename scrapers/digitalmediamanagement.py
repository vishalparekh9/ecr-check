...
# Token
token = 'DIGITALMEDIAMANAGEMENT'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://jobs.lever.co/digitalmediamanagement'
        ...
        self.domain = 'digitalmediamanagement.com'
    ...
    def process_logic(self):
        try:
            url = 'https://jobs.lever.co/digitalmediamanagement'

...
# Token
token = 'DIGITALOCEANCITESREMOTES'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://boards.greenhouse.io/digitaloceancitesremotes'
        ...
        self.domain = 'digitaloceancitesremotes.com'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/digitaloceancitesremotes'

...
#Token
token = 'DIGNITASTECHNOLOGIES'.upper()

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.dignitastechnologies.com/'
        ...
        self.domain = 'dignitastechnologies.com'
    ...
    def process_logic(self):
        try:
            jobid = ""
            cid = 'd14f7bd4-5843-4d2e-b88a-bd5f8e0275a1'

...
# Token
token = 'DIGRESTAURANTS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://find-and-update.company-information.service.gov.uk/company/12351529'
        ...
        self.domain = 'find-and-update.company-information.service.gov.uk'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/digrestaurants'

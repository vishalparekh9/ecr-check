...
# Token
token = 'DIRECTARTISTMANAGEMENT'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://jobs.lever.co/directartistmanagement'
        ...
        self.domain = 'directartistmanagement.com'
    ...
    def process_logic(self):
        try:
            url = 'https://jobs.lever.co/directartistmanagement'

...
# Token
token = 'DISABILITYRIGHTSCA'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://jobs.lever.co/disabilityrightsca'
        ...
        self.domain = 'disabilityrightsca.org'
    ...
    def process_logic(self):
        try:
            url = 'https://jobs.lever.co/disabilityrightsca'

...
# Token
token = 'DOCTORSWITHOUTBORDERS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://economictimes.indiatimes.com/company/doctors-without-borders-india-private-limited/U74900DL2013PTC250252'
        ...
        self.domain = 'economictimes.indiatimes.com'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/doctorswithoutborders'

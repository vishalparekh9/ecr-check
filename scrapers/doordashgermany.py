...
# Token
token = 'DOORDASHGERMANY'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://doordash.news/company/doordash-launches-in-germany/'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/doordashgermany'

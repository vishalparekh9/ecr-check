...
# Token
token = 'DOUGLASGUARDIAN'

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://douglasguardian.bamboohr.com/jobs/embed2.php?version=1.0.0'
        ...
        self.domain = 'douglasguardian.com'
        self.allJobs = []
        self.iserror = False
    ...
    def process_logic(self):
        try:
            url = 'https://douglasguardian.bamboohr.com/jobs/embed2.php?version=1.0.0'

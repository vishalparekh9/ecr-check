...
#Token
token = 'DREAMLANDBBQ'.upper()

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'http://www.dreamlandbbq.com/'
    ...
    def process_logic(self):
        try:
            jobid = ""
            cid = '1abe9c11-0fff-46fa-abbb-9dd7d3f6d3d6'
            icids = '9151613715323_4251'

...
# Token
token = 'DTN_NETWORKS_WORKDAY_JOBS_CAREER_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://dtn.wd1.myworkdayjobs.com/DTN_Careers'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://dtn.wd1.myworkdayjobs.com/wday/cxs/dtn/DTN_Careers/jobs'
                ...
                if isloaded:
                    ...
                    if len(data) > 0:
                        for rd in data:
                            ...
                            url = "https://dtn.wd1.myworkdayjobs.com/DTN_Careers" + str(rd['externalPath'])
                            jobObj['url'] = url

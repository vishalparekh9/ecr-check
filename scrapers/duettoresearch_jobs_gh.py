                ...
                if "jobs" in str(res.json()):
                    for data in res.json()["jobs"]:
                        if data:
                            ...
                            isloaded, res = self.get_request('https://boards.greenhouse.io/embed/job_app?for=duettoresearch&token='+url.split('gh_jid=')[1]+'&b=https%3A%2F%2Fwww.duettocloud.com%2Fcareers')

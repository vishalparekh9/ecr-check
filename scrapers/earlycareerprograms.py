...
# Token
token = 'EARLYCAREERPROGRAMS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.sas.com/en_in/careers/students-and-graduates/sas-academy.html'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/earlycareerprograms'

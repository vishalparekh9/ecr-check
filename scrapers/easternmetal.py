...
#Token
token = 'EASTERNMETAL'.upper()

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.easternmetal.com/'
    ...
    def process_logic(self):
        try:
            jobid = ""
            cid = '465dd6b5-ac55-4142-8f62-84cc0f0c1522'
            icids = '9200042898573_2'

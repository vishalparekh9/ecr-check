...
# Token
token = 'JOB_BOARD_EJOB_BZ_AUTOALERT_CAREER_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://autoalert.com/'
    ...
    def process_logic(self):
        try:
            url = 'https://ejob.bz/ATS/CompanyPortal.do?companyGK=29592&portalGK=17372'

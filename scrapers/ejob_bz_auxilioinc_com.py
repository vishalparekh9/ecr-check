...
# Token
token = 'JOB_BOARD_EJOB_BZ_AUXILIOINC_CAREER_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://auxilioinc.com/'
    ...
    def process_logic(self):
        try:
            url = 'https://ejob.bz/ATS/CompanyPortal.do?companyGK=28171&portalGK=15651'

...
# Token
token = 'JOB_BOARD_EJOB_BZ_CADDIEMASTER_CAREER_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://caddiemaster.com/'
    ...
    def process_logic(self):
        try:
            url = 'https://ejob.bz/CompanyPortal.do?companyGK=24031&portalGK=10191'

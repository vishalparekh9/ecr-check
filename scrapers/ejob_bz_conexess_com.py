...
# Token
token = 'JOB_BOARD_EJOB_BZ_CONEXESS_CAREER_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://conexess.com/'
    ...
    def process_logic(self):
        try:
            url = 'https://ejob.bz/CompanyPortal.do?refresh=true&companyGK=19162&portalGK=2143'

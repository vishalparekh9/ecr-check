...
# Token
token = 'JOB_BOARD_EJOB_BZ_FIBERLIGHT_CAREER_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://fiberlight.com/'
    ...
    def process_logic(self):
        try:
            url = 'https://ejob.bz/CompanyPortal.do?refresh=true&companyGK=19834&portalGK=3095'

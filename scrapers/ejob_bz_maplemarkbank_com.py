...
# Token
token = 'JOB_BOARD_EJOB_BZ_MAPLEMARKBANK_CAREER_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://maplemarkbank.com/'
    ...
    def process_logic(self):
        try:
            url = 'https://ejob.bz/CompanyPortal.do?refresh=true&companyGK=23952&portalGK=10933'

...
# Token
token = 'JOB_BOARD_EJOB_BZ_REDIMAIL_CAREER_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://redimail.com/'
    ...
    def process_logic(self):
        try:
            url = 'https://ejob.bz/ATS/CompanyPortal.do?companyGK=26731&portalGK=13671'

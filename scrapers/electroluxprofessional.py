...
# Token
token = 'ELECTROLUXPROFESSIONAL'

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://electroluxprofessional.bamboohr.com/jobs/embed2.php?version=1.0.0'
        ...
        self.domain = 'electroluxprofessional.com'
        self.allJobs = []
        self.iserror = False
    ...
    def process_logic(self):
        try:
            url = 'https://electroluxprofessional.bamboohr.com/jobs/embed2.php?version=1.0.0'

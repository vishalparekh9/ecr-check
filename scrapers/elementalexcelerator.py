...
# Token
token = 'ELEMENTALEXCELERATOR'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://elementalexcelerator.com/'
        ...
        self.domain = 'elementalexcelerator.com'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/elementalexcelerator'

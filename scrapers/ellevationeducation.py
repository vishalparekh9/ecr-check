...
# Token
token = 'ELLEVATIONEDUCATION'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://jobs.lever.co/ellevationeducation'
        ...
        self.domain = 'ellevationeducation.com'
    ...
    def process_logic(self):
        try:
            url = 'https://jobs.lever.co/ellevationeducation'

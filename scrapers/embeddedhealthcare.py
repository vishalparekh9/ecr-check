...
# Token
token = 'EMBEDDEDHEALTHCARE'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.embeddedhealthcare.com/'
        ...
        self.domain = 'embeddedhealthcare.com'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/embeddedhealthcare'

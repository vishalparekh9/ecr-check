...
#Token
token = 'EMPIRESTATEREALTYTRUST'.upper()

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'http://empirestaterealtytrust.com'
        ...
        self.domain = 'empirestaterealtytrust.com'
    ...
    def process_logic(self):
        try:
            jobid = ""
            cid = '7e591afa-7c69-4d57-86b3-5ad12ed19508'

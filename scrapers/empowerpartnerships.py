...
# Token
token = 'EMPOWERPARTNERSHIPS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://jobs.lever.co/empowerpartnerships'
        ...
        self.domain = 'empowerpartnerships.com'
    ...
    def process_logic(self):
        try:
            url = 'https://jobs.lever.co/empowerpartnerships'

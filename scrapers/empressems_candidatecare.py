...
# Token
token = 'CANDIDATE_CARE_JOBS_EMPRESSESMS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://empressems.com'
    ...
    def process_logic(self):
        try:
            url = f'https://empressems.candidatecare.jobs/job_positions/browse'
            print(url)

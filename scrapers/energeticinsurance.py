...
# Token
token = 'ENERGETICINSURANCE'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://jobs.lever.co/energeticinsurance'
        ...
        self.domain = 'energeticinsurance.com'
    ...
    def process_logic(self):
        try:
            url = 'https://jobs.lever.co/energeticinsurance'

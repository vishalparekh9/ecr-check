...
# Token
token = 'ENERGICORELIMITED'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://web3.career/web3-companies/energicorelimited'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/energicorelimited'

...
# Token
token = 'ENERGYANDENVIRONMENTLAB'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://urbanlabs.uchicago.edu/labs/energy-environment'
        ...
        self.domain = 'urbanlabs.uchicago.edu'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/energyandenvironmentlab'

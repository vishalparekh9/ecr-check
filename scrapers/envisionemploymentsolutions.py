...
# Token
token = 'ENVISIONEMPLOYMENTSOLUTIONS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://jobs.lever.co/envisionemploymentsolutions'
    ...
    def process_logic(self):
        try:
            url = 'https://jobs.lever.co/envisionemploymentsolutions'

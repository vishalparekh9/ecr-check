...
# Token
token = 'EPICSUMMERRESEARCH'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://boards.greenhouse.io/epicsummerresearch/jobs/4933633003'
        ...
        self.domain = 'epicsummerresearch.com'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/epicsummerresearch'

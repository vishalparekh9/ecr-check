...
# Token
token = 'EVERGREENSTRATEGYGROUP'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://jobs.lever.co/evergreenstrategygroup'
        ...
        self.domain = 'evergreenstrategygroup.com'
    ...
    def process_logic(self):
        try:
            url = 'https://jobs.lever.co/evergreenstrategygroup'

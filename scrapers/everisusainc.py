...
class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.dnb.com/business-directory/company-profiles.everis_usa_inc.366f4bfefe7e71ff2c7f6725317c06e9.html'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/everisusainc'

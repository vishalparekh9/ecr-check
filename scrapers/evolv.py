...
class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://apply.workable.com/evolv-technology/'
        ...
        self.domain = 'evolvtechnology.com'
        ...
        try:
            ...
            if isloaded:
                ...
                while True:
                    ...
                    url = 'https://apply.workable.com/api/v3/accounts/evolv-technology/jobs'
                    params = '{"token":"' + str(
                        token) + '","query":"","location":[],"department":[],"worktype":[],"remote":[]}'
                    ...
                    if isloaded:
                        ...
                        for link in links:
                            try:
                                ...
                                jobObj['url'] = 'https://apply.workable.com/evolv-technology/j/' + str(link['shortcode']) + '/'
                                jobObj['title'] = link['title']
                                jobObj['location'] = link['location']['city'] + ', ' + link['location']['region']
                                url = 'https://apply.workable.com/api/v2/accounts/evolv-technology/jobs/' + str(link['shortcode'])

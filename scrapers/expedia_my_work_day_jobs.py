...
# Token
token = 'LIFE_AT_EXPEDIA_GROUP_WORKDAY_JOBS_CAREER_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.lifeatexpediagroup.com'
                    ...
                    if len(data) > 0:
                        try:
                            for rd in data:
                                ...
                                url = "https://expedia.wd5.myworkdayjobs.com/en-US/search" + str(rd['externalPath'])
                                jobObj['url'] = url

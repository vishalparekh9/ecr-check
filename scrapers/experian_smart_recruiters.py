...
# Token
token = 'SMARTRECRUITERS_EXPERIAN_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.smartrecruiters.com/job-api/public/search/widgets/Experian/postings?&offset=0&limit=5000&langCode=en&callback=jQuery321039221376362208304_1646217716102&_=1646217716103'
        ...
        self.domain = 'corporatecostcontrol.com'
                ...
                if jsonText:
                    for vacancies in jsonText['results']:
                        try:
                            ...
                            url = 'https://www.smartrecruiters.com/Experian/' + str(vacancies['publicationId']) + str(

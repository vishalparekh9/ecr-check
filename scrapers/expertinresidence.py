...
# Token
token = 'EXPERTINRESIDENCE'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.imperialenterpriselab.com/advice/experts-in-residence/'
        ...
        self.domain = 'imperialenterpriselab.com'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/expertinresidence'

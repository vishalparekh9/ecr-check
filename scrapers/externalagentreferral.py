...
# Token
token = 'EXTERNALAGENTREFERRAL'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.horacemann.com/agents/referral'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/externalagentreferral'

...
# Token
token = 'FACEREALITYSKINCARE'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://facerealityskincare.com/'
        ...
        self.domain = 'facerealityskincare.com'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/facerealityskincare'

...
# Token
token = 'FAIRWAYINDEPENDENTMORTGAGECORPORATION'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.fairwayindependentmc.com/'
        ...
        self.domain = 'fairwayindependentmc.com'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/fairwayindependentmortgagecorporation'

...
# Token
token = 'FANDUELGROUPTVG'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://support.tvg.com/hc/en-us/articles/360009091573-FanDuel-Group'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/fanduelgrouptvg'

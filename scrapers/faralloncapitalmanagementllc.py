...
# Token
token = 'FARALLONCAPITALMANAGEMENTLLC'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.faralloncapital.com/'
        ...
        self.domain = 'faralloncapital.com'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/faralloncapitalmanagementllc'

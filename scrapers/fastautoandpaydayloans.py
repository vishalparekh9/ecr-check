...
# Token
token = 'FASTAUTOANDPAYDAYLOANS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://fastautoandpaydayloans.com/'
        ...
        self.domain = 'fastautoandpaydayloans.com'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/fastautoandpaydayloans'

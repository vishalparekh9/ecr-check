...
# Token
token = 'FASTAUTOLOANSVIRGINIAINC'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://fastautoloansvirginiainc.com/'
        ...
        self.domain = 'fastautoloansvirginiainc.com'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/fastautoloansvirginiainc'

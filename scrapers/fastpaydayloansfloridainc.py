...
# Token
token = 'FASTPAYDAYLOANSFLORIDAINC'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://fastpaydayloansfloridainc.com/'
        ...
        self.domain = 'fastpaydayloansfloridainc.com'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/fastpaydayloansfloridainc'

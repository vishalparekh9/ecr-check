...
# Token
token = 'FASTPAYDAYLOANSOFKENTUCKYLLC'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://fastpaydayloansofkentuckyllc.com/'
        ...
        self.domain = 'fastpaydayloansofkentuckyllc.com'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/fastpaydayloansofkentuckyllc'

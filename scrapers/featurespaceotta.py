...
# Token
token = 'FEATURESPACEOTTA'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://boards.greenhouse.io/featurespaceotta/jobs/3438932?gh_src=bd8b57a31us'
        ...
        self.domain = 'featurespaceotta.com'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/featurespaceotta'

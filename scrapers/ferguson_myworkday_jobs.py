...
# Token
token = 'FERGUSON_WORKDAY_JOBS_CAREER_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.ferguson.com'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://ferguson.wd1.myworkdayjobs.com/wday/cxs/ferguson/Ferguson_Experienced/jobs'
                ...
                if isloaded:
                    ...
                    if len(data) > 0:
                        for rd in data:
                            ...
                            url = "https://ferguson.wd1.myworkdayjobs.com/en-US/Ferguson_Experienced" + str(rd['externalPath'])
                            jobObj['url'] = url

...
# Token
token = 'FIFTHWALLVENTURESMANAGEMENTLLC'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.bloomberg.com/profile/company/1430200D:US'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/fifthwallventuresmanagementllc'

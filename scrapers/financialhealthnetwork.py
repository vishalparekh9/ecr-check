...
# Token
token = 'FINANCIALHEALTHNETWORK'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://recruitingbypaycor.com/career/CareerHomeSearch.action?clientId=8a788267506ea29401508206aa8a02a6'
    ...
    def process_logic(self):
        try:
            url = 'https://recruitingbypaycor.com/career/CareerHomeSearch.action?clientId=8a788267506ea29401508206aa8a02a6'

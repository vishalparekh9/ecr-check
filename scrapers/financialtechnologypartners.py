...
# Token
token = 'FINANCIALTECHNOLOGYPARTNERS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.ftpartners.com/'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/financialtechnologypartners'

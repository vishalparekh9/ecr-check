...
#Token
token = 'FIRSTCARBONSOLUTIONS'.upper()

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'http://www.firstcarbonsolutions.com'
        ...
        self.domain = 'firstcarbonsolutions.com'
    ...
    def process_logic(self):
        try:
            jobid = ""
            cid = '81da19df-51f7-4d56-bf65-d3194d3ce70e'

...
#Token
token = 'FIRSTFLORIDAINTEGRITYBANK'.upper()

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'http://firstfloridaintegritybank.com'
        ...
        self.domain = 'firstfloridaintegritybank.com'
    ...
    def process_logic(self):
        try:
            jobid = ""
            cid = '04bc3770-9614-43aa-b5c0-fede66f49781'
            icids = '836557396_1973'

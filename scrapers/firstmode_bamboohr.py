...
token = 'FIRST_MODE_CAREERS_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://firstmode.bamboohr.com/jobs/embed2.php?version=1.0.0'
    ...
    def process_logic(self):
        try:
            url = 'https://firstmode.bamboohr.com/jobs/embed2.php?version=1.0.0'

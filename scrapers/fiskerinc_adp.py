...
class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://fisker.wd1.myworkdayjobs.com/Fisker_Careers'
    ...
    def process_logic(self):
        try:
            ...
            oldurl = ''
            while isdata:
                isloaded, res = self.post_request('https://fisker.wd1.myworkdayjobs.com/wday/cxs/fisker/Fisker_Careers/jobs',
                                                  page)
                page = page + 20
                ...
                for obj in objs:
                    try:
                        ...
                        url = 'https://fisker.wd1.myworkdayjobs.com/wday/cxs/fisker/Fisker_Careers' + obj['externalPath']
                        jobObj['url'] = 'https://fisker.wd1.myworkdayjobs.com/en-US/Fisker_Careers' + obj['externalPath']

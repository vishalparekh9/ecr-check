...
# Token
token = 'FLAGSTAFFCIVITAS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://civitasseniorliving.com/our-communities/the-bluffs-of-flagstaff/'
        ...
        self.domain = 'civitasseniorliving.com'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/flagstaffcivitas'

...
# Token
token = 'FLEXIONEXTERNALREFERRALS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://boards.greenhouse.io/flexionexternalreferrals'
        ...
        self.domain = 'flexionexternalreferrals.com'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/flexionexternalreferrals'

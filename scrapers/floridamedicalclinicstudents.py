...
# Token
token = 'FLORIDAMEDICALCLINICSTUDENTS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.floridamedicalclinic.com/careers/'
        ...
        self.domain = 'floridamedicalclinic.com'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/floridamedicalclinicstudents'

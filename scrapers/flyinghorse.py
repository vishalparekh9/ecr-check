...
class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://economictimes.indiatimes.com/company/flying-horses-production-private-limited/U74999UP2018PTC101409'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/flyinghorse'

...
# Token
token = 'FNZ_WORKDAY_JOBS_CAREER_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.fnz.com'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://fnz.wd3.myworkdayjobs.com/wday/cxs/fnz/fnz_careers/jobs'
                    ...
                    if len(data) > 0:
                        for rd in data:
                            try:
                                ...
                                url = "https://fnz.wd3.myworkdayjobs.com/en-US/fnz_careers" + str(rd['externalPath'])
                                jobObj['url'] = url

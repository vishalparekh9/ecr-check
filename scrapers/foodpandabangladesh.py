...
# Token
token = 'FOODPANDABANGLADESH'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.deliveryhero.com/blog/founders-story-ambareen-reza-foodpanda/'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/foodpandabangladesh'

...
# Token
token = 'FOODPANDAPHILIPPINES'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.foodpanda.ph/contents/about.htm'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/foodpandaphilippines'

...
# Token
token = 'FOODPANDATAIWAN'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.dnb.com/business-directory/company-profiles.foodpanda_taiwan_co_ltd.66a0e42668e81abe4eee2c382fdb8876.html'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/foodpandataiwan'

...
#Token
token = 'FORMULATEDSOLUTIONS'.upper()

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'http://www.formulatedsolutions.com/'
        ...
        self.domain = 'formulatedsolutions.com'
    ...
    def process_logic(self):
        try:
            jobid = ""
            cid = '64d670cb-e636-46a2-9d09-ea20a41419f9'

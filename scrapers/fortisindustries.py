...
# Token
token = 'FORTISINDUSTRIES'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://recruitingbypaycor.com/career/CareerHomeSearch.action?clientId=8a7883c6718f9d9a0171cbfa5aa60ea1'
    ...
    def process_logic(self):
        try:
            url = 'https://recruitingbypaycor.com/career/CareerHomeSearch.action?clientId=8a7883c6718f9d9a0171cbfa5aa60ea1'

...
# Token
token = 'FOUNDERSINTELLIGENCE'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://foundersintelligence.com/'
        ...
        self.domain = 'foundersintelligence.com'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/foundersintelligence'

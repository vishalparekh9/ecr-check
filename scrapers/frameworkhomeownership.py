...
# Token
token = 'FRAMEWORKHOMEOWNERSHIP'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://jobs.lever.co/frameworkhomeownership'
        ...
        self.domain = 'frameworkhomeownership.org'
    ...
    def process_logic(self):
        try:
            url = 'https://jobs.lever.co/frameworkhomeownership'

...
class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.discoverwalks.com/blog/france/top-10-most-famous-french-companies/'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/french'

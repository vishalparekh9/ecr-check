...
# Token
token = 'FRESHTEAM_BEAINC_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'http://beainc.com'
    ...
    def process_logic(self):
        try:
            url = f'https://beasensors.freshteam.com/jobs'
            print(url)
                ...
                if len(links) > 0:
                    for link in links:
                        try:
                            ...
                            url = f"https://beasensors.freshteam.com" + str(link.get("href"))

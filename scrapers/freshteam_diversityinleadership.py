...
# Token
token = 'FRESHTEAM_DIVERSITYINLEADERSHIP_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'http://diversityinleadership.org'
        ...
        self.domain = 'diversityinleadership.org'
    ...
    def process_logic(self):
        try:
            url = f'https://diversityinleadership.freshteam.com/jobs'
            print(url)
                ...
                if len(links) > 0:
                    for link in links:
                        try:
                            ...
                            url = f"https://diversityinleadership.freshteam.com" + str(link.get("href"))

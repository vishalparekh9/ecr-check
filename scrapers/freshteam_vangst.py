...
# Token
token = 'FRESHTEAM_VANGST_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'http://vangst.com'
    ...
    def process_logic(self):
        try:
            url = f'https://vangst.freshteam.com/jobs'
            print(url)
                ...
                if len(links) > 0:
                    for link in links:
                        try:
                            ...
                            url = f"https://vangst.freshteam.com" + str(link.get("href"))

...
# Token
token = 'FRESHTEAM_GRANDVIEWCABINETRY_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'http://grandviewcabinetry.com'
        ...
        self.domain = 'grandviewcabinetry.com'
    ...
    def process_logic(self):
        try:
            url = f'https://woodmontcabinetry.freshteam.com/jobs'
            print(url)
                ...
                if len(links) > 0:
                    for link in links:
                        try:
                            ...
                            url = f"https://woodmontcabinetry.freshteam.com" + str(link.get("href"))

...
#Token
token = 'FRUITGROWERS'.upper()

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.fruitgrowers.com'
    ...
    def process_logic(self):
        try:
            jobid = ""
            cid = 'db8c99df-3031-4268-8946-d8ef3ea24251'
            icids = '9200133367133_2'

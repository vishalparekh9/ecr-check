...
# Token
token = 'FULLSPECTRUMSOFTWARE'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://jobs.lever.co/fullspectrumsoftware'
        ...
        self.domain = 'fullspectrumsoftware.com'
    ...
    def process_logic(self):
        try:
            url = 'https://jobs.lever.co/fullspectrumsoftware'

...
# Token
token = 'GAFGACTUARIALOPPORTUNITIES'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://boards.greenhouse.io/gafgactuarialopportunities/jobs/3899021'
        ...
        self.domain = 'gafgactuarialopportunities.com'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/gafgactuarialopportunities'

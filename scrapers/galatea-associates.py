...
# Token
token = 'GALATEA-ASSOCIATES'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://jobs.lever.co/galatea-associates'
        ...
        self.domain = 'galatea-associates.com'
    ...
    def process_logic(self):
        try:
            url = 'https://jobs.lever.co/galatea-associates'

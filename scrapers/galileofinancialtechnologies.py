...
# Token
token = 'GALILEOFINANCIALTECHNOLOGIES'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.galileo-ft.com/'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/galileofinancialtechnologies'

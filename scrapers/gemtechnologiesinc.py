...
# Token
token = 'GEMTECHNOLOGIESINC'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://jobs.lever.co/gemtechnologiesinc'
        ...
        self.domain = 'gemtechnologiesinc.com'
    ...
    def process_logic(self):
        try:
            url = 'https://jobs.lever.co/gemtechnologiesinc'

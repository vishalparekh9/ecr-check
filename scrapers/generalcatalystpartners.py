...
# Token
token = 'GENERALCATALYSTPARTNERS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.generalcatalyst.com/'
        ...
        self.domain = 'generalcatalyst.com'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/generalcatalystpartners'

...
# Token
token = 'GENERALLYINTELLIGENT'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://jobs.lever.co/generallyintelligent'
        ...
        self.domain = 'generallyintelligent.ai'
    ...
    def process_logic(self):
        try:
            url = 'https://jobs.lever.co/generallyintelligent'

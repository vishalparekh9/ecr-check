...
# Token
token = 'GENESISGLOBALLIMITED'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://mt.linkedin.com/company/genesis-global-limited'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/genesisgloballimited'

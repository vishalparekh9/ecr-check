...
# Token
token = 'GENESISTHERAPEUTICS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://jobs.lever.co/genesistherapeutics'
        ...
        self.domain = 'genesistherapeutics.ai'
    ...
    def process_logic(self):
        try:
            url = 'https://jobs.lever.co/genesistherapeutics'

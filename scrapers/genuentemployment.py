...
# Token
token = 'GENUENTEMPLOYMENT'

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://genuentemployment.bamboohr.com/jobs/embed2.php?version=1.0.0'
        ...
        self.domain = 'genuentemployment.com'
        self.allJobs = []
        self.iserror = False
    ...
    def process_logic(self):
        try:
            url = 'https://genuentemployment.bamboohr.com/jobs/embed2.php?version=1.0.0'

...
class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.dnb.com/business-directory/company-profiles.get_resq_ltd.4261da1391c9e80ecf84f4e9d8bde827.html'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/getresqltd'

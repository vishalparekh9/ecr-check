...
# Token
token = 'GLOBALFUNDFORWOMEN'

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://globalfundforwomen.bamboohr.com/jobs/embed2.php?version=1.0.0'
        ...
        self.domain = 'globalfundforwomen.com'
        self.allJobs = []
        self.iserror = False
    ...
    def process_logic(self):
        try:
            url = 'https://globalfundforwomen.bamboohr.com/jobs/embed2.php?version=1.0.0'

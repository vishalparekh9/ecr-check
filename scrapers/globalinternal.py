...
# Token
token = 'GLOBALINTERNAL'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.naukri.com/job-listings-global-internal-corporate-communication-russell-tobin-associates-staffing-solutions-india-pvt-ltd-mumbai-3-to-5-years-031121004323'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/globalinternal'

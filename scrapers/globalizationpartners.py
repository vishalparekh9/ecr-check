...
# Token
token = 'GLOBALIZATIONPARTNERS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.globalization-partners.com/'
        ...
        self.domain = 'globalization-partners.com'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/globalizationpartners'

...
# Token
token = 'GLOBALSTRATEGYGROUP'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://jobs.lever.co/globalstrategygroup'
        ...
        self.domain = 'globalstrategygroup.com'
    ...
    def process_logic(self):
        try:
            url = 'https://jobs.lever.co/globalstrategygroup'

...
class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.dnb.com/business-directory/company-profiles.jordan_goal_trading_limited.2dc57d0c4cfb5f16e42ae6735860fbe0.html'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/goaljordan'

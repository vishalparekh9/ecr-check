...
# Token
token = 'GOHEALTHSALESIL'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.gohealth.com/careers/sales-consultants/'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/gohealthsalesil'

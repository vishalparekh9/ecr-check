...
# Token
token = 'GOLDENDOORSCHOLARS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.goldendoorscholars.org/'
        ...
        self.domain = 'goldendoorscholars.org'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/goldendoorscholars'

...
# Token
token = 'GOLDENSANDSGENERALCONTRACTORSINC'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://recruitingbypaycor.com/career/CareerHomeSearch.action?clientId=8a7883d0612bf7a001617bbb331a3d37'
        ...
        self.getHeaders = {
            ...
            'clientId': '8a7883d0612bf7a001617bbb331a3d37',
            'parentUrl': 'https://recruitingbypaycor.com/career/',
            'gns': '',
        }
        self.session = requests.session()
        self.domain = 'goldensandsgc.com'
    ...
    def process_logic(self):
        try:
            url = 'https://recruitingbypaycor.com/career/CareerHomeSearch.action?clientId=8a7883d0612bf7a001617bbb331a3d37'

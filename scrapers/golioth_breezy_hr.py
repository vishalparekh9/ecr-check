...
token = 'GOLIOTH_BREEZY_HR_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://golioth.breezy.hr/'
            ...
            if isloaded:
                ...
                if links:
                    for link in links:
                        ...
                        url = str("https://golioth.breezy.hr") + str(link.find('a').get('href'))
                        jobObj['url'] = url

...
#Token
token = 'GOODIERCOSMETICS'.upper()

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'http://www.goodiercosmetics.com/'
        ...
        self.domain = 'goodiercosmetics.com'
    ...
    def process_logic(self):
        try:
            jobid = ""
            cid = '5cdb12a0-dc15-4fd8-8656-4be8e7fbcd74'
            icids = '168320179228_2'

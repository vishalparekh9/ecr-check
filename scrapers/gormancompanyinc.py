...
# Token
token = 'GORMANCOMPANYINC'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://recruitingbypaycor.com/career/CareerHomeSearch.action?clientId=8a7883c66e1f22fa016e479ee54222c0'
        ...
        self.getHeaders = {
            ...
            'clientId': '8a7883c66e1f22fa016e479ee54222c0',
            'parentUrl': 'https://recruitingbypaycor.com/career/',
            'gns': '',
        }
        self.session = requests.session()
        self.domain = 'gormanusa.com'
    ...
    def process_logic(self):
        try:
            url = 'https://recruitingbypaycor.com/career/CareerHomeSearch.action?clientId=8a7883c66e1f22fa016e479ee54222c0'

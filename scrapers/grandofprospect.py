...
# Token
token = 'GRANDOFPROSPECT'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://in.linkedin.com/company/grand-prospect-international-communication-private-limited'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/grandofprospect'

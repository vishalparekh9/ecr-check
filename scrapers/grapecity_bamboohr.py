...
token = 'GRAPECITY_BAMBOOHR_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://grapecity.bamboohr.com/jobs/embed2.php?version=1.0.0'
    ...
    def process_logic(self):
        try:
            url = 'https://grapecity.bamboohr.com/jobs/embed2.php?version=1.0.0'

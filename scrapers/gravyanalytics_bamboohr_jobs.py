...
token = 'GRAVYANALYTICS_BAMBOOHR_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://gravyanalytics.bamboohr.com/jobs/embed2.php?version=1.0.0'
        ...
        self.domain = 'gravyanalytics.com'
    ...
    def process_logic(self):
        try:
            url = 'https://gravyanalytics.bamboohr.com/jobs/embed2.php?version=1.0.0'

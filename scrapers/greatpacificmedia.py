...
# Token
token = 'GREATPACIFICMEDIA'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://ca.linkedin.com/company/great-pacific-media'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/greatpacificmedia'

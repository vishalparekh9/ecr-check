...
#Token
token = 'GROUPONEHEALTHSOURCE'.upper()

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'http://grouponehealthsource.com'
        ...
        self.domain = 'grouponehealthsource.com'
    ...
    def process_logic(self):
        try:
            jobid = ""
            cid = '7cff71a4-fcca-491c-8037-3fd6d78d8d0d'

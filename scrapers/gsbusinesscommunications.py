...
# Token
token = 'GSBUSINESSCOMMUNICATIONS'

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://gsbusinesscommunications.bamboohr.com/jobs/embed2.php?version=1.0.0'
        ...
        self.domain = 'gsbusinesscommunications.com'
        self.allJobs = []
        self.iserror = False
    ...
    def process_logic(self):
        try:
            url = 'https://gsbusinesscommunications.bamboohr.com/jobs/embed2.php?version=1.0.0'

...
# Token
token = 'GS_WATER_CAREER_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'http://gswater.com/'
        ...
        self.getHeaders = {
            ...
            'Referer': 'https://phg.tbe.taleo.net/phg02/ats/careers/v2/searchResults?org=ASWC&cws=51',
            'Cookie': 'JSESSIONID=BEEDA75464E0497A7D01C66A6FCCE3E3'
        }
        self.session = requests.session()
        self.domain = 'gswater.com'

...
# Token
token = 'GUARDIANSECURITYINC'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://jobs.lever.co/guardiansecurityinc'
        ...
        self.domain = 'guardiansecurityinc.com'
    ...
    def process_logic(self):
        try:
            url = 'https://jobs.lever.co/guardiansecurityinc'

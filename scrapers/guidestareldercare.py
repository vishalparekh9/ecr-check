...
# Token
token = 'GUIDESTARELDERCARE'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://jobs.lever.co/guidestareldercare'
        ...
        self.domain = 'guidestareldercare.com'
    ...
    def process_logic(self):
        try:
            url = 'https://jobs.lever.co/guidestareldercare'

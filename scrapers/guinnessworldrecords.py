...
# Token
token = 'GUINNESSWORLDRECORDS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.guinnessworldrecords.com/'
        ...
        self.domain = 'guinnessworldrecords.com'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/guinnessworldrecords'

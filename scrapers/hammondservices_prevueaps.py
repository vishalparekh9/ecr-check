...
# Token
token = 'PREVUEAPS_HAMMOND_SERVICES_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.hammondservices.com'
        ...
        self.domain = 'hammondservices.com'
    ...
    def process_logic(self):
        try:
            url = f'https://hammondservices.prevueaps.com/jobs/'
            print(url)

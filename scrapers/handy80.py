...
class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.amazon.in/BTSKY-Carrying-Lipstick-Organizer-Prismacolor/dp/B072FN4T1M'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/handy80'

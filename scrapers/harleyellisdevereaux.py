...
#Token
token = 'HARLEYELLISDEVEREAUX'.upper()

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'http://www.harleyellisdevereaux.com/'
        ...
        self.domain = 'harleyellisdevereaux.com'
    ...
    def process_logic(self):
        try:
            jobid = ""
            cid = '73f568d7-f300-4c97-af4c-df2862da5316'

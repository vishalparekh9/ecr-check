...
#Token
token = 'HASTINGSPISTONRINGS'.upper()

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.hastingspistonrings.com/'
        ...
        self.domain = 'hastingspistonrings.com'
    ...
    def process_logic(self):
        try:
            jobid = ""
            cid = '312ca522-83d2-426e-9151-03c31cdaa8fc'

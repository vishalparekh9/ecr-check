...
# Token
token = 'HAVENPARKCOMMUNITIES'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://jobs.lever.co/havenparkcommunities'
        ...
        self.domain = 'havenparkcommunities.com'
    ...
    def process_logic(self):
        try:
            url = 'https://jobs.lever.co/havenparkcommunities'

...
#Token
token = 'HAWAIIDENTALSERVICE'.upper()

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.hawaiidentalservice.com/'
        ...
        self.domain = 'hawaiidentalservice.com'
    ...
    def process_logic(self):
        try:
            jobid = ""
            cid = '277bc3f5-5b35-4068-8e6c-8aa26b95d052'

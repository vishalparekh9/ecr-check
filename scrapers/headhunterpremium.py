...
# Token
token = 'HEADHUNTERPREMIUM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://boards.greenhouse.io/headhunterpremium'
        ...
        self.domain = 'headhunterpremium.com'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/headhunterpremium'

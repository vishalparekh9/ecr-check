...
# Token
token = 'HEADHUNTERSTANDARTPLUS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://headhunter.org.au/product/standard-plus/'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/headhunterstandartplus'

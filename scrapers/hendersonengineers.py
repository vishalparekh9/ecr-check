...
# Token
token = 'HENDERSONENGINEERS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://jobs.lever.co/hendersonengineers'
        ...
        self.domain = 'hendersonengineers.com'
    ...
    def process_logic(self):
        try:
            url = 'https://jobs.lever.co/hendersonengineers'

...
# Token
token = 'HERITAGECRYSTALCLEANLLC'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.crystal-clean.com/'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/heritagecrystalcleanllc'

...
# Token
token = 'HERMANMILLERRETAIL'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.hermanmiller.com/contact/retail-stores/'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/hermanmillerretail'

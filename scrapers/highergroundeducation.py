...
# Token
token = 'HIGHERGROUNDEDUCATION'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.tohigherground.com/'
        ...
        self.domain = 'tohigherground.com'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/highergroundeducation'

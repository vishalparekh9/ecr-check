...
#Token
token = 'HIGHTOUCHTECHNOLOGIES'.upper()

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'http://hightouchtechnologies.com'
        ...
        self.domain = 'hightouchtechnologies.com'
    ...
    def process_logic(self):
        try:
            jobid = ""
            cid = '6960b6a4-237e-4740-b808-8059ba3a1c7f'

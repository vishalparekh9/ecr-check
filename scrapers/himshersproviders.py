...
# Token
token = 'HIMSHERSPROVIDERS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.forhims.com/blog/hims-hers-a-model-for-better-care-through-patient-engagement-and-telemedicine'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/himshersproviders'

...
# Token
token = 'HOLLYWOODPARKSOFISTADIUM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://boards.greenhouse.io/hollywoodparksofistadium'
        ...
        self.domain = 'hollywoodparksofistadium.com'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/hollywoodparksofistadium'

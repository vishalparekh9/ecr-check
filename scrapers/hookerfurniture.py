...
# Token
token = 'HOOKERFURNITURE'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://recruitingbypaycor.com/career/CareerHomeSearch.action?clientId=8a321814489b99660148a400e9534f3a'
    ...
    def process_logic(self):
        try:
            url = 'https://recruitingbypaycor.com/career/CareerHomeSearch.action?clientId=8a321814489b99660148a400e9534f3a'

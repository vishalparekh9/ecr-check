...
# Token
token = 'HOSPICECOMMUNITY'

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://hospicecommunity.bamboohr.com/jobs/embed2.php?version=1.0.0'
        ...
        self.domain = 'hospicecommunity.com'
    ...
    def process_logic(self):
        try:
            url = 'https://hospicecommunity.bamboohr.com/jobs/embed2.php?version=1.0.0'

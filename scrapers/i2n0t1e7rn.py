...
class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://economictimes.indiatimes.com/company/rosetonn-instatrade-private-limited/U51909WB2012PTC174311'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/i2n0t1e7rn'

...
# Token
token = 'ICIMS_BERKLEYSELECT'


class CRAWLER(object):
    def __init__(self):
        self.host = 'https://careers-berkley.icims.com'
    ...
    def process_logic(self):
        try:
            ...
            page = 0
            while isdata:
                url = self.host + '/jobs/search?pr=' + str(
                    page) + '&in_iframe=1&mobile=false&width=809&height=500&bga=true&needsRedirect=false&jan1offset=330&jun1offset=330'
                        ...
                        for link in links:
                            try:
                                ...
                                for job in jsn:
                                    ...
                                    url = self.host + '/jobs/' + str(job[
                                                                         'idRaw']) + '/dispute-specialist/job?mobile=false&width=809&height=500&bga=true&needsRedirect=false&jan1offset=330&jun1offset=330&in_iframe=1'
                                    jobObj['url'] = url

...
# Token
token = 'HAMILTON_COMPANY_ICIMS_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://careers-hamiltoncompany.icims.com/jobs/search?ss=1&hashed=-625949271'
        ...
        self.domain = 'hamiltoncompany.com'
    ...
    def process_logic(self):
        try:
            jobid = ""
            url = 'https://careers-hamiltoncompany.icims.com/jobs/search?pr=1&in_iframe=1'

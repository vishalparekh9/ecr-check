...
# Token
token = 'ICIMS_RIMINISTREET'


class CRAWLER(object):
    def __init__(self):
        self.host = 'https://careers-riministreet.icims.com'
                            ...
                            for job in jsn:
                                ...
                                if match:
                                    ...
                                    if jobObj['location'].strip() == '':
                                        try:
                                            jobObj['location'] = \
                                            soup.find('div', {'class': 'col-xs-6 header left'}).find_all('span')[
                                                1].text.strip()
                                        except:

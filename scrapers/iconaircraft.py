...
#Token
token = 'ICONAIRCRAFT'.upper()

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'http://www.iconaircraft.com'
    ...
    def process_logic(self):
        try:
            jobid = ""
            cid = 'ab0e965a-eb8c-4297-8595-33f7e5bc2180'
            icids = '1586553179774328_4142'

...
class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.dnb.com/business-directory/company-profiles.igusa_representaciones_sac.93a301d0e43ec6e5f29b0117c7eec6fe.html'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/iigusa'

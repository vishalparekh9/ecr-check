...
# Token
token = 'ILLINOISTITLELOANSINC'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://illinoistitleloansinc.com/'
        ...
        self.domain = 'illinoistitleloansinc.com'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/illinoistitleloansinc'

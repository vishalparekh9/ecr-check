...
# Token
token = 'IMMOSCOUT24AUSTRIA'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://apps.apple.com/lv/app/immoscout24-austria/id1207863676'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/immoscout24austria'

...
class CRAWLER(object):
    def __init__(self):
        self.baseUrl = '"https://www. US&fromage=7&radius=50"/jobs?l=Saint Marys' 
        ...
        self.domain = ' US&fromage=7&radius=50"'
    ...
    def get_details(self, links):
        ...
        try:
            for link in links:
                ...
                #find a details
                url = 'https://www. US&fromage=7&radius=50"/viewjob?jk=' + link.get('data-jk')
                jobObj['url'] = url
                jobObj['domain'] = " US&fromage=7&radius=50""
                ...
                try:
                    ...
                    if link: jobObj['domain'] = link
                        ...
                        url = 'https://www. US&fromage=7&radius=50"' +link.parent.parent.parent.find('span',{'class':'companyName'}).find('a').get('href')
                        found, resdetail = self.get_request(url)
                        soup = BeautifulSoup(resdetail.text, 'lxml')

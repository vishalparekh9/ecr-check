...
#Token
token = 'INDEED_ACINCORP_JOBS'

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.indeed.com/jobs?q=Ac%20Inc.%20company%3A(Ac%20Inc.)&l=Huntsville%2C%20AL&vjk=872a1925e9fa5a3e' 

...
#Token
token = 'INDEED_ACTFORKLIFT_JOBS'

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.indeed.com/q-Atlantic-Coast-Toyotalift-l-North-Carolina-jobs.html?vjk=20b708b1390e2521' 

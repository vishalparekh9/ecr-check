...
#Token
token = 'INDEED_ADVERTISINGRESULTS_JOBS'

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.indeed.com/q-American-Classified-Services-jobs.html?vjk=9852dc446c900bfd' 
        ...
        self.domain = 'advertisingresults.com'

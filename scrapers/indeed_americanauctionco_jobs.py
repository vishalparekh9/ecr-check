...
#Token
token = 'INDEED_AMERICANAUCTIONCO_JOBS'

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.indeed.com/q-America-Auction-Company-jobs.html?vjk=b5aedc4d53766699' 
        ...
        self.domain = 'americanauctionco.com'

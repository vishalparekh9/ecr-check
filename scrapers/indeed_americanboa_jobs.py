...
#Token
token = 'INDEED_AMERICANBOA_JOBS'

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://in.indeed.com/jobs?q=Bank%20of%20America&mna=5&aceid&gclid=EAIaIQobChMIk4CS34GJ9QIVD6yWCh0unAHDEAAYASAAEgLYXfD_BwE&from=mobRdr&utm_source=%2Fm%2F&utm_medium=redir&utm_campaign=dt&vjk=3c7bcb35ca83e2e2' 

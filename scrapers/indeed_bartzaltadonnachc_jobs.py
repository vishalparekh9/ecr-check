...
#Token
token = 'INDEED_BARTZALTADONNACHC_JOBS'

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.indeed.com/cmp/Bartz--altadonna-Community-Health-Center/jobs' 
        ...
        self.domain = 'bartz-altadonna-chc.org'

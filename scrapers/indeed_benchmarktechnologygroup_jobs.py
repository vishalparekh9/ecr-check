...
#Token
token = 'INDEED_BENCHMARKTECHNOLOGYGROUP_JOBS'

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.indeed.com/cmp/Benchmark-Technology-Group/jobs' 
        ...
        self.domain = 'benchmarktechnologygroup.com'

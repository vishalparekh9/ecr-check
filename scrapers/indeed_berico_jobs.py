...
#Token
token = 'INDEED_BERICO_JOBS'

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.indeed.com/jobs?q=Berico%20Heating%20and%20Cooling&from=vj&l=Greensboro,%20NC&vjk=5da97ede65358f5d' 

...
#Token
token = 'INDEED_BESTCORPORATEEVENTS_JOBS'

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.indeed.com/q-Best-Corporate-Events-jobs.html?vjk=3b80372fe5bf0df2' 
        ...
        self.domain = 'bestcorporateevents.com'

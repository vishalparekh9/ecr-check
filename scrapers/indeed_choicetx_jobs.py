...
#Token
token = 'INDEED_CHOICETX_JOBS'

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.indeed.com/jobs?as_and&as_phr&as_any&as_not&as_ttl&as_cmp=Choice%20Homecare&jt=all&st&as_src&salary&radius=0&l=Texas&fromage=any&limit=10&sort&psf=advsrch&from=advancedsearch&vjk=b28ced6c6524c7d7' 

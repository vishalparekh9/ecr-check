...
#Token
token = 'INDEED_CITRUSHEALTH_JOBS'

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.indeed.com/jobs?q=Citrus%20health%20network&l=Miami,%20FL&vjk=953d6c884e1a9880' 

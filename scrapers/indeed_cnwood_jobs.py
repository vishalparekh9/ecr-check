...
#Token
token = 'INDEED_CNWOOD_JOBS'

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.indeed.com/jobs?q=CN+Wood&ts=1604587122279&rq=1&rsIdx=0&fromage=last&newcount=11' 

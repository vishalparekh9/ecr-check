...
#Token
token = 'INDEED_GREATSOUTHERNHOMES_JOBS'

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.indeed.com/cmp/Great-Southern-Homes/jobs#cmp-skip-header-desktop' 
        ...
        self.domain = 'greatsouthernhomes.com'

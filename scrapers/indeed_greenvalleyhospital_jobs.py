...
#Token
token = 'INDEED_GREENVALLEYHOSPITAL_JOBS'

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.indeed.com/cmp/Santa-Cruz-Valley-Regional-Hospital/jobs' 
        ...
        self.domain = 'greenvalleyhospital.com'

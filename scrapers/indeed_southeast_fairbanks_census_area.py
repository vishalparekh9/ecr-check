...
import common as cf
#Token
token = 'INDEED_SOUTHEAST_FAIRBANKS_CENSUS_AREA'

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.indeed.com/jobs?l=Southeast Fairbanks Census Area^ US&fromage=1&radius=50'.replace('^ US','')

...
# Token
token = 'INDICACOESIFOODINTERNO'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://boards.greenhouse.io/indicacoesifoodinterno/jobs/5339916002'
        ...
        self.domain = 'indicacoesifoodinterno.com'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/indicacoesifoodinterno'

...
# Token
token = 'INFRASTRUCTURENSULTINGENGINEERING'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://recruitingbypaycor.com/career/CareerHomeSearch.action?clientId=8a7882525c23e80b015c3262ae5c4da0'
        ...
        self.getHeaders = {
            ...
            'clientId': '8a7882525c23e80b015c3262ae5c4da0',
            'parentUrl': 'https://recruitingbypaycor.com/career/',
            'gns': '',
        }
        self.session = requests.session()
        self.domain = 'ice-eng.com'
    ...
    def process_logic(self):
        try:
            url = 'https://recruitingbypaycor.com/career/CareerHomeSearch.action?clientId=8a7882525c23e80b015c3262ae5c4da0'

...
# Token
token = 'INSIGHTDATASCIENCE'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://insightfellows.com/data-science'
        ...
        self.domain = 'insightfellows.com'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/insightdatascience'

...
# Token
token = 'INSTITUTEFORCLINICALANDECONOMICREVIEW'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://icer.org/'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/instituteforclinicalandeconomicreview'

...
# Token
token = 'INTEGRATEDSYSTEMSSOLUTIONS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.linkedin.com/company/integrated_systems_solution_inc.'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/integratedsystemssolutions'

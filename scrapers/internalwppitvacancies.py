...
# Token
token = 'INTERNALWPPITVACANCIES'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://boards.greenhouse.io/internalwppitvacancies/jobs/5650214002'
        ...
        self.domain = 'internalwppitvacancies.com'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/internalwppitvacancies'

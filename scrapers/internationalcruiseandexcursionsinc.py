...
# Token
token = 'INTERNATIONALCRUISEANDEXCURSIONSINC'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.linkedin.com/company/iceenterprise'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/internationalcruiseandexcursionsinc'

...
# Token
token = 'INTERNATIONALHOUSEBERKELEY'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://ihouse.berkeley.edu/'
        ...
        self.domain = 'ihouse.berkeley.edu'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/internationalhouseberkeley'

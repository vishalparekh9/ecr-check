...
# Token
token = 'INTRADO_CAREER_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://intrado.jobs.net/'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                page = page + 1
                url = f'https://intrado.jobs.net/en-US/search?pagenumber={page}'
                    ...
                    if len(links) > 0:
                        for link in links:
                            if link.find('a') is not None:
                                ...
                                url = "https://intrado.jobs.net" + link.find('a').get('href')
                                jobObj['url'] = url

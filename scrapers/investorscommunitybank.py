...
#Token
token = 'INVESTORSCOMMUNITYBANK'.upper()

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.investorscommunitybank.com/'
        ...
        self.domain = 'investorscommunitybank.com'
    ...
    def process_logic(self):
        try:
            jobid = ""
            cid = '6bd72b38-6275-4214-9f29-cd6b5a4b34b3'

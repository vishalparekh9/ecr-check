...
# Token
token = 'IRECRUITER_US_BOULDER_ASSOCIATES'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.boulderassociates.com'
        ...
        self.domain = 'boulderassociates.com'
    ...
    def process_logic(self):
        try:
            url = f'https://www.irecruit-us.com/index.php?OrgID=I20091101'
            print(url)

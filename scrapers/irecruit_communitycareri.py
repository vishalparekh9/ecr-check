...
# Token
token = 'IRECRUITER_US_COMMUNITY_CARERI'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://communitycareri.org'
        ...
        self.domain = 'communitycareri.org'
    ...
    def process_logic(self):
        try:
            url = f'https://www.irecruit-us.com/index.php?OrgID=I20100603'
            print(url)

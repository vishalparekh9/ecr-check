...
# Token
token = 'IRECRUITER_US_CORNHUSKERBANK'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://cornhuskerbank.com'
        ...
        self.domain = 'cornhuskerbank.com'
    ...
    def process_logic(self):
        try:
            url = f'https://www.irecruit-us.com/index.php?OrgID=I20130330'
            print(url)

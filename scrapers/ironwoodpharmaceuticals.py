...
# Token
token = 'IRONWOODPHARMACEUTICALS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://ironwoodpharma.com/'
        ...
        self.domain = 'ironwoodpharma.com'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/ironwoodpharmaceuticals'

...
# Token
token = 'ISOLVEDHIRE_FIRSTAMERICANTITLELOANS_JOBS'

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://firstamericantitleofgeorgia.isolvedhire.com/jobs/'
        ...
        self.domain = 'firstamericantitleloans.com'

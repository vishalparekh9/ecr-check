...
# Token
token = 'JABRA_WORKDAY_JOBS_CAREER_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://jabra.com'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://gn.wd3.myworkdayjobs.com/wday/cxs/gn/JabraCareers/jobs'
                ...
                if isloaded:
                    ...
                    if len(data) > 0:
                        for rd in data:
                            ...
                            url = "https://gn.wd3.myworkdayjobs.com/JabraCareers" + str(rd['externalPath'])
                            jobObj['url'] = url

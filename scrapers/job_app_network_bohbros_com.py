...
# Token
token = 'JOB_APP_NETWORK_BOHBROS_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://apply.jobappnetwork.com/boh-bros'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                payload = '{"from":'+str(page)+',"size":10,"_source":["positionType","category","socialRecruitingAttribute1","description","address","jobId","clientId","clientName","brandId","location","internalOrExternal","url"],"query":{"bool":{"filter":[{"terms":{"clientId.raw":["19904"]}},{"terms":{"brand.raw":["Boh Bros Construction"]}}]}},"sort":[{"positionType.raw":{"order":"asc"}}]}'

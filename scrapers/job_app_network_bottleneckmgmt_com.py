...
specialid = 'INF1006BTNM'
id = 'e6b3547e-a18a-4a60-b8a4-1fc01f0b0804'

token = 'BOTTLE_NECK_MGMT_JOBS_RECRUITING_ULTIPRO_TWO'
...
class CRAWLER(object):
    def __init__(self):
        ...
        self.domain = 'bottleneckmgmt.com'
    ...
    def process_logic(self):
        try:
            url = 'https://recruiting2.ultipro.com/' + str(specialid) + '/JobBoard/' + str(

...
# Token
token = 'JOB_APP_NETWORK_CHERRYHILLPHOTO_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://apply.jobappnetwork.com/cherry-hill-programs'
        ...
        self.domain = 'cherryhillphoto.com'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                payload = '{"from":'+str(page)+',"size":10,"_source":["positionType","category","socialRecruitingAttribute1","description","address","jobId","clientId","clientName","brandId","location","internalOrExternal","url"],"query":{"bool":{"filter":[{"terms":{"clientId.raw":["15599"]}},{"terms":{"brand.raw":["Cherry Hill Programs"]}},{"terms":{"internalOrExternal":[{"internalOrExternal":"externalOnly"}]}}]}},"sort":[{"positionType.raw":{"order":"asc"}}]}'

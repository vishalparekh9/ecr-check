...
# Token
token = 'JOB_APP_NETWORK_CLAIMJUMPER_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://apply.jobappnetwork.com/krgllc'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                payload = '{"from":'+str(page)+',"size":10,"_source":["positionType","category","socialRecruitingAttribute1","description","address","jobId","clientId","clientName","brandId","location","internalOrExternal","url"],"query":{"bool":{"filter":[{"terms":{"clientId.raw":["14511"]}},{"terms":{"brand.raw":["Craft Republic","Brick House Tavern + Tap","Joes Crab Shack","Spengers","McCormick & Schmicks","Mitchells Fish Market","Kings Family Restaurant","Gradys BBQ","GuacAmigos","Kelly Operations Group","Claim Jumper","Bubba Gump","Kansas Bar & Grill","Kansas Buffet Company","Lucky Bastards","Nashville Hot Chicken Shack","KC Whiskey River"]}},{"terms":{"internalOrExternal":[{"internalOrExternal":"externalOnly"}]}}]}},"sort":[{"positionType.raw":{"order":"asc"}}]}'

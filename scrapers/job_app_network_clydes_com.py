...
# Token
token = 'JOB_APP_NETWORK_CLYDES_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://apply.jobappnetwork.com/clydes'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                payload = '{"from":'+str(page)+',"size":10,"_source":["positionType","category","socialRecruitingAttribute1","description","address","jobId","clientId","clientName","brandId","location","internalOrExternal","url"],"query":{"bool":{"filter":[{"terms":{"clientId.raw":["19160"]}},{"terms":{"brand.raw":["Clydes","1789","The Hamilton","Old Ebbitt Grill","The Tombs","Clydes of Gallery Place","Clydes of Georgetown","Clydes of Reston","Clydes of Chevy Chase","Clydes at Mark Center","Clydes Tower Oaks Lodge","Clydes Willow Creek Farm"]}},{"terms":{"internalOrExternal":[{"internalOrExternal":"externalOnly"}]}}]}},"sort":[{"positionType.raw":{"order":"asc"}}]}'

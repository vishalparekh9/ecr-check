...
# Token
token = 'JOB_APP_NETWORK_EATFRESHKITCHEN_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://apply.jobappnetwork.com/ccfk'
        ...
        self.domain = 'eatfreshkitchen.com'

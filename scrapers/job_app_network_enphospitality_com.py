...
# Token
token = 'JOB_APP_NETWORK_ENPHOSPITALITY_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://apply.jobappnetwork.com/eat-n-park'
        ...
        self.domain = 'enphospitality.com'

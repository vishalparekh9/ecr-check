...
# Token
token = 'JOB_APP_NETWORK_GREATAMERICANRESTAURANTS_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://apply.jobappnetwork.com/gar'
        ...
        self.domain = 'greatamericanrestaurants.com'

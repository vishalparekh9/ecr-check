...
# Token
token = 'JOB_APP_NETWORK_HEINENS_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://apply.jobappnetwork.com/heinens'

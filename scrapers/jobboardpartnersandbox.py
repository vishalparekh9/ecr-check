...
# Token
token = 'JOBBOARDPARTNERSANDBOX'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://careers.smartrecruiters.com/PartnersSandbox?oga=true'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/jobboardpartnersandbox'

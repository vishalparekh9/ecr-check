...
# Token
token = 'JOBS_AIM_TRACK_ARIZONCOMPANIES'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://arizoncompanies.com'
        ...
        self.domain = 'arizoncompanies.com'
    ...
    def process_logic(self):
        try:
            isloaded, res = self.get_request("https://arizoncompanies.aaimtrack.com/jobs/")
            if isloaded:

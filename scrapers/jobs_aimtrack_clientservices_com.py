...
# Token
token = 'JOBS_AIM_TRACK_CLIENTSERVICES'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://clientservices.com'
        ...
        self.domain = 'clientservices.com'
    ...
    def process_logic(self):
        try:
            isloaded, res = self.get_request("https://clientservices.aaimtrack.com/jobs/")
            if isloaded:

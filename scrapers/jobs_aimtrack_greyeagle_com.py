...
# Token
token = 'JOBS_AIM_TRACK_GREYEAGLE'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://greyeagle.com'
    ...
    def process_logic(self):
        try:
            isloaded, res = self.get_request("https://greyeagle.aaimtrack.com/jobs/")
            if isloaded:

...
# Token
token = 'JOBS_AIM_TRACK_HOPEDALEMC'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://hopedalemc.com'
    ...
    def process_logic(self):
        try:
            isloaded, res = self.get_request("https://hopedalemc.aaimtrack.com/jobs/")
            if isloaded:

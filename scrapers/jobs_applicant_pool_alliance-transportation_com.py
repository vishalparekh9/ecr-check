...
#Token
token = 'JOBS_APPLICANT_POOL_ALLIANCE-TRANSPORTATION'

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://alliancetransportation.applicantpool.com/jobs/?linkId=hd.more.career' 
        ...
        self.domain = 'alliance-transportation.com'
                ...
                if aTag:
                    for link in aTag:
                        ...
                        if isloaded:
                            ...
                            descs = jobDetail.find('div',{'class':regex}).find('div',{'class':'col-sm-7'}).find('hr')

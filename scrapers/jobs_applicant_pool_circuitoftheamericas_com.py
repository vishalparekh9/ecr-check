...
#Token
token = 'JOBS_APPLICANT_POOL_CIRCUITOFTHEAMERICAS'

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://circuitoftheamericas.applicantpool.com/jobs/?linkId=hd.more.career' 
        ...
        self.domain = 'circuitoftheamericas.com'

...
#Token
token = 'JOBS_APPLICANT_POOL_FIRSTCOMMUNITYBANK'

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://firstcommunitybank.applicantpool.com/jobs/?linkId=hd.more.career' 
        ...
        self.domain = 'firstcommunitybank.com'

...
#Token
token = 'JOBS_APPLICANT_POOL_FISHERISLANDCLUB'

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://fisherislandclub.applicantpool.com/jobs/?linkId=hd.more.career' 
        ...
        self.domain = 'fisherislandclub.com'

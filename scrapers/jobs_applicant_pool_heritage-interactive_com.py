...
#Token
token = 'JOBS_APPLICANT_POOL_HERITAGE-INTERACTIVE'

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://heritageenviro.applicantpool.com/jobs/?linkId=hd.more.career' 
        ...
        self.domain = 'heritage-interactive.com'

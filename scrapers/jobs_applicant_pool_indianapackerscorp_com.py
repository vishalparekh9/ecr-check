...
#Token
token = 'JOBS_APPLICANT_POOL_INDIANAPACKERSCORP'

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://indianapackerscorp.applicantpool.com/jobs/?linkId=hd.more.career' 
        ...
        self.domain = 'indianapackerscorp.com'

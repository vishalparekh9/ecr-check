...
#Token
token = 'JOBS_APPLICANT_POOL_LINDLEYHABILITATION'

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://cbcare.applicantpool.com/jobs/?linkId=hd.more.career' 
        ...
        self.domain = 'lindleyhabilitation.com'

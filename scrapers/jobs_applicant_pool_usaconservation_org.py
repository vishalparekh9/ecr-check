...
#Token
token = 'JOBS_APPLICANT_POOL_USACONSERVATION'

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://usaconservationstaff.applicantpool.com/jobs/?linkId=hd.more.career' 
        ...
        self.domain = 'usaconservation.org'

...
# Token
token = 'JOBS_ATSONDEMAND_BACKSTOPSOLUTIONS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'http://backstopsolutions.atsondemand.com'
                ...
                if len(data) > 0:
                    for link in data:
                        try:
                            ...
                            tokens = link['jid']
                            url = 'http://backstopsolutions.atsondemand.com/#/jobDescription/' + str(tokens)
                            jobObj['url'] = url

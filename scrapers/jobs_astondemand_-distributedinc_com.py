...
# Token
token = 'JOBS_ATSONDEMAND_DISTRIBUTEDINC'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://distributedsolutions.atsondemand.com'
                ...
                if len(data) > 0:
                    for link in data:
                        try:
                            ...
                            tokens = link['jid']
                            url = 'https://distributedsolutions.atsondemand.com/#/jobDescription/' + str(tokens)
                            jobObj['url'] = url

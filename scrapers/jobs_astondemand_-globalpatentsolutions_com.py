...
# Token
token = 'JOBS_ATSONDEMAND_GLOBALPATENTSOLUTIONS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://globalpatentsolutions.atsondemand.com'
                ...
                if len(data) > 0:
                    for link in data:
                        try:
                            ...
                            tokens = link['jid']
                            url = 'https://globalpatentsolutions.atsondemand.com/#/jobDescription/' + str(tokens)
                            jobObj['url'] = url

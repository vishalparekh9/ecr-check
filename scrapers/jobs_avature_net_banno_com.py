...
# Token
token = 'JOBS_AVATURE_NET_BANNO'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://jackhenry.avature.net/careers/SearchJobs/?jobOffset=0'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                page = page + 10
                url = f'https://jackhenry.avature.net/careers/SearchJobs/?jobOffset=0'

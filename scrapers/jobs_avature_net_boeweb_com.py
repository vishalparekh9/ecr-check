...
# Token
token = 'JOBS_AVATURE_NET_BOEWEB'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://xerox.avature.net/careers/SearchJobs/?jobOffset=0'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                page = page + 10
                url = f'https://xerox.avature.net/careers/SearchJobs/?jobOffset=0'

...
# Token
token = 'JOBS_AVATURE_NET_KRAFTHEINZCOMPANY'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://kraftheinz.avature.net/careers/SearchJobs/?jobOffset=0'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                page = page + 10
                url = f'https://kraftheinz.avature.net/careers/SearchJobs/?jobOffset=0'

...
# Token
token = 'COSBAR_RECRUITING_BY_PAYCOR'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://recruitingbypaycor.com/career/CareerHomeSearch.action?clientId=8a7883d0766d99fc0177067ea3654697'
        ...
        self.getHeaders = {
            ...
            'clientId': '8a7883d0766d99fc0177067ea3654697',
            'parentUrl': 'https://recruitingbypaycor.com/career/',
            'gns': '',
        }
        self.session = requests.session()
        self.domain = 'caroffer.com'
    ...
    def process_logic(self):
        try:
            url = 'https://recruitingbypaycor.com/career/CareerHomeSearch.action?clientId=8a7883d0766d99fc0177067ea3654697'

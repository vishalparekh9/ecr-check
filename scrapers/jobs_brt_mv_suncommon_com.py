...
# Token
token = 'JOBS_BRT_MV_SUNCOMMON'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.suncommon.com'
    ...
    def process_logic(self):
        try:
            url = f'https://j.brt.mv/ATS/CompanyPortal.do?refresh=true&companyGK=27071&portalGK=14569'
            print(url)

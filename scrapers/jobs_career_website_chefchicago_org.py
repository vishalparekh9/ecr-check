...
# Token
token = 'JOBS_CAREER_WEBSITE_CHEFCHICAGO'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.chefchicago.org'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://chefchicago-jobs.careerwebsite.com/c/@search_results/controller/includes/search_jobs.cfm?page={page}&pos_flt=0&location_autocomplete=true&radius=320&ajaxRequest=1'
                print(url)
                ...
                if isloaded:
                    ...
                    if len(jlinks) > 0:
                        for rd in jlinks:
                            ...
                            url = "https://chefchicago-jobs.careerwebsite.com" + rd.find("a").get("href")
                            jobObj['url'] = url

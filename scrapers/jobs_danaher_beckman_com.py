...
# Token
token = 'JOBS_DANAHER_BECKMAN'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.beckman.com'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://jobs.danaher.com/global/en/search-results?keywords=beckman&from={page}&s=1'
                print(url)

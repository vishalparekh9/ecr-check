...
# Token
token = 'JOBS_DANAHER_BECKMANCOULTER'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.beckmancoulter.com'
        ...
        self.domain = 'beckmancoulter.com'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://jobs.danaher.com/global/en/search-results?keywords=beck%20man%20coulter&from={page}&s=1'
                print(url)

...
# Token
token = 'JOBS_DANAHER_BLUESOFTWARE'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.bluesoftware.com'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://jobs.danaher.com/global/en/esko-search-results&from={page}&s=1'
                print(url)

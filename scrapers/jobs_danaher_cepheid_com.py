...
# Token
token = 'JOBS_DANAHER_CEPHEID'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.cepheid.com'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://jobs.danaher.com/global/en/search-results?keywords=cepheid&from={page}&s=1'
                print(url)

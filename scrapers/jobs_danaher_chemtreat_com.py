...
# Token
token = 'JOBS_DANAHER_CHEMTREAT'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.chemtreat.com'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://jobs.danaher.com/global/en/c/administrative-jobs&from={page}&s=1'
                print(url)

...
# Token
token = 'JOBS_DANAHER_DANAHER'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.danaher.com'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://jobs.danaher.com/global/en/search-results?keywords=danaher&from={page}&s=1'
                print(url)

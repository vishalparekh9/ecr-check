...
# Token
token = 'JOBS_DANAHER_EXCELED'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.exceled.com'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://jobs.danaher.com/global/en/search-results?keywords=exceled&from={page}&s=1'
                print(url)

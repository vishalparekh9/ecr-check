...
# Token
token = 'JOBS_DANAHER_HACH'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.hach.com'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://jobs.danaher.com/global/en/search-results?keywords=hach&from={page}&s=1'
                print(url)

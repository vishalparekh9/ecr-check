...
# Token
token = 'JOBS_DANAHER_IDTDNA'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.idtdna.com'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://jobs.danaher.com/global/en/search-results?keywords=Integrated%20DNA%20Technologies%20(IDT)&from={page}&s=1'
                print(url)

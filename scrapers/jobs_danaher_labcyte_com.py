...
# Token
token = 'JOBS_DANAHER_LABCYTE'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.labcyte.com'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://jobs.danaher.com/global/en/search-results?keywords=labcyte&from={page}&s=1'
                print(url)

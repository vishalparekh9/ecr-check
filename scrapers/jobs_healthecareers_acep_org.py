...
# Token
token = 'JOBS_HEALTH_E_CAREERS_ACEP'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.acep.org'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://www.healthecareers.com/acep/search-jobs/?catid=1959&pg={page}'
                print(url)

...
# Token
token = 'JOBS_HEALTH_E_CAREERS_AMERICANANESTHESIOLOGY'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.americananesthesiology.com'
        ...
        self.domain = 'americananesthesiology.com'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://www.healthecareers.com/asa/search-jobs/?catid=1956&pg={page}'
                print(url)

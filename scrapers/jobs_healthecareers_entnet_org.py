...
# Token
token = 'JOBS_HEALTH_E_CAREERS_ENTNET'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.entnet.org'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://www.healthecareers.com/aaohns/search-jobs/?catid=&pg={page}'
                print(url)

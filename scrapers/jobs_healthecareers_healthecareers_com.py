...
# Token
token = 'JOBS_HEALTH_E_CAREERS_HEALTHECAREERS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.healthecareers.com'
        ...
        self.domain = 'healthecareers.com'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://www.healthecareers.com/search-jobs/?catid=&pg={page}'
                print(url)

...
# Token
token = 'JOBS_HEALTH_E_CAREERS_IDSOCIETY'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.idsociety.org'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://www.healthecareers.com/idsa/search-jobs/?cati&pg={page}'
                print(url)

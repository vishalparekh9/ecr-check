...
# Token
token = 'JOBS_HEALTH_E_CAREERS_OSTEOPATHIC'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.osteopathic.org'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://www.healthecareers.com/aoa/search-jobs/?catid=&pg={page}'
                print(url)

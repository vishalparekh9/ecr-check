...
# Token
token = 'JOBS_HIRE_CENTRIC_AMPHENOLPCD'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://amphenolpcd.com'
    ...
    def process_logic(self):
        try:
            isloaded, res = self.get_request("https://amphenolpcd.hirecentric.com/jobs/")
            if isloaded:

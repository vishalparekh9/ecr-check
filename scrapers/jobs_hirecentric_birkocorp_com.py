...
# Token
token = 'JOBS_HIRE_CENTRIC_BIRKOCORP'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://birkocorp.com'
    ...
    def process_logic(self):
        try:
            isloaded, res = self.get_request("https://birkocorp.hirecentric.com/jobsearch/")
            if isloaded:

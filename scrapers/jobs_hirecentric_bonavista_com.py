...
# Token
token = 'JOBS_HIRE_CENTRIC_BONAVISTA'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://bonavista.com'
    ...
    def process_logic(self):
        try:
            isloaded, res = self.get_request("https://bonavista.hirecentric.com/jobsearch/")
            if isloaded:

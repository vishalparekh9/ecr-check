...
# Token
token = 'JOBS_HIRE_CENTRIC_CHILDRENSBUREAU'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://childrensbureau.com'
        ...
        self.domain = 'childrensbureau.com'
    ...
    def process_logic(self):
        try:
            isloaded, res = self.get_request("https://childrensbureau.hirecentric.com/jobsearch/")
            if isloaded:

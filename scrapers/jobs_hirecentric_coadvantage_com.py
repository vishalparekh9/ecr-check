...
# Token
token = 'JOBS_HIRE_CENTRIC_COADVANTAGE'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://coadvantage.com'
    ...
    def process_logic(self):
        try:
            isloaded, res = self.get_request("https://coadvantage.hirecentric.com/jobs/")
            if isloaded:

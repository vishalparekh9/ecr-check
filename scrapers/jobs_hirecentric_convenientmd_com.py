...
# Token
token = 'JOBS_HIRE_CENTRIC_CONVENIENTMD'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://convenientmd.com'
    ...
    def process_logic(self):
        try:
            isloaded, res = self.get_request("https://convenientmd.hirecentric.com/jobsearch/?keywords=massachusetts")
            if isloaded:

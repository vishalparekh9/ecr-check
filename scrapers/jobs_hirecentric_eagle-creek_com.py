...
# Token
token = 'JOBS_HIRE_CENTRIC_EAGLE-CREEK'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://eagle-creek.com'
    ...
    def process_logic(self):
        try:
            isloaded, res = self.get_request("https://eaglecreekaviation.hirecentric.com/jobsearch/")
            if isloaded:

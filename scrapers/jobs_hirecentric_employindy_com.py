...
# Token
token = 'JOBS_HIRE_CENTRIC_EMPLOYINDY'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://employindy.com'
    ...
    def process_logic(self):
        try:
            isloaded, res = self.get_request("https://employindy.hirecentric.com/jobsearch/")
            if isloaded:

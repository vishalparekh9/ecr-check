...
# Token
token = 'JOBS_HIRE_CENTRIC_FFSB'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://ffsb.com'
    ...
    def process_logic(self):
        try:
            isloaded, res = self.get_request("https://firstfederalbankemployment.hirecentric.com/jobsearch/")
            if isloaded:

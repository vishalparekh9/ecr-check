...
# Token
token = 'JOBS_HIRE_CENTRIC_OHIOREALTITLE'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://ohiorealtitle.com'
    ...
    def process_logic(self):
        try:
            isloaded, res = self.get_request("https://ohiorealtitle.hirecentric.com/jobs/")
            if isloaded:

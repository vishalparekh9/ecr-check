...
# Token
token = 'JOBS_HUA_HRSMART_CROMCORP'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://cromcorp.hua.hrsmart.com'
        self.session = requests.session()
        self.domain = 'cromcorp.com'
        ...
        try:
            ...
            while isPage:
                ...
                isloaded, res = self.get_request(
                    f"https://cromcorp.hua.hrsmart.com/hr/ats/JobSearch/viewAll/jobSearchPaginationExternal_pageSize:100/jobSearchPaginationExternal_page:{page}")
                if isloaded:
                    ...
                    if jobDataChunk is not None:
                        ...
                        if len(aTag) > 1:
                            for link in aTag:
                                ...
                                url = 'https://cromcorp.hua.hrsmart.com' + link.find_all("td")[0].find("a").get("href")
                                jobObj['url'] = url

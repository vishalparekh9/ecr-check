...
# Token
token = 'JOBS_HUA_HRSMART_GRESHAMSMITH'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://greshamsmith.hua.hrsmart.com'
        self.session = requests.session()
        self.domain = 'greshamsmith.com'
        ...
        try:
            ...
            while isPage:
                ...
                isloaded, res = self.get_request(
                    f"https://greshamsmith.hua.hrsmart.com/hr/ats/JobSearch/viewAll/jobSearchPaginationExternal_pageSize:100/jobSearchPaginationExternal_page:{page}")
                if isloaded:
                    ...
                    if jobDataChunk is not None:
                        ...
                        if len(aTag) > 1:
                            for link in aTag:
                                ...
                                url = 'https://greshamsmith.hua.hrsmart.com' + link.find_all("td")[0].find("a").get("href")
                                jobObj['url'] = url

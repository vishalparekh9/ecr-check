...
# Token
token = 'JOBS_CAREER_JOBSCORE_CADENT'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://cadent.tv'
    ...
    def process_logic(self):
        try:
            isloaded, res = self.get_request("https://careers.jobscore.com/careers/cadent")
            if isloaded:

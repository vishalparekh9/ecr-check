...
# Token
token = 'JOBS_CAREER_JOBSCORE_CALDERAMEDICAL'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://calderamedical.com'
        ...
        self.domain = 'calderamedical.com'
    ...
    def process_logic(self):
        try:
            isloaded, res = self.get_request("https://careers.jobscore.com/careers/calderamedical")
            if isloaded:

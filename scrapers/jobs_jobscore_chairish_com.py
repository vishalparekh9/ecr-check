...
# Token
token = 'JOBS_CAREER_JOBSCORE_CHAIRISH'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://chairish.com'
    ...
    def process_logic(self):
        try:
            isloaded, res = self.get_request("https://careers.jobscore.com/careers/chairishinc")
            if isloaded:

...
# Token
token = 'JOBS_CAREER_JOBSCORE_CIRCADENCE'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://circadence.com'
    ...
    def process_logic(self):
        try:
            isloaded, res = self.get_request("https://careers.jobscore.com/careers/circadencecorporation")
            if isloaded:

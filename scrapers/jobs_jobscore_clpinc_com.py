...
# Token
token = 'JOBS_CAREER_JOBSCORE_CLPINC'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://clpinc.com'
    ...
    def process_logic(self):
        try:
            isloaded, res = self.get_request("https://careers.jobscore.com/careers/citylightandpower")
            if isloaded:

...
# Token
token = 'JOBS_CAREER_JOBSCORE_DIGIMARC'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://digimarc.com'
    ...
    def process_logic(self):
        try:
            isloaded, res = self.get_request("https://careers.jobscore.com/careers/digimarccorporation/")
            if isloaded:

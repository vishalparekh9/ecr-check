...
# Token
token = 'JOBS_CAREER_JOBSCORE_EDMUNDS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://edmunds.com'
    ...
    def process_logic(self):
        try:
            isloaded, res = self.get_request("https://careers.jobscore.com/careers/edmunds")
            if isloaded:

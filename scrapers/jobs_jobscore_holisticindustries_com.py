...
# Token
token = 'JOBS_CAREER_JOBSCORE_HOLISTICINDUSTRIES'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://holisticindustries.com'
        ...
        self.domain = 'holisticindustries.com'
    ...
    def process_logic(self):
        try:
            isloaded, res = self.get_request("https://careers.jobscore.com/careers/holisticindustries")
            if isloaded:

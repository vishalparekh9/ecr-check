...
# Token
token = 'JOBS_CAREER_JOBSCORE_TAULIA'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://taulia.com'
    ...
    def process_logic(self):
        try:
            isloaded, res = self.get_request("https://careers.jobscore.com/careers/taulia")
            if isloaded:

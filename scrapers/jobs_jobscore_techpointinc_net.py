...
# Token
token = 'JOBS_CAREER_JOBSCORE_TECHPOINTINC'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://techpointinc.net'
    ...
    def process_logic(self):
        try:
            isloaded, res = self.get_request("https://careers.jobscore.com/careers/techpointinc")
            if isloaded:

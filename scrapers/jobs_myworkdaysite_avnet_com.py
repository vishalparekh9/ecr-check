...
# Token
token = 'JOBS_MYWORKDAYSITE_AVNET'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.avnet.com'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://wd1.myworkdaysite.com/wday/cxs/avnet/External/jobs'
                    ...
                    if len(data) > 0:
                        for rd in data:
                            try:
                                ...
                                url = "https://wd1.myworkdaysite.com/wday/cxs/avnet/External" + str(rd['externalPath'])
                                jobObj['url'] = url

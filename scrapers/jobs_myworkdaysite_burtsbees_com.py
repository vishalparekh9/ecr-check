...
# Token
token = 'JOBS_MYWORKDAYSITE_BURTSBEES'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.burtsbees.com'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://wd2-impl.myworkdaysite.com/wday/cxs/clorox/BurtsBees/jobs'
                    ...
                    if len(data) > 0:
                        for rd in data:
                            try:
                                ...
                                url = "https://wd2-impl.myworkdaysite.com/wday/cxs/clorox/BurtsBees" + str(rd['externalPath'])
                                jobObj['url'] = url

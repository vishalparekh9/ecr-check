...
# Token
token = 'JOBS_MYWORKDAYSITE_CLARK-ENG'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.clark-eng.com'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://wd1.myworkdaysite.com/wday/cxs/imeg/Imeg_Careers/jobs'
                    ...
                    if len(data) > 0:
                        for rd in data:
                            try:
                                ...
                                url = "https://wd1.myworkdaysite.com/wday/cxs/imeg/Imeg_Careers" + str(rd['externalPath'])
                                jobObj['url'] = url

...
# Token
token = 'JOBS_MYWORKDAYSITE_CORPORATESPENDING'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.corporatespending.com'
        ...
        self.domain = 'corporatespending.com'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://wd3.myworkdaysite.com/en-US/wday/cxs/edenpeople/Edenred_Careers/jobs'
                    ...
                    if len(data) > 0:
                        for rd in data:
                            try:
                                ...
                                url = "https://wd3.myworkdaysite.com/en-US/wday/cxs/edenpeople/Edenred_Careers" + str(rd['externalPath'])
                                jobObj['url'] = url

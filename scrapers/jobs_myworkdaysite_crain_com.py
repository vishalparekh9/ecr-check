...
# Token
token = 'JOBS_MYWORKDAYSITE_CRAIN'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.crain.com'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://wd1.myworkdaysite.com/wday/cxs/crain/Crain_Careers/jobs'
                    ...
                    if len(data) > 0:
                        for rd in data:
                            try:
                                ...
                                url = "https://wd1.myworkdaysite.com/wday/cxs/crain/Crain_Careers" + str(rd['externalPath'])
                                jobObj['url'] = url

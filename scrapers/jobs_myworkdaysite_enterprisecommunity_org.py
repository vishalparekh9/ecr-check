...
# Token
token = 'JOBS_MYWORKDAYSITE_ENTERPRISECOMMUNITY'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.enterprisecommunity.org'
        ...
        self.domain = 'enterprisecommunity.org'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://wd5.myworkdaysite.com/wday/cxs/enterprisecommunity/EnterpriseCareers/jobs'
                    ...
                    if len(data) > 0:
                        for rd in data:
                            try:
                                ...
                                url = "https://wd5.myworkdaysite.com/wday/cxs/enterprisecommunity/EnterpriseCareers" + str(rd['externalPath'])
                                jobObj['url'] = url

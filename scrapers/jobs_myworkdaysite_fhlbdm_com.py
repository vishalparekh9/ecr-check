...
# Token
token = 'JOBS_MYWORKDAYSITE_FHLBDM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.fhlbdm.com'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://wd5.myworkdaysite.com/wday/cxs/vhr_fhlbdm/careers/jobs'
                    ...
                    if len(data) > 0:
                        for rd in data:
                            try:
                                ...
                                url = "https://wd5.myworkdaysite.com/wday/cxs/vhr_fhlbdm/careers" + str(rd['externalPath'])
                                jobObj['url'] = url

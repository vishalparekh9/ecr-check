...
# Token
token = 'JOBS_MYWORKDAYSITE_GOLUBCAPITAL'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.golubcapital.com'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://wd5.myworkdaysite.com/wday/cxs/golubcapital/Golub_Capital_Careers/jobs'
                    ...
                    if len(data) > 0:
                        for rd in data:
                            try:
                                ...
                                url = "https://wd5.myworkdaysite.com/wday/cxs/golubcapital/Golub_Capital_Careers" + str(rd['externalPath'])
                                jobObj['url'] = url

...
# Token
token = 'JOBS_MYWORKDAYSITE_HAVASFORMULA'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.havasformula.com'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://wd3.myworkdaysite.com/wday/cxs/havas/CreativeExternalCareerSite/jobs'
                    ...
                    if len(data) > 0:
                        for rd in data:
                            try:
                                ...
                                url = "https://wd3.myworkdaysite.com/wday/cxs/havas/CreativeExternalCareerSite" + str(rd['externalPath'])
                                jobObj['url'] = url

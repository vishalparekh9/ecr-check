...
# Token
token = 'JOBS_MYWORKDAYSITE_UPENN'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.upenn.edu'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://wd1.myworkdaysite.com/wday/cxs/upenn/careers-at-penn/jobs'
                    ...
                    if len(data) > 0:
                        for rd in data:
                            try:
                                ...
                                url = "https://wd1.myworkdaysite.com/wday/cxs/upenn/careers-at-penn" + str(rd['externalPath'])
                                jobObj['url'] = url

...
# Token
token = 'JOBS_OUR_CAREER_PAGES_BLSMROOFING'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.blsmroofing.com'
    ...
    def process_logic(self):
        try:
            company = "tectaamerica"
            url = f'http://tectaamerica.ourcareerpages.com/WebServices/BDHWebServiceDirector.asmx/ProcessRequest'
            print(url)
            ...
            if isloaded:
                ...
                if len(data) > 0:
                    for rd in data:
                        ...
                        job_id = rd['job_id']
                        url = str(f"http://tectaamerica.ourcareerpages.com/JobView.aspx?id={job_id}&jobFeedCode={company}&source={company}")
                        jobObj['url'] = url
                        print(jobObj)

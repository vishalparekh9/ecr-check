...
# Token
token = 'JOBS_OUR_CAREER_PAGES_GEICONSULTANTS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.geiconsultants.com'
        ...
        self.domain = 'geiconsultants.com'
    ...
    def process_logic(self):
        try:
            company = "geiconsultantsinc"
            url = f'https://geiconsultantsinc.ourcareerpages.com/WebServices/BDHWebServiceDirector.asmx/ProcessRequest'
            print(url)
            ...
            if isloaded:
                ...
                if len(data) > 0:
                    for rd in data:
                        ...
                        job_id = rd['job_id']
                        url = str(f"https://geiconsultantsinc.ourcareerpages.com/JobView.aspx?id={job_id}&jobFeedCode={company}&source={company}")
                        jobObj['url'] = url
                        print(jobObj)

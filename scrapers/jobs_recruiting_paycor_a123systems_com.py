...
# Token
token = 'JOBS_RECRUITING_PAYCOR_A123SYSTEMS_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'http://recruitingbypaycor.com/career/CareerHome.action?clientId=8a7883d060ed7d890161013b37b90b81'
        ...
        self.getHeaders = {
            ...
            'clientId': '8a7883d060ed7d890161013b37b90b81',
            'parentUrl': 'https://recruitingbypaycor.com/career/',
            'gns': '',
        }
        self.session = requests.session()
        self.domain = 'a123systems.com'
    ...
    def process_logic(self):
        try:
            url = 'http://recruitingbypaycor.com/career/CareerHome.action?clientId=8a7883d060ed7d890161013b37b90b81'

...
# Token
token = 'JOBS_RECRUITING_PAYCOR_ABC-COMPANIES_COM'
...
class CRAWLER(object):
    ...
    def process_logic(self):
        try:
            url = 'https://recruitingbypaycor.com/career/CareerHomeSearch.action?clientId=8a7883c66439e9820164811e5f356ab1'

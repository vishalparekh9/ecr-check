...
# Token
token = 'JOBS_RECRUITING_PAYCOR_ACSTECHNOLOGIES_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://recruitingbypaycor.com/career/CareerHome.action?clientId=8a7882605a4a9832015a4dfb52683116'
        ...
        self.getHeaders = {
            ...
            'clientId': '8a7882605a4a9832015a4dfb52683116',
            'parentUrl': 'https://recruitingbypaycor.com/career/',
            'gns': '',
        }
        self.session = requests.session()
        self.domain = 'acstechnologies.com'
    ...
    def process_logic(self):
        try:
            url = 'https://recruitingbypaycor.com/career/CareerHome.action?clientId=8a7882605a4a9832015a4dfb52683116'

...
# Token
token = 'JOBS_RECRUITING_PAYCOR_ADMINSTRAT_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://recruitingbypaycor.com/career/CareerHome.action?clientId=8a7883d07acff70f017b3748d30424c3'
        ...
        self.getHeaders = {
            ...
            'clientId': '8a7883d07acff70f017b3748d30424c3',
            'parentUrl': 'https://recruitingbypaycor.com/career/',
            'gns': '',
        }
        self.session = requests.session()
        self.domain = 'adminstrat.com'
    ...
    def process_logic(self):
        try:
            url = 'https://recruitingbypaycor.com/career/CareerHome.action?clientId=8a7883d07acff70f017b3748d30424c3'

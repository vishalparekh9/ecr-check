...
# Token
token = 'JOBS_RECRUITING_PAYCOR_AINQ_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://recruitingbypaycor.com/career/CareerHome.action?clientId=8a3b93ee4b71aa0d014b7efa202d5b23'
        ...
        self.getHeaders = {
            ...
            'clientId': '8a3b93ee4b71aa0d014b7efa202d5b23',
            'parentUrl': 'https://recruitingbypaycor.com/career/',
            'gns': '',
        }
        self.session = requests.session()
        self.domain = 'ainq.com'
    ...
    def process_logic(self):
        try:
            url = 'https://recruitingbypaycor.com/career/CareerHome.action?clientId=8a3b93ee4b71aa0d014b7efa202d5b23'

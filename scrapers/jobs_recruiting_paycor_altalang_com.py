...
# Token
token = 'JOBS_RECRUITING_PAYCOR_ALTALANG_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://recruitingbypaycor.com/career/CareerHome.action?clientId=8a7883d06a9aaadd016a9e0cbdea0501'
        ...
        self.getHeaders = {
            ...
            'clientId': '8a7883d06a9aaadd016a9e0cbdea0501',
            'parentUrl': 'https://recruitingbypaycor.com/career/',
            'gns': '',
        }
        self.session = requests.session()
        self.domain = 'altalang.com'
    ...
    def process_logic(self):
        try:
            url = 'https://recruitingbypaycor.com/career/CareerHome.action?clientId=8a7883d06a9aaadd016a9e0cbdea0501'

...
# Token
token = 'JOBS_RECRUITING_PAYCOR_APMORTGAGE_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://recruitingbypaycor.com/career/CareerHome.action?clientId=8a37b2194e04a92c014e08aa044c01c4'
        ...
        self.getHeaders = {
            ...
            'clientId': '8a37b2194e04a92c014e08aa044c01c4',
            'parentUrl': 'https://recruitingbypaycor.com/career/',
            'gns': '',
        }
        self.session = requests.session()
        self.domain = 'apmortgage.com'
    ...
    def process_logic(self):
        try:
            url = 'https://recruitingbypaycor.com/career/CareerHome.action?clientId=8a37b2194e04a92c014e08aa044c01c4'

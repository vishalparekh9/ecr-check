...
# Token
token = 'JOBS_RECRUITING_PAYCOR_AUTOMATIONTOOL_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://recruitingbypaycor.com/career/CareerHome.action?clientId=8a78826752446f9b0152467239890040'
        ...
        self.getHeaders = {
            ...
            'clientId': '8a78826752446f9b0152467239890040',
            'parentUrl': 'https://recruitingbypaycor.com/career/',
            'gns': '',
        }
        self.session = requests.session()
        self.domain = 'automationtool.com'
    ...
    def process_logic(self):
        try:
            url = 'https://recruitingbypaycor.com/career/CareerHome.action?clientId=8a78826752446f9b0152467239890040'

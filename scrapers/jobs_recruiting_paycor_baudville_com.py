...
# Token
token = 'JOBS_RECRUITING_PAYCOR_BAUDVILLE_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://recruitingbypaycor.com/career/CareerHome.action?clientId=8a7883d07beb3be7017bf4edce340354'
        ...
        self.getHeaders = {
            ...
            'clientId': '8a7883d07beb3be7017bf4edce340354',
            'parentUrl': 'https://recruitingbypaycor.com/career/',
            'gns': '',
        }
        self.session = requests.session()
        self.domain = 'baudville.com'
    ...
    def process_logic(self):
        try:
            url = 'https://recruitingbypaycor.com/career/CareerHome.action?clientId=8a7883d07beb3be7017bf4edce340354'

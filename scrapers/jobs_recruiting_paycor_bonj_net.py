...
# Token
token = 'JOBS_RECRUITING_PAYCOR_BONJ_NET'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://recruitingbypaycor.com/career/CareerHome.action?clientId=8a699b98413131b901413c04aa967322'
        ...
        self.getHeaders = {
            ...
            'clientId': '8a699b98413131b901413c04aa967322',
            'parentUrl': 'https://recruitingbypaycor.com/career/',
            'gns': '',
        }
        self.session = requests.session()
        self.domain = 'bonj.net'
    ...
    def process_logic(self):
        try:
            url = 'https://recruitingbypaycor.com/career/CareerHome.action?clientId=8a699b98413131b901413c04aa967322'

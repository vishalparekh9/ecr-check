...
# Token
token = 'JOBS_RECRUITING_PAYCOR_BRUNSWICKBOWLING_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'http://recruitingbypaycor.com/career/CareerHome.action?clientId=8a7883d0688e28aa01689b928cb55327'
        ...
        self.getHeaders = {
            ...
            'clientId': '8a7883d0688e28aa01689b928cb55327',
            'parentUrl': 'https://recruitingbypaycor.com/career/',
            'gns': '',
        }
        self.session = requests.session()
        self.domain = 'brunswickbowling.com'
    ...
    def process_logic(self):
        try:
            url = 'http://recruitingbypaycor.com/career/CareerHome.action?clientId=8a7883d0688e28aa01689b928cb55327'

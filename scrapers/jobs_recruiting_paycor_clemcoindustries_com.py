...
# Token
token = 'JOBS_RECRUITING_PAYCOR_CLEMCOINDUSTRIES_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://recruitingbypaycor.com/career/CareerHome.action?clientId=8a7882525c3d7d8e015c84764a7d56d5'
    ...
    def process_logic(self):
        try:
            url = 'https://recruitingbypaycor.com/career/CareerHome.action?clientId=8a7882525c3d7d8e015c84764a7d56d5'

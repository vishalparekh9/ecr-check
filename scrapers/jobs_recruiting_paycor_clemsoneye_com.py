...
# Token
token = 'JOBS_RECRUITING_PAYCOR_CLEMSONEYE_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'http://recruitingbypaycor.com/career/CareerHome.action?clientId=8a7883d064eeac4a0164f20380e645cd'
        ...
        self.getHeaders = {
            ...
            'clientId': '8a7883d064eeac4a0164f20380e645cd',
            'parentUrl': 'https://recruitingbypaycor.com/career/',
            'gns': '',
        }
        self.session = requests.session()
        self.domain = 'clemsoneye.com'
    ...
    def process_logic(self):
        try:
            url = 'http://recruitingbypaycor.com/career/CareerHome.action?clientId=8a7883d064eeac4a0164f20380e645cd'

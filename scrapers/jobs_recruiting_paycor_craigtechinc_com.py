...
# Token
token = 'JOBS_RECRUITING_PAYCOR_CRAIGTECHINC_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://recruitingbypaycor.com/career/CareerHomeSearch.action?clientId=8a78826757bc744e0157bf0e31470032'
        ...
        self.getHeaders = {
            ...
            'clientId': '8a78826757bc744e0157bf0e31470032',
            'parentUrl': 'https://recruitingbypaycor.com/career/',
            'gns': '',
        }
        self.session = requests.session()
        self.domain = 'craigtechinc.com'
    ...
    def process_logic(self):
        try:
            url = 'https://recruitingbypaycor.com/career/CareerHomeSearch.action?clientId=8a78826757bc744e0157bf0e31470032'

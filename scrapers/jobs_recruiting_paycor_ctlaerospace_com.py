...
# Token
token = 'JOBS_RECRUITING_PAYCOR_CTLAEROSPACE_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'http://recruitingbypaycor.com/career/CareerHome.action?clientId=8a7883d077dab2610178042217361849'
        ...
        self.getHeaders = {
            ...
            'clientId': '8a7883d077dab2610178042217361849',
            'parentUrl': 'https://recruitingbypaycor.com/career/',
            'gns': '',
        }
        self.session = requests.session()
        self.domain = 'ctlaerospace.com'
    ...
    def process_logic(self):
        try:
            url = 'http://recruitingbypaycor.com/career/CareerHome.action?clientId=8a7883d077dab2610178042217361849'

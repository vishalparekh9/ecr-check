...
# Token
token = 'JOBS_RECRUITING_PAYCOR_FINHEALTHNETWORK_ORG'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://recruitingbypaycor.com/career/CareerHome.action?clientId=8a788267506ea29401508206aa8a02a6'
        ...
        self.getHeaders = {
            ...
            'clientId': '8a788267506ea29401508206aa8a02a6',
            'parentUrl': 'https://recruitingbypaycor.com/career/',
            'gns': '',
        }
        self.session = requests.session()
        self.domain = 'finhealthnetwork.org'
    ...
    def process_logic(self):
        try:
            url = 'https://recruitingbypaycor.com/career/CareerHome.action?clientId=8a788267506ea29401508206aa8a02a6'

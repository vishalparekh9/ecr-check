...
# Token
token = 'JOBS_RECRUITING_PAYCOR_FIRSTFLORIDA_ORG'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://recruitingbypaycor.com/career/CareerHomeSearch.action?clientId=8a78826752446f9b015247a64c1400da'
        ...
        self.getHeaders = {
            ...
            'clientId': '8a78826752446f9b015247a64c1400da',
            'parentUrl': 'https://recruitingbypaycor.com/career/',
            'gns': '',
        }
        self.session = requests.session()
        self.domain = 'firstflorida.org'
    ...
    def process_logic(self):
        try:
            url = 'https://recruitingbypaycor.com/career/CareerHomeSearch.action?clientId=8a78826752446f9b015247a64c1400da'

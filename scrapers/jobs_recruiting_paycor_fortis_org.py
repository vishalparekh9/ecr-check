...
# Token
token = 'JOBS_RECRUITING_PAYCOR_FORTIS_ORG'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://recruitingbypaycor.com/career/CareerHome.action?clientId=8a7883c6718f9d9a0171cbfa5aa60ea1'
        ...
        self.getHeaders = {
            ...
            'clientId': '8a7883c6718f9d9a0171cbfa5aa60ea1',
            'parentUrl': 'https://recruitingbypaycor.com/career/',
            'gns': '',
        }
        self.session = requests.session()
        self.domain = 'fortis.org'
    ...
    def process_logic(self):
        try:
            url = 'https://recruitingbypaycor.com/career/CareerHome.action?clientId=8a7883c6718f9d9a0171cbfa5aa60ea1'

...
# Token
token = 'JOBS_RECRUITING_PAYCOR_GENEVANATIONALRESORT_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://recruitingbypaycor.com/career/CareerHomeSearch.action?clientId=8a78826059152fc001592261a86a0664'
        ...
        self.getHeaders = {
            ...
            'clientId': '8a78826059152fc001592261a86a0664',
            'parentUrl': 'https://recruitingbypaycor.com/career/',
            'gns': '',
        }
        self.session = requests.session()
        self.domain = 'genevanationalresort.com'
    ...
    def process_logic(self):
        try:
            url = 'https://recruitingbypaycor.com/career/CareerHomeSearch.action?clientId=8a78826059152fc001592261a86a0664'

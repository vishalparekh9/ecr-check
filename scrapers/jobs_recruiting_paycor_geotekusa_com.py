...
# Token
token = 'JOBS_RECRUITING_PAYCOR_GEOTEKUSA_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://recruitingbypaycor.com/career/CareerHome.action?clientId=8a78858b5e748ace015e7825a83e5cd0'
        ...
        self.getHeaders = {
            ...
            'clientId': '8a78858b5e748ace015e7825a83e5cd0',
            'parentUrl': 'https://recruitingbypaycor.com/career/',
            'gns': '',
        }
        self.session = requests.session()
        self.domain = 'geotekusa.com'
    ...
    def process_logic(self):
        try:
            url = 'https://recruitingbypaycor.com/career/CareerHome.action?clientId=8a78858b5e748ace015e7825a83e5cd0'

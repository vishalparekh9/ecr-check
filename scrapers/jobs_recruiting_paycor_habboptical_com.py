...
# Token
token = 'JOBS_RECRUITING_PAYCOR_HABBOPTICAL_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://recruitingbypaycor.com/career/CareerHomeSearch.action?clientId=8a7882674faaeb6e014faf31dcd9011e'
        ...
        self.getHeaders = {
            ...
            'clientId': '8a7882674faaeb6e014faf31dcd9011e',
            'parentUrl': 'https://recruitingbypaycor.com/career/',
            'gns': '',
        }
        self.session = requests.session()
        self.domain = 'habboptical.com'
    ...
    def process_logic(self):
        try:
            url = 'https://recruitingbypaycor.com/career/CareerHomeSearch.action?clientId=8a7882674faaeb6e014faf31dcd9011e'

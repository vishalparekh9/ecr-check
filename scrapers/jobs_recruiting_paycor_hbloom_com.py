...
# Token
token = 'JOBS_RECRUITING_PAYCOR_HBLOOM_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'http://recruitingbypaycor.com/career/CareerHome.action?clientId=8a7883c66613934801665f45ecc50f15#careers'
        ...
        self.getHeaders = {
            ...
            'clientId': '8a7883c66613934801665f45ecc50f15#careers',
            'parentUrl': 'https://recruitingbypaycor.com/career/',
            'gns': '',
        }
        self.session = requests.session()
        self.domain = 'hbloom.com'
    ...
    def process_logic(self):
        try:
            url = 'http://recruitingbypaycor.com/career/CareerHome.action?clientId=8a7883c66613934801665f45ecc50f15#careers'

...
# Token
token = 'JOBS_RECRUITING_PAYCOR_HOOKERFURNITURE_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://recruitingbypaycor.com/career/CareerHome.action?clientId=8a321814489b99660148a400e9534f3a'
        ...
        self.getHeaders = {
            ...
            'clientId': '8a321814489b99660148a400e9534f3a',
            'parentUrl': 'https://recruitingbypaycor.com/career/',
            'gns': '',
        }
        self.session = requests.session()
        self.domain = 'hookerfurniture.com'
    ...
    def process_logic(self):
        try:
            url = 'https://recruitingbypaycor.com/career/CareerHome.action?clientId=8a321814489b99660148a400e9534f3a'

...
# Token
token = 'JOBS_RECRUITING_PAYCOR_HOPKINSMFG_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://recruitingbypaycor.com/career/CareerHome.action?clientId=8a7883d066998dd601669d45e0552891'
        ...
        self.getHeaders = {
            ...
            'clientId': '8a7883d066998dd601669d45e0552891',
            'parentUrl': 'https://recruitingbypaycor.com/career/',
            'gns': '',
        }
        self.session = requests.session()
        self.domain = 'hopkinsmfg.com'
    ...
    def process_logic(self):
        try:
            url = 'https://recruitingbypaycor.com/career/CareerHome.action?clientId=8a7883d066998dd601669d45e0552891'

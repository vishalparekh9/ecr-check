...
# Token
token = 'JOBS_SELECTMINDS_COM_AGSOURCE'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://urus.referrals.selectminds.com/vas'
    ...
    def process_logic(self):
        try:
            url = f'https://urus.referrals.selectminds.com/vas'

...
# Token
token = 'JOBS_SELECTMINDS_COM_ASRCENERGY'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://asrcenergy.referrals.selectminds.com/aes'
    ...
    def process_logic(self):
        try:
            url = f'https://asrcenergy.referrals.selectminds.com/aes'

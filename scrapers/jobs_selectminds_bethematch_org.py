...
# Token
token = 'JOBS_SELECTMINDS_COM_BETHEMATCH'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://nmdp.referrals.selectminds.com/'
    ...
    def process_logic(self):
        try:
            url = f'https://nmdp.referrals.selectminds.com/'

...
# Token
token = 'JOBS_SELECTMINDS_COM_BLUESHIELDCA'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://bsc.referrals.selectminds.com/bsc/et/4hmy7Uj/page/tech-jobs-23'
    ...
    def process_logic(self):
        try:
            url = f'https://bsc.referrals.selectminds.com/bsc/et/4hmy7Uj/page/tech-jobs-23'

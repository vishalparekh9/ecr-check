...
# Token
token = 'JOBS_SELECTMINDS_COM_EASTCASTLEPLACE'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://lcsnet.referrals.selectminds.com/eastcastleplace'
        ...
        self.domain = 'eastcastleplace.com'
    ...
    def process_logic(self):
        try:
            url = f'https://lcsnet.referrals.selectminds.com/eastcastleplace'

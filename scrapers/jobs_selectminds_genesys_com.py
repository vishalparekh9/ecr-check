...
# Token
token = 'JOBS_SELECTMINDS_COM_GENESYS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://genesys.referrals.selectminds.com/'
    ...
    def process_logic(self):
        try:
            url = f'https://genesys.referrals.selectminds.com/'

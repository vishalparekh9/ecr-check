...
# Token
token = 'JOBS_SELECTMINDS_COM_GPSTRATEGIES'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://gpstrategies.referrals.selectminds.com/'
    ...
    def process_logic(self):
        try:
            url = f'https://gpstrategies.referrals.selectminds.com/'

...
# Token
token = 'JOBS_SELECTMINDS_COM_GRADYHEALTH'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://gmh.referrals.selectminds.com/'
    ...
    def process_logic(self):
        try:
            url = f'https://gmh.referrals.selectminds.com/'

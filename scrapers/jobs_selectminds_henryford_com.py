...
# Token
token = 'JOBS_SELECTMINDS_COM_HENRYFORD'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://henryford.referrals.selectminds.com/'
    ...
    def process_logic(self):
        try:
            url = f'https://henryford.referrals.selectminds.com/'

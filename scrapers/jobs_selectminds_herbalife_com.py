...
# Token
token = 'JOBS_SELECTMINDS_COM_HERBALIFE'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://herbalife.referrals.selectminds.com/'
    ...
    def process_logic(self):
        try:
            url = f'https://herbalife.referrals.selectminds.com/'

...
# Token
token = 'JOBS_SELECTMINDS_COM_HILLSIDE'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://hillside.referrals.selectminds.com/default1695'
    ...
    def process_logic(self):
        try:
            url = f'https://hillside.referrals.selectminds.com/default1695'

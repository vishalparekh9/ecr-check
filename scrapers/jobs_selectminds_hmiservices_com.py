...
# Token
token = 'JOBS_SELECTMINDS_COM_HMISERVICES'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://henkels.referrals.selectminds.com/hmi'
    ...
    def process_logic(self):
        try:
            url = f'https://henkels.referrals.selectminds.com/hmi'

...
# Token
token = 'JOBS_SELECTMINDS_COM_MYHTCAREERS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://myhtcareers.referrals.selectminds.com/jobs/ search/16054254'
    ...
    def process_logic(self):
        try:
            url = f'https://myhtcareers.referrals.selectminds.com/jobs/search/16054254'

...
# Token
token = 'JOBS_SELECTMINDS_COM_UIOWA'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://uiowa.referrals.selectminds.com/jobs/search/3959886'
    ...
    def process_logic(self):
        try:
            url = f'https://uiowa.referrals.selectminds.com/'

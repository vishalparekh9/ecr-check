...
# Token
token = 'JOBS_THE_APPLICANT_MANAGER_AMERICANMATERIALSCO'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.theapplicantmanager.com/careers?co=mt&int'
        ...
        self.domain = 'americanmaterialsco.com'
    ...
    def process_logic(self):
        try:
            url = 'https://www.theapplicantmanager.com/careers?co=mt&int'

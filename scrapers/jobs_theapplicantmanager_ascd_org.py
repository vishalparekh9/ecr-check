...
# Token
token = 'JOBS_THE_APPLICANT_MANAGER_ASCD'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://theapplicantmanager.com/careers?co=ai'
    ...
    def process_logic(self):
        try:
            url = 'https://theapplicantmanager.com/careers?co=ai'

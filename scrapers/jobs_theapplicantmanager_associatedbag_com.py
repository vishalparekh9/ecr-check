...
# Token
token = 'JOBS_THE_APPLICANT_MANAGER_ASSOCIATEDBAG'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://theapplicantmanager.com/careers?co=a7'
    ...
    def process_logic(self):
        try:
            url = 'https://theapplicantmanager.com/careers?co=a7'

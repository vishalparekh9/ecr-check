...
# Token
token = 'JOBS_THE_APPLICANT_MANAGER_AUBERGERESORTS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://theapplicantmanager.com/careers?co=au'
        ...
        self.domain = 'aubergeresorts.com'
    ...
    def process_logic(self):
        try:
            url = 'https://theapplicantmanager.com/careers?co=au'

...
# Token
token = 'JOBS_THE_APPLICANT_MANAGER_BEACONHC'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://theapplicantmanager.com/careers?co=b5'
    ...
    def process_logic(self):
        try:
            url = 'https://theapplicantmanager.com/careers?co=b5'

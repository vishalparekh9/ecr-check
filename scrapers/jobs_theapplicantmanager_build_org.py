...
# Token
token = 'JOBS_THE_APPLICANT_MANAGER_BUILD'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://theapplicantmanager.com/careers?co=bu'
    ...
    def process_logic(self):
        try:
            url = 'https://theapplicantmanager.com/careers?co=bu'

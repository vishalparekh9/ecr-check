...
# Token
token = 'JOBS_THE_APPLICANT_MANAGER_CLINECELLARS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://theapplicantmanager.com/careers?co=l0'
    ...
    def process_logic(self):
        try:
            url = 'https://theapplicantmanager.com/careers?co=l0'

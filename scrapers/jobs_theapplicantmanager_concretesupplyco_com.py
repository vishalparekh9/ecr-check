...
# Token
token = 'JOBS_THE_APPLICANT_MANAGER_CONCRETESUPPLYCO'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://theapplicantmanager.com/careers?co=c0'
        ...
        self.domain = 'concretesupplyco.com'
    ...
    def process_logic(self):
        try:
            url = 'https://theapplicantmanager.com/careers?co=c0'

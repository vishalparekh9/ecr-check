...
# Token
token = 'JOBS_THE_APPLICANT_MANAGER_HEARTTOHEARTHOSPICE'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.theapplicantmanager.com/careers?co=hh'
        ...
        self.domain = 'hearttohearthospice.com'
    ...
    def process_logic(self):
        try:
            url = 'https://www.theapplicantmanager.com/careers?co=hh'

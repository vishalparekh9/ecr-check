...
# Token
token = 'JOBS_THE_APPLICANT_MANAGER_HIVEMEDIA'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.theapplicantmanager.com/careers?co=hm'
    ...
    def process_logic(self):
        try:
            url = 'https://www.theapplicantmanager.com/careers?co=hm'

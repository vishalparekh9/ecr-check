...
# Token
token = 'JOBS_THE_APPLICANT_MANAGER_WHYREMAN'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://theapplicantmanager.com/careers?co=k6'
    ...
    def process_logic(self):
        try:
            url = 'https://theapplicantmanager.com/careers?co=k6'

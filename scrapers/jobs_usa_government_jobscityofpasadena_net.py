...
# Token
token = 'JOBS_USA_GOVERNMENT_JOBSCITYOFPASADENA_NET'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.governmentjobs.com/careers/pasadena'
        ...
        self.domain = 'cityofpasadena.net'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                page = page + 1
                url = f'https://www.governmentjobs.com/careers/pasadena?page={page}'

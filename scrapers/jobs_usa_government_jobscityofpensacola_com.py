...
# Token
token = 'JOBS_USA_GOVERNMENT_JOBSCITYOFPENSACOLA_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.governmentjobs.com/careers/pensacola'
        ...
        self.domain = 'cityofpensacola.com'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                page = page + 1
                url = f'https://www.governmentjobs.com/careers/pensacola?page={page}'

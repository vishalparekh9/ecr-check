...
# Token
token = 'JOBS_USA_GOVERNMENT_JOBSCITYOFSANTACRUZ_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.governmentjobs.com/careers/santacruz'
        ...
        self.domain = 'cityofsantacruz.com'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                page = page + 1
                url = f'https://www.governmentjobs.com/careers/santacruz?page={page}'

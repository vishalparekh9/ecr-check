...
# Token
token = 'JOBS_USA_GOVERNMENT_JOBSCLEANWATERSERVICES_ORG'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.governmentjobs.com/careers/cws'
        ...
        self.domain = 'cleanwaterservices.org'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                page = page + 1
                url = f'https://www.governmentjobs.com/careers/cws?page={page}'

...
# Token
token = 'JOBS_USA_GOVERNMENT_JOBSCOLLIERCOUNTYFL_GOV'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.governmentjobs.com/careers/collier'
        ...
        self.domain = 'colliercountyfl.gov'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                page = page + 1
                url = f'https://www.governmentjobs.com/careers/collier?page={page}'

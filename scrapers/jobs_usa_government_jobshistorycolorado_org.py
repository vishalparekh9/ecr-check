...
# Token
token = 'JOBS_USA_GOVERNMENT_JOBSHISTORYCOLORADO_ORG'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.governmentjobs.com/careers/colorado'
        ...
        self.domain = 'historycolorado.org'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                page = page + 1
                url = f'https://www.governmentjobs.com/careers/colorado?page={page}'

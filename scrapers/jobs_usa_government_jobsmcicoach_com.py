...
# Token
token = 'JOBS_USA_GOVERNMENT_JOBSMCICOACH_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.governmentjobs.com/careers/nfigroup'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                page = page + 1
                url = f'https://www.governmentjobs.com/careers/nfigroup?page={page}'

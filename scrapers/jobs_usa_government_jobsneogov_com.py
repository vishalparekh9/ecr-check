...
# Token
token = 'JOBS_USA_GOVERNMENT_JOBSNEOGOV_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.governmentjobs.com/careers/neogovpe'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                page = page + 1
                url = f'https://www.governmentjobs.com/careers/neogovpe?page={page}'

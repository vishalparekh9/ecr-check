...
# Token
token = 'JOBS_USA_GOVERNMENT_JOBSPORTLANDOREGON_GOV'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.governmentjobs.com/careers/portlandor'
        ...
        self.domain = 'portlandoregon.gov'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                page = page + 1
                url = f'https://www.governmentjobs.com/careers/portlandor?page={page}'

...
# Token
token = 'JOBS_VMWARE_AETHERPAL'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.aetherpal.com'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://careers.vmware.com/api/jobs?keywords=VMware%20Workspace%20ONE&limit=25&page={page}&sortBy=relevance&descending=false&internal=false'
                print(url)

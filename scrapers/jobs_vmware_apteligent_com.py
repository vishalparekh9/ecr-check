...
# Token
token = 'JOBS_VMWARE_APTELIGENT'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.apteligent.com'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://careers.vmware.com/api/jobs?keywords=apteligent&limit=25&page={page}&sortBy=relevance&descending=false&internal=false'
                print(url)

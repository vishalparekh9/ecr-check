...
# Token
token = 'JOBS_VMWARE_BLUELANE'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.bluelane.com'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://careers.vmware.com/api/jobs?keywords=Blue%20Lane%20Technologies&limit=25&page={page}&sortBy=relevance&descending=false&internal=false'
                print(url)

...
# Token
token = 'JOBS_VMWARE_CARBONBLACK'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.carbonblack.com'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://careers.vmware.com/api/jobs?keywords=carbonblack%20&limit=25&page={page}&sortBy=relevance&descending=false&internal=false'
                print(url)

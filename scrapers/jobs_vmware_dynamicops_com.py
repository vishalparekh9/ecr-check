...
# Token
token = 'JOBS_VMWARE_DYNAMICOPS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.dynamicops.com'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://careers.vmware.com/api/jobs?keywords=dynamicops&limit=25&page={page}&sortBy=relevance&descending=false&internal=false'
                print(url)

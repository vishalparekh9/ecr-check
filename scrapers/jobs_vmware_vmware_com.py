...
# Token
token = 'JOBS_VMWARE_VMWARE'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.vmware.com'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://careers.vmware.com/api/jobs?keywords=vmware&limit=25&page={page}&sortBy=relevance&descending=false&internal=false'
                print(url)

...
# Token
token = 'JOINCOMMONROOM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://boards.greenhouse.io/joincommonroom/jobs/4001072004'
        ...
        self.domain = 'joincommonroom.com'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/joincommonroom'

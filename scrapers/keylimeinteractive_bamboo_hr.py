...
token = 'KEY_LIME_INTERACTIVE_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://keylimeinteractive.bamboohr.com/jobs/embed2.php?version=1.0.0'
        ...
        self.domain = 'keylimeinteractive.com'
    ...
    def process_logic(self):
        try:
            url = 'https://kli.bamboohr.com/jobs/embed2.php?version=1.0.0'

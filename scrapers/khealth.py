...
class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.investopedia.com/articles/markets/030916/worlds-top-10-health-care-companies-unh-mdt.asp'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/khealth'

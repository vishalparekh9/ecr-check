...
# Token
token = 'KINSHIPINTERNSHIPS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://boards.greenhouse.io/kinshipinternships'
        ...
        self.domain = 'kinshipinternships.com'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/kinshipinternships'

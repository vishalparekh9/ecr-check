...
# Token
token = 'KOKUAZIPRECRUITER'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://boards.greenhouse.io/kokuaziprecruiter/jobs/5734206002'
        ...
        self.domain = 'kokuaziprecruiter.com'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/kokuaziprecruiter'

...
# Token
token = 'KYOWAKIRINUSA90'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://boards.greenhouse.io/kyowakirinusa90/jobs/4834482003'
        ...
        self.domain = 'kyowakirinusa90.com'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/kyowakirinusa90'

...
# Token
token = 'LELANDSAYLORASSOCIATES'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.crunchbase.com/organization/leland-saylor-associates'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/lelandsaylorassociates'

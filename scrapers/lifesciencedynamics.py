...
# Token
token = 'LIFESCIENCEDYNAMICS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.lifesciencedynamics.com/'
        ...
        self.domain = 'lifesciencedynamics.com'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/lifesciencedynamics'

...
# Token
token = 'LIFESKILLSAUTISMACADEMY'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.lifeskillsautismacademy.com/'
        ...
        self.domain = 'lifeskillsautismacademy.com'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/lifeskillsautismacademy'

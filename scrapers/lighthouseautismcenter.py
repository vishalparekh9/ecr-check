...
# Token
token = 'LIGHTHOUSEAUTISMCENTER'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://lighthouseautismcenter.com/'
        ...
        self.domain = 'lighthouseautismcenter.com'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/lighthouseautismcenter'

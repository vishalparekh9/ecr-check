...
# Token
token = 'LITHUANIAREVELSYSTEMSCAREERS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://boards.greenhouse.io/lithuaniarevelsystemscareers/jobs/3966316'
        ...
        self.domain = 'lithuaniarevelsystemscareers.com'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/lithuaniarevelsystemscareers'

...
# Token
token = 'LITTLERAYMONDSINDIANAPOLIS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'http://littleraymondsprintshop.com/'
        ...
        self.domain = 'littleraymondsprintshop.com'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/littleraymondsindianapolis'

...
# Token
token = 'LIVELYHEARINGCORPORATION'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.listenlively.com/'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/livelyhearingcorporation'

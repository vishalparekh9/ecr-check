...
class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://in.kompass.com/s/education-training-organisations/14/r/madhya-pradesh/in_inmp/'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/lmpeducation'

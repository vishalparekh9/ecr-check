...
# Token
token = 'LONEMOUNTAINPARTNERS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://opencorporates.com/companies/us_nv/E0390402014-9'
        ...
        self.domain = 'opencorporates.com'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/lonemountainpartners'

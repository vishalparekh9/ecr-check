...
class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://investor.2u.com/news-and-events/press-releases/news-details/2014/2U-Inc-CEO-and-Co-Founder-Chip-Paucek-to-Speak-at-Goldman-Sachs-US-EmergingSMID-Cap-Growth-Conference/default.aspx'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/marriott2u'

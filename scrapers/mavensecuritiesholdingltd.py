...
# Token
token = 'MAVENSECURITIESHOLDINGLTD'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.mavensecurities.com/'
        ...
        self.domain = 'mavensecurities.com'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/mavensecuritiesholdingltd'

...
# Token
token = 'MECHANICALLICENSINGCOLLECTIVE'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.themlc.com/'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/mechanicallicensingcollective'

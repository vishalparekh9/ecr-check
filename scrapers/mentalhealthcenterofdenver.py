...
# Token
token = 'MENTALHEALTHCENTEROFDENVER'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.linkedin.com/company/mental-health-center-of-denver'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/mentalhealthcenterofdenver'

...
# Token
token = 'MFAINTERNALJOBBOARD'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.monsterindia.com/search/mfa-jobs-in-pune'
    ...
    def process_logic(self):
        try:
            url = 'https://boards.greenhouse.io/mfainternaljobboard'

...
#Token
token = 'MORNINGSTARSENIORLIVING'.upper()

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.morningstarseniorliving.com/'
        ...
        self.domain = 'morningstarseniorliving.com'
    ...
    def process_logic(self):
        try:
            jobid = ""
            cid = 'eebd3a88-0d4b-47d4-a309-3fee7b16763b'

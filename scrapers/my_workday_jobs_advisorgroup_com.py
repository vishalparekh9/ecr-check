...
# Token
token = 'MY_WORKDAY_JOBS_ADVISORGROUP_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://advisorgroup.wd1.myworkdayjobs.com/wday/cxs/advisorgroup/Advisor_Career_Site/jobs'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://advisorgroup.wd1.myworkdayjobs.com/wday/cxs/advisorgroup/Advisor_Career_Site/jobs'
                        ...
                        for rd in data:
                            ...
                            try:
                                if rd['title'] not in jobtitles:
                                    ...
                                    url = "https://advisorgroup.wd1.myworkdayjobs.com/wday/cxs/advisorgroup/Advisor_Career_Site" + str(rd['externalPath'])
                                    jobObj['url'] = url

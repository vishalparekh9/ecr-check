...
# Token
token = 'MY_WORKDAY_JOBS_AEAWEB_ORG'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://aba.wd1.myworkdayjobs.com/wday/cxs/aba/ABA/jobs'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://aba.wd1.myworkdayjobs.com/wday/cxs/aba/ABA/jobs'
                        ...
                        for rd in data:
                            ...
                            try:
                                if rd['title'] not in jobtitles:
                                    ...
                                    url = "https://aba.wd1.myworkdayjobs.com/wday/cxs/aba/ABA" + str(rd['externalPath'])
                                    jobObj['url'] = url

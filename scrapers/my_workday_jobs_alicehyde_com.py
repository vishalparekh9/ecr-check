...
# Token
token = 'MY_WORKDAY_JOBS_ALICEHYDE_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://uvmhealth.wd1.myworkdayjobs.com/wday/cxs/uvmhealth/AHMC/jobs'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://uvmhealth.wd1.myworkdayjobs.com/wday/cxs/uvmhealth/AHMC/jobs'
                        ...
                        for rd in data:
                            ...
                            try:
                                if rd['title'] not in jobtitles:
                                    ...
                                    url = "https://uvmhealth.wd1.myworkdayjobs.com/wday/cxs/uvmhealth/AHMC" + str(rd['externalPath'])
                                    jobObj['url'] = url

...
# Token
token = 'MY_WORKDAY_JOBS_AMGEN_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://amgen.wd1.myworkdayjobs.com/wday/cxs/amgen/Careers/jobs'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://amgen.wd1.myworkdayjobs.com/wday/cxs/amgen/Careers/jobs'
                        ...
                        for rd in data:
                            ...
                            try:
                                if rd['title'] not in jobtitles:
                                    ...
                                    url = "https://amgen.wd1.myworkdayjobs.com/wday/cxs/amgen/Careers" + str(rd['externalPath'])
                                    jobObj['url'] = url

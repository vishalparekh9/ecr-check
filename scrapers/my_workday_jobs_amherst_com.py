...
# Token
token = 'MY_WORKDAY_JOBS_AMHERST_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://amherstgroup.wd1.myworkdayjobs.com/wday/cxs/amherstgroup/Amherst_Holdings_Careers/jobs'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://amherstgroup.wd1.myworkdayjobs.com/wday/cxs/amherstgroup/Amherst_Holdings_Careers/jobs'
                        ...
                        for rd in data:
                            ...
                            try:
                                if rd['title'] not in jobtitles:
                                    ...
                                    url = "https://amherstgroup.wd1.myworkdayjobs.com/wday/cxs/amherstgroup/Amherst_Holdings_Careers" + str(rd['externalPath'])
                                    jobObj['url'] = url

...
# Token
token = 'MY_WORKDAY_JOBS_AMNCAREERS_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://amn.wd1.myworkdayjobs.com/wday/cxs/amn/AMN_Careers/jobs'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://amn.wd1.myworkdayjobs.com/wday/cxs/amn/AMN_Careers/jobs'
                        ...
                        for rd in data:
                            ...
                            try:
                                if rd['title'] not in jobtitles:
                                    ...
                                    url = "https://amn.wd1.myworkdayjobs.com/wday/cxs/amn/AMN_Careers" + str(rd['externalPath'])
                                    jobObj['url'] = url

...
# Token
token = 'MY_WORKDAY_JOBS_AMPLIFY_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://amplify.wd1.myworkdayjobs.com/wday/cxs/amplify/Amplify_Careers/jobs'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://amplify.wd1.myworkdayjobs.com/wday/cxs/amplify/Amplify_Careers/jobs'
                        ...
                        for rd in data:
                            ...
                            try:
                                if rd['title'] not in jobtitles:
                                    ...
                                    url = "https://amplify.wd1.myworkdayjobs.com/wday/cxs/amplify/Amplify_Careers" + str(rd['externalPath'])
                                    jobObj['url'] = url

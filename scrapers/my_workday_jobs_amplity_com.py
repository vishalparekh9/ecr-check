...
# Token
token = 'MY_WORKDAY_JOBS_AMPLITY_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://amplity.wd1.myworkdayjobs.com/wday/cxs/amplity/AmplityHealth/jobs'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://amplity.wd1.myworkdayjobs.com/wday/cxs/amplity/AmplityHealth/jobs'
                        ...
                        for rd in data:
                            ...
                            try:
                                if rd['title'] not in jobtitles:
                                    ...
                                    url = "https://amplity.wd1.myworkdayjobs.com/wday/cxs/amplity/AmplityHealth" + str(rd['externalPath'])
                                    jobObj['url'] = url

...
# Token
token = 'MY_WORKDAY_JOBS_APEXUS_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://vizient.wd1.myworkdayjobs.com/wday/cxs/vizient/Vizient_Careers/jobs'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://vizient.wd1.myworkdayjobs.com/wday/cxs/vizient/Vizient_Careers/jobs'
                        ...
                        for rd in data:
                            ...
                            try:
                                if rd['title'] not in jobtitles:
                                    ...
                                    url = "https://vizient.wd1.myworkdayjobs.com/wday/cxs/vizient/Vizient_Careers" + str(rd['externalPath'])
                                    jobObj['url'] = url

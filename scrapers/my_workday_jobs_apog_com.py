...
# Token
token = 'MY_WORKDAY_JOBS_APOG_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://apog.wd1.myworkdayjobs.com/wday/cxs/apog/Apogee/jobs'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://apog.wd1.myworkdayjobs.com/wday/cxs/apog/Apogee/jobs'
                        ...
                        for rd in data:
                            ...
                            try:
                                if rd['title'] not in jobtitles:
                                    ...
                                    url = "https://apog.wd1.myworkdayjobs.com/wday/cxs/apog/Apogee" + str(rd['externalPath'])
                                    jobObj['url'] = url

...
# Token
token = 'MY_WORKDAY_JOBS_ARIESSYS_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://relx.wd3.myworkdayjobs.com/wday/cxs/relx/ElsevierJobs/jobs'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://relx.wd3.myworkdayjobs.com/wday/cxs/relx/ElsevierJobs/jobs'
                        ...
                        for rd in data:
                            ...
                            try:
                                if rd['title'] not in jobtitles:
                                    ...
                                    url = "https://relx.wd3.myworkdayjobs.com/wday/cxs/relx/ElsevierJobs" + str(rd['externalPath'])
                                    jobObj['url'] = url

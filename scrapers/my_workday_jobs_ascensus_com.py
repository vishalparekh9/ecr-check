...
# Token
token = 'MY_WORKDAY_JOBS_ASCENSUS_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://ascensushr.wd1.myworkdayjobs.com/wday/cxs/ascensushr/ascensuscareers/jobs'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://ascensushr.wd1.myworkdayjobs.com/wday/cxs/ascensushr/ascensuscareers/jobs'
                        ...
                        for rd in data:
                            ...
                            try:
                                if rd['title'] not in jobtitles:
                                    ...
                                    url = "https://ascensushr.wd1.myworkdayjobs.com/wday/cxs/ascensushr/ascensuscareers" + str(rd['externalPath'])
                                    jobObj['url'] = url

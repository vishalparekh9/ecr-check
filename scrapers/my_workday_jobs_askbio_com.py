...
# Token
token = 'MY_WORKDAY_JOBS_ASKBIO_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://askbio.wd1.myworkdayjobs.com/wday/cxs/askbio/AskBio/jobs'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://askbio.wd1.myworkdayjobs.com/wday/cxs/askbio/AskBio/jobs'
                        ...
                        for rd in data:
                            ...
                            try:
                                if rd['title'] not in jobtitles:
                                    ...
                                    url = "https://askbio.wd1.myworkdayjobs.com/wday/cxs/askbio/AskBio" + str(rd['externalPath'])
                                    jobObj['url'] = url

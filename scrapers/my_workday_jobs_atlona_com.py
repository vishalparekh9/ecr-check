...
# Token
token = 'MY_WORKDAY_JOBS_ATLONA_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://panduit.wd1.myworkdayjobs.com/wday/cxs/panduit/International/jobs'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://panduit.wd1.myworkdayjobs.com/wday/cxs/panduit/International/jobs'
                        ...
                        for rd in data:
                            ...
                            try:
                                if rd['title'] not in jobtitles:
                                    ...
                                    url = "https://panduit.wd1.myworkdayjobs.com/wday/cxs/panduit/International" + str(rd['externalPath'])
                                    jobObj['url'] = url

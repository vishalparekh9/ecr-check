...
# Token
token = 'MY_WORKDAY_JOBS_BARR_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://barr.wd1.myworkdayjobs.com/wday/cxs/barr/BarrCareers/jobs'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://barr.wd1.myworkdayjobs.com/wday/cxs/barr/BarrCareers/jobs'
                        ...
                        for rd in data:
                            ...
                            try:
                                if rd['title'] not in jobtitles:
                                    ...
                                    url = "https://barr.wd1.myworkdayjobs.com/wday/cxs/barr/BarrCareers" + str(rd['externalPath'])
                                    jobObj['url'] = url

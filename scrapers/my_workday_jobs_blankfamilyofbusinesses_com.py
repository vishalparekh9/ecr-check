...
# Token
token = 'MY_WORKDAY_JOBS_BLANKFAMILYOFBUSINESSES_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://ambgroup.wd1.myworkdayjobs.com/wday/cxs/ambgroup/AMBSE/jobs'
        ...
        self.domain = 'blankfamilyofbusinesses.com'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://ambgroup.wd1.myworkdayjobs.com/wday/cxs/ambgroup/AMBSE/jobs'
                        ...
                        for rd in data:
                            ...
                            try:
                                if rd['title'] not in jobtitles:
                                    ...
                                    url = "https://ambgroup.wd1.myworkdayjobs.com/wday/cxs/ambgroup/AMBSE" + str(rd['externalPath'])
                                    jobObj['url'] = url

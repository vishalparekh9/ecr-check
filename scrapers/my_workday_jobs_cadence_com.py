...
# Token
token = 'MY_WORKDAY_JOBS_CADENCE_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://cadence.wd1.myworkdayjobs.com/wday/cxs/cadence/External_Careers/jobs'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://cadence.wd1.myworkdayjobs.com/wday/cxs/cadence/External_Careers/jobs'
                        ...
                        for rd in data:
                            ...
                            try:
                                if rd['title'] not in jobtitles:
                                    ...
                                    url = "https://cadence.wd1.myworkdayjobs.com/wday/cxs/cadence/External_Careers" + str(rd['externalPath'])
                                    jobObj['url'] = url

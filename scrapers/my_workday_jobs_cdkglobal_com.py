...
# Token
token = 'MY_WORKDAY_JOBS_CDKGLOBAL_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://cdk.wd1.myworkdayjobs.com/wday/cxs/cdk/CDK/jobs'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://cdk.wd1.myworkdayjobs.com/wday/cxs/cdk/CDK/jobs'
                        ...
                        for rd in data:
                            ...
                            try:
                                if rd['title'] not in jobtitles:
                                    ...
                                    url = "https://cdk.wd1.myworkdayjobs.com/wday/cxs/cdk/CDK" + str(rd['externalPath'])
                                    jobObj['url'] = url

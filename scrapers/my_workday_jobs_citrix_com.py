...
# Token
token = 'MY_WORKDAY_JOBS_CITRIX_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://citrix.wd1.myworkdayjobs.com/wday/cxs/citrix/CitrixCareers/jobs'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://citrix.wd1.myworkdayjobs.com/wday/cxs/citrix/CitrixCareers/jobs'
                        ...
                        for rd in data:
                            ...
                            try:
                                if rd['title'] not in jobtitles:
                                    ...
                                    url = "https://citrix.wd1.myworkdayjobs.com/wday/cxs/citrix/CitrixCareers" + str(rd['externalPath'])
                                    jobObj['url'] = url

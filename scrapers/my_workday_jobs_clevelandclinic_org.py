...
# Token
token = 'MY_WORKDAY_JOBS_CLEVELANDCLINIC_ORG'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://ccf.wd1.myworkdayjobs.com/wday/cxs/ccf/ClevelandClinicCareers/jobs'
        ...
        self.domain = 'clevelandclinic.org'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://ccf.wd1.myworkdayjobs.com/wday/cxs/ccf/ClevelandClinicCareers/jobs'
                        ...
                        for rd in data:
                            ...
                            try:
                                if rd['title'] not in jobtitles:
                                    ...
                                    url = "https://ccf.wd1.myworkdayjobs.com/wday/cxs/ccf/ClevelandClinicCareers" + str(rd['externalPath'])
                                    jobObj['url'] = url

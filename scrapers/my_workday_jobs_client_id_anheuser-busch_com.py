...
# Token
token = 'MY_WORKDAY_JOBS_CLIENT_ID_ANHEUSER-BUSCH_COM'

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://wd1.myworkdaysite.com/en-US/recruiting/abinbev/USA?clientRequestID=03144377c9184a7aa0fdd4d1fffbeda9' 
        ...
        self.domain = 'anheuser-busch.com'
    ...
    def process_logic(self):
        try:
            ...
            while isdata:
                isdata = False
                url = 'https://wd1.myworkdaysite.com/en-US/recruiting/abinbev/USA?clientRequestID=03144377c9184a7aa0fdd4d1fffbeda9'

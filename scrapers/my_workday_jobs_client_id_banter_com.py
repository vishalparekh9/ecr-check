...
# Token
token = 'MY_WORKDAY_JOBS_CLIENT_ID_BANTER_COM'

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://signetjewelers.wd1.myworkdayjobs.com/Banter/jobs?clientRequestID=6d758f6c09374f5d956263dc5babdee9' 
    ...
    def process_logic(self):
        try:
            ...
            while isdata:
                isdata = False
                url = 'https://signetjewelers.wd1.myworkdayjobs.com/Banter/jobs?clientRequestID=6d758f6c09374f5d956263dc5babdee9'
                ...
                if isloaded:
                    ...
                    if 'listItems' in res.json()['body']['children'][0]['children'][0]:
                        ...
                        for link in lis:
                            ...
                            url = 'https://signetjewelers.wd1.myworkdayjobs.com' + a
                            jobObj['url'] = url

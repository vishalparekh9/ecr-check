...
# Token
token = 'MY_WORKDAY_JOBS_CLIENT_ID_CBOE_COM'

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://cboe.wd1.myworkdayjobs.com/External_Career_CBOE/jobs?clientRequestID=4e1e31ecdcb3417bab54563bff928c1f' 
    ...
    def process_logic(self):
        try:
            ...
            while isdata:
                isdata = False
                url = 'https://cboe.wd1.myworkdayjobs.com/External_Career_CBOE/jobs?clientRequestID=4e1e31ecdcb3417bab54563bff928c1f'
                ...
                if isloaded:
                    ...
                    if 'listItems' in res.json()['body']['children'][0]['children'][0]:
                        ...
                        for link in lis:
                            ...
                            url = 'https://cboe.wd1.myworkdayjobs.com' + a
                            jobObj['url'] = url

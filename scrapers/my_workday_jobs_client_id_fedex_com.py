...
# Token
token = 'MY_WORKDAY_JOBS_CLIENT_ID_FEDEX_COM'

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://fedex.wd1.myworkdayjobs.com/FXS-FXC_External_Career_Site/jobs?clientRequestID=211d8f13b8bd43aaad7a80618cd552ef' 
    ...
    def process_logic(self):
        try:
            ...
            while isdata:
                isdata = False
                url = 'https://fedex.wd1.myworkdayjobs.com/FXS-FXC_External_Career_Site/jobs?clientRequestID=211d8f13b8bd43aaad7a80618cd552ef'
                ...
                if isloaded:
                    ...
                    if 'listItems' in res.json()['body']['children'][0]['children'][0]:
                        ...
                        for link in lis:
                            ...
                            url = 'https://fedex.wd1.myworkdayjobs.com' + a
                            jobObj['url'] = url

...
# Token
token = 'MY_WORKDAY_JOBS_ECOLAB_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://ecolab.wd1.myworkdayjobs.com/wday/cxs/ecolab/Ecolab_External/jobs'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://ecolab.wd1.myworkdayjobs.com/wday/cxs/ecolab/Ecolab_External/jobs'
                        ...
                        for rd in data:
                            ...
                            try:
                                if rd['title'] not in jobtitles:
                                    ...
                                    url = "https://ecolab.wd1.myworkdayjobs.com/wday/cxs/ecolab/Ecolab_External" + str(rd['externalPath'])
                                    jobObj['url'] = url

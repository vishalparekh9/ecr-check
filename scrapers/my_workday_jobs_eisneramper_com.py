...
# Token
token = 'MY_WORKDAY_JOBS_EISNERAMPER_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://eisneramper.wd1.myworkdayjobs.com/wday/cxs/eisneramper/EisnerAmper_External/jobs'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://eisneramper.wd1.myworkdayjobs.com/wday/cxs/eisneramper/EisnerAmper_External/jobs'
                        ...
                        for rd in data:
                            ...
                            try:
                                if rd['title'] not in jobtitles:
                                    ...
                                    url = "https://eisneramper.wd1.myworkdayjobs.com/wday/cxs/eisneramper/EisnerAmper_External" + str(rd['externalPath'])
                                    jobObj['url'] = url

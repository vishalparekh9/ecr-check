...
# Token
token = 'MY_WORKDAY_JOBS_FINICITY_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://mastercard.wd1.myworkdayjobs.com/wday/cxs/mastercard/CorporateCareers/jobs'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://mastercard.wd1.myworkdayjobs.com/wday/cxs/mastercard/CorporateCareers/jobs'
                        ...
                        for rd in data:
                            ...
                            try:
                                if rd['title'] not in jobtitles:
                                    ...
                                    url = "https://mastercard.wd1.myworkdayjobs.com/wday/cxs/mastercard/CorporateCareers" + str(rd['externalPath'])
                                    jobObj['url'] = url

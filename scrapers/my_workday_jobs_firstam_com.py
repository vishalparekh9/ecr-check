...
# Token
token = 'MY_WORKDAY_JOBS_FIRSTAM_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://firstam.wd1.myworkdayjobs.com/wday/cxs/firstam/firstamericancareers/jobs'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://firstam.wd1.myworkdayjobs.com/wday/cxs/firstam/firstamericancareers/jobs'
                        ...
                        for rd in data:
                            ...
                            try:
                                if rd['title'] not in jobtitles:
                                    ...
                                    url = "https://firstam.wd1.myworkdayjobs.com/wday/cxs/firstam/firstamericancareers" + str(rd['externalPath'])
                                    jobObj['url'] = url

...
# Token
token = 'MY_WORKDAY_JOBS_FIVEBELOW_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://fivebelow.wd1.myworkdayjobs.com/wday/cxs/fivebelow/fivebelowcareers/jobs'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://fivebelow.wd1.myworkdayjobs.com/wday/cxs/fivebelow/fivebelowcareers/jobs'
                        ...
                        for rd in data:
                            ...
                            try:
                                if rd['title'] not in jobtitles:
                                    ...
                                    url = "https://fivebelow.wd1.myworkdayjobs.com/wday/cxs/fivebelow/fivebelowcareers" + str(rd['externalPath'])
                                    jobObj['url'] = url

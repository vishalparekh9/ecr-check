...
# Token
token = 'MY_WORKDAY_JOBS_FORDFOUNDATION_ORG'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://fordfoundation.wd1.myworkdayjobs.com/wday/cxs/fordfoundation/FordFoundationCareerPage/jobs'
        ...
        self.domain = 'fordfoundation.org'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://fordfoundation.wd1.myworkdayjobs.com/wday/cxs/fordfoundation/FordFoundationCareerPage/jobs'
                        ...
                        for rd in data:
                            ...
                            try:
                                if rd['title'] not in jobtitles:
                                    ...
                                    url = "https://fordfoundation.wd1.myworkdayjobs.com/wday/cxs/fordfoundation/FordFoundationCareerPage" + str(rd['externalPath'])
                                    jobObj['url'] = url

...
# Token
token = 'MY_WORKDAY_JOBS_FRANKLINEQUIPMENT_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://ur.wd1.myworkdayjobs.com/wday/cxs/ur/URcareers/jobs'
        ...
        self.domain = 'franklinequipment.com'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://ur.wd1.myworkdayjobs.com/wday/cxs/ur/URcareers/jobs'
                        ...
                        for rd in data:
                            ...
                            try:
                                if rd['title'] not in jobtitles:
                                    ...
                                    url = "https://ur.wd1.myworkdayjobs.com/wday/cxs/ur/URcareers" + str(rd['externalPath'])
                                    jobObj['url'] = url

...
# Token
token = 'MY_WORKDAY_JOBS_HEARTLANDPAYMENTSYSTEMS_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://tsys.wd1.myworkdayjobs.com/wday/cxs/tsys/HeartlandCareers/jobs'
        ...
        self.domain = 'heartlandpaymentsystems.com'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://tsys.wd1.myworkdayjobs.com/wday/cxs/tsys/HeartlandCareers/jobs'
                        ...
                        for rd in data:
                            ...
                            try:
                                if rd['title'] not in jobtitles:
                                    ...
                                    url = "https://tsys.wd1.myworkdayjobs.com/wday/cxs/tsys/HeartlandCareers" + str(rd['externalPath'])
                                    jobObj['url'] = url

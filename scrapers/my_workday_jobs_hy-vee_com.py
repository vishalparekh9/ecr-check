...
# Token
token = 'MY_WORKDAY_JOBS_HY-VEE_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://hyvee.wd1.myworkdayjobs.com/wday/cxs/hyvee/HyVeeCareers/jobs'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://hyvee.wd1.myworkdayjobs.com/wday/cxs/hyvee/HyVeeCareers/jobs'
                        ...
                        for rd in data:
                            ...
                            try:
                                if rd['title'] not in jobtitles:
                                    ...
                                    url = "https://hyvee.wd1.myworkdayjobs.com/wday/cxs/hyvee/HyVeeCareers" + str(rd['externalPath'])
                                    jobObj['url'] = url

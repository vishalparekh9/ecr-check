...
# Token
token = 'MY_WORKDAY_JOBS_HYTRUST_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://entrust.wd1.myworkdayjobs.com/wday/cxs/entrust/EntrustCareers/jobs'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://entrust.wd1.myworkdayjobs.com/wday/cxs/entrust/EntrustCareers/jobs'
                        ...
                        for rd in data:
                            ...
                            try:
                                if rd['title'] not in jobtitles:
                                    ...
                                    url = "https://entrust.wd1.myworkdayjobs.com/wday/cxs/entrust/EntrustCareers" + str(rd['externalPath'])
                                    jobObj['url'] = url

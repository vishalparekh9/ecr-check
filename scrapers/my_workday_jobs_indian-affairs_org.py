...
# Token
token = 'MY_WORKDAY_JOBS_INDIAN-AFFAIRS_ORG'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://cni.wd1.myworkdayjobs.com/wday/cxs/cni/CNI/jobs'
        ...
        self.domain = 'indian-affairs.org'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://cni.wd1.myworkdayjobs.com/wday/cxs/cni/CNI/jobs'
                        ...
                        for rd in data:
                            ...
                            try:
                                if rd['title'] not in jobtitles:
                                    ...
                                    url = "https://cni.wd1.myworkdayjobs.com/wday/cxs/cni/CNI" + str(rd['externalPath'])
                                    jobObj['url'] = url

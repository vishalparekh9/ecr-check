...
# Token
token = 'MY_WORKDAY_JOBS_INTRALINKS_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://wd1.myworkdaysite.com/wday/cxs/ssctech/SSCTechnologies/jobs'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://wd1.myworkdaysite.com/wday/cxs/ssctech/SSCTechnologies/jobs'
                        ...
                        for rd in data:
                            ...
                            try:
                                if rd['title'] not in jobtitles:
                                    ...
                                    url = "https://wd1.myworkdaysite.com/wday/cxs/ssctech/SSCTechnologies" + str(rd['externalPath'])
                                    jobObj['url'] = url

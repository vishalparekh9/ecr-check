...
# Token
token = 'MY_WORKDAY_JOBS_INVENERGY_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://invenergyllc.wd1.myworkdayjobs.com/wday/cxs/invenergyllc/invenergycareers/jobs'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://invenergyllc.wd1.myworkdayjobs.com/wday/cxs/invenergyllc/invenergycareers/jobs'
                        ...
                        for rd in data:
                            ...
                            try:
                                if rd['title'] not in jobtitles:
                                    ...
                                    url = "https://invenergyllc.wd1.myworkdayjobs.com/wday/cxs/invenergyllc/invenergycareers" + str(rd['externalPath'])
                                    jobObj['url'] = url

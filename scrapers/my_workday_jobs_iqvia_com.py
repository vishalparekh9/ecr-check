...
# Token
token = 'MY_WORKDAY_JOBS_IQVIA_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://iqvia.wd1.myworkdayjobs.com/wday/cxs/iqvia/IQVIA/jobs'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://iqvia.wd1.myworkdayjobs.com/wday/cxs/iqvia/IQVIA/jobs'
                        ...
                        for rd in data:
                            ...
                            try:
                                if rd['title'] not in jobtitles:
                                    ...
                                    url = "https://iqvia.wd1.myworkdayjobs.com/wday/cxs/iqvia/IQVIA" + str(rd['externalPath'])
                                    jobObj['url'] = url

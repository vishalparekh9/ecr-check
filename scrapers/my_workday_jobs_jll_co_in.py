...
# Token
token = 'MY_WORKDAY_JOBS_JLL_CO_IN'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://jll.wd1.myworkdayjobs.com/wday/cxs/jll/jllcareers/jobs'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://jll.wd1.myworkdayjobs.com/wday/cxs/jll/jllcareers/jobs'
                        ...
                        for rd in data:
                            ...
                            try:
                                if rd['title'] not in jobtitles:
                                    ...
                                    url = "https://jll.wd1.myworkdayjobs.com/wday/cxs/jll/jllcareers" + str(rd['externalPath'])
                                    jobObj['url'] = url

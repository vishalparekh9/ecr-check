...
# Token
token = 'MY_WORKDAY_JOBS_NATIONWIDE_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://nationwide.wd1.myworkdayjobs.com/wday/cxs/nationwide/Nationwide_Career/jobs'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://nationwide.wd1.myworkdayjobs.com/wday/cxs/nationwide/Nationwide_Career/jobs'
                        ...
                        for rd in data:
                            ...
                            try:
                                if rd['title'] not in jobtitles:
                                    ...
                                    url = "https://nationwide.wd1.myworkdayjobs.com/wday/cxs/nationwide/Nationwide_Career" + str(rd['externalPath'])
                                    jobObj['url'] = url

...
# Token
token = 'MY_WORKDAY_JOBS_NORTHROPGRUMMAN_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://ngc.wd1.myworkdayjobs.com/wday/cxs/ngc/Northrop_Grumman_External_Site/jobs'
        ...
        self.domain = 'northropgrumman.com'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://ngc.wd1.myworkdayjobs.com/wday/cxs/ngc/Northrop_Grumman_External_Site/jobs'
                        ...
                        for rd in data:
                            ...
                            try:
                                if rd['title'] not in jobtitles:
                                    ...
                                    url = "https://ngc.wd1.myworkdayjobs.com/wday/cxs/ngc/Northrop_Grumman_External_Site" + str(rd['externalPath'])
                                    jobObj['url'] = url

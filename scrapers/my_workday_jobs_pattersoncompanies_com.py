...
# Token
token = 'MY_WORKDAY_JOBS_PATTERSONCOMPANIES_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://pattersoncompanies.wd1.myworkdayjobs.com/wday/cxs/pattersoncompanies/PDCO/jobs'
        ...
        self.domain = 'pattersoncompanies.com'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://pattersoncompanies.wd1.myworkdayjobs.com/wday/cxs/pattersoncompanies/PDCO/jobs'
                        ...
                        for rd in data:
                            ...
                            try:
                                if rd['title'] not in jobtitles:
                                    ...
                                    url = "https://pattersoncompanies.wd1.myworkdayjobs.com/wday/cxs/pattersoncompanies/PDCO" + str(rd['externalPath'])
                                    jobObj['url'] = url

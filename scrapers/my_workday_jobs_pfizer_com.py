...
# Token
token = 'MY_WORKDAY_JOBS_PFIZER_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://pfizer.wd1.myworkdayjobs.com/wday/cxs/pfizer/PfizerCareers/jobs'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://pfizer.wd1.myworkdayjobs.com/wday/cxs/pfizer/PfizerCareers/jobs'
                        ...
                        for rd in data:
                            ...
                            try:
                                if rd['title'] not in jobtitles:
                                    ...
                                    url = "https://pfizer.wd1.myworkdayjobs.com/wday/cxs/pfizer/PfizerCareers" + str(rd['externalPath'])
                                    jobObj['url'] = url

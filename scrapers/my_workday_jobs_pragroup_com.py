...
# Token
token = 'MY_WORKDAY_JOBS_PRAGROUP_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://pra.wd1.myworkdayjobs.com/wday/cxs/pra/PRA_Careers/jobs'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://pra.wd1.myworkdayjobs.com/wday/cxs/pra/PRA_Careers/jobs'
                        ...
                        for rd in data:
                            ...
                            try:
                                if rd['title'] not in jobtitles:
                                    ...
                                    url = "https://pra.wd1.myworkdayjobs.com/wday/cxs/pra/PRA_Careers" + str(rd['externalPath'])
                                    jobObj['url'] = url

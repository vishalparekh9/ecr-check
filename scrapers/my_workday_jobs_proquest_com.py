...
# Token
token = 'MY_WORKDAY_JOBS_PROQUEST_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://clarivate.wd3.myworkdayjobs.com/wday/cxs/clarivate/Clarivate_Careers/jobs'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://clarivate.wd3.myworkdayjobs.com/wday/cxs/clarivate/Clarivate_Careers/jobs'
                        ...
                        for rd in data:
                            ...
                            try:
                                if rd['title'] not in jobtitles:
                                    ...
                                    url = "https://clarivate.wd3.myworkdayjobs.com/wday/cxs/clarivate/Clarivate_Careers" + str(rd['externalPath'])
                                    jobObj['url'] = url

...
# Token
token = 'MY_WORKDAY_JOBS_RECSOLU_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://cccis.wd1.myworkdayjobs.com/wday/cxs/cccis/CCCIS/jobs'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://cccis.wd1.myworkdayjobs.com/wday/cxs/cccis/CCCIS/jobs'
                        ...
                        for rd in data:
                            ...
                            try:
                                if rd['title'] not in jobtitles:
                                    ...
                                    url = "https://cccis.wd1.myworkdayjobs.com/wday/cxs/cccis/CCCIS" + str(rd['externalPath'])
                                    jobObj['url'] = url

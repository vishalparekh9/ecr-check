...
# Token
token = 'MY_WORKDAY_JOBS_SENSATA_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://sensata.wd1.myworkdayjobs.com/wday/cxs/sensata/Sensata-Careers/jobs'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://sensata.wd1.myworkdayjobs.com/wday/cxs/sensata/Sensata-Careers/jobs'
                        ...
                        for rd in data:
                            ...
                            try:
                                if rd['title'] not in jobtitles:
                                    ...
                                    url = "https://sensata.wd1.myworkdayjobs.com/wday/cxs/sensata/Sensata-Careers" + str(rd['externalPath'])
                                    jobObj['url'] = url

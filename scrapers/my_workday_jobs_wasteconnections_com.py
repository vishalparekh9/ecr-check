...
# Token
token = 'MY_WORKDAY_JOBS_WASTECONNECTIONS_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://wasteconnections.wd1.myworkdayjobs.com/wday/cxs/wasteconnections/Careers/jobs'
        ...
        self.domain = 'wasteconnections.com'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://wasteconnections.wd1.myworkdayjobs.com/wday/cxs/wasteconnections/Careers/jobs'
                        ...
                        for rd in data:
                            ...
                            try:
                                if rd['title'] not in jobtitles:
                                    ...
                                    url = "https://wasteconnections.wd1.myworkdayjobs.com/wday/cxs/wasteconnections/Careers" + str(rd['externalPath'])
                                    jobObj['url'] = url

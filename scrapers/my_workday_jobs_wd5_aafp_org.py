...
# Token
token = 'MY_WORKDAY_JOBS_WD5_AAFP_ORG'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://aafp.wd5.myworkdayjobs.com/wday/cxs/aafp/AAFP_Careers/jobs'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://aafp.wd5.myworkdayjobs.com/wday/cxs/aafp/AAFP_Careers/jobs'
                        ...
                        for rd in data:
                            ...
                            try:
                                if rd not in jobtitles:
                                    ...
                                    url = "https://aafp.wd5.myworkdayjobs.com/wday/cxs/aafp/AAFP_Careers" + str(rd['externalPath'])
                                    jobObj['url'] = url

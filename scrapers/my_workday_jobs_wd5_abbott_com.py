...
# Token
token = 'MY_WORKDAY_JOBS_WD5_ABBOTT_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://abbott.wd5.myworkdayjobs.com/wday/cxs/abbott/abbottcareers/jobs'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://abbott.wd5.myworkdayjobs.com/wday/cxs/abbott/abbottcareers/jobs'
                        ...
                        for rd in data:
                            ...
                            try:
                                if rd not in jobtitles:
                                    ...
                                    url = "https://abbott.wd5.myworkdayjobs.com/wday/cxs/abbott/abbottcareers" + str(rd['externalPath'])
                                    jobObj['url'] = url

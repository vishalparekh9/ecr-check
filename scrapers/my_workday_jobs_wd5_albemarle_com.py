...
# Token
token = 'MY_WORKDAY_JOBS_WD5_ALBEMARLE_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://albemarle.wd5.myworkdayjobs.com/wday/cxs/albemarle/External/jobs'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://albemarle.wd5.myworkdayjobs.com/wday/cxs/albemarle/External/jobs'
                        ...
                        for rd in data:
                            ...
                            try:
                                if rd not in jobtitles:
                                    ...
                                    url = "https://albemarle.wd5.myworkdayjobs.com/wday/cxs/albemarle/External" + str(rd['externalPath'])
                                    jobObj['url'] = url

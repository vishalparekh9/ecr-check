...
# Token
token = 'MY_WORKDAY_JOBS_WD5_ALLINAHEALTH_ORG'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://allina.wd5.myworkdayjobs.com/wday/cxs/allina/External/jobs'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://allina.wd5.myworkdayjobs.com/wday/cxs/allina/External/jobs'
                        ...
                        for rd in data:
                            ...
                            try:
                                if rd not in jobtitles:
                                    ...
                                    url = "https://allina.wd5.myworkdayjobs.com/wday/cxs/allina/External" + str(rd['externalPath'])
                                    jobObj['url'] = url

...
# Token
token = 'MY_WORKDAY_JOBS_WD5_AMERIHOME_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://westernalliancebank.wd5.myworkdayjobs.com/wday/cxs/westernalliancebank/AMH/jobs'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://westernalliancebank.wd5.myworkdayjobs.com/wday/cxs/westernalliancebank/AMH/jobs'
                        ...
                        for rd in data:
                            ...
                            try:
                                if rd not in jobtitles:
                                    ...
                                    url = "https://westernalliancebank.wd5.myworkdayjobs.com/wday/cxs/westernalliancebank/AMH" + str(rd['externalPath'])
                                    jobObj['url'] = url

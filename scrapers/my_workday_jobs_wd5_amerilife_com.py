...
# Token
token = 'MY_WORKDAY_JOBS_WD5_AMERILIFE_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://amerilife.wd5.myworkdayjobs.com/wday/cxs/amerilife/External/jobs'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://amerilife.wd5.myworkdayjobs.com/wday/cxs/amerilife/External/jobs'
                        ...
                        for rd in data:
                            ...
                            try:
                                if rd not in jobtitles:
                                    ...
                                    url = "https://amerilife.wd5.myworkdayjobs.com/wday/cxs/amerilife/External" + str(rd['externalPath'])
                                    jobObj['url'] = url

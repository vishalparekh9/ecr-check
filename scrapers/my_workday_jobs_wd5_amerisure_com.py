...
# Token
token = 'MY_WORKDAY_JOBS_WD5_AMERISURE_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://osv_amerisure.wd5.myworkdayjobs.com/wday/cxs/osv_amerisure/Amerisure/jobs'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://osv_amerisure.wd5.myworkdayjobs.com/wday/cxs/osv_amerisure/Amerisure/jobs'
                        ...
                        for rd in data:
                            ...
                            try:
                                if rd not in jobtitles:
                                    ...
                                    url = "https://osv_amerisure.wd5.myworkdayjobs.com/wday/cxs/osv_amerisure/Amerisure" + str(rd['externalPath'])
                                    jobObj['url'] = url

...
# Token
token = 'MY_WORKDAY_JOBS_WD5_ARIENSCO_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://arienscompany.wd5.myworkdayjobs.com/wday/cxs/arienscompany/External/jobs'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://arienscompany.wd5.myworkdayjobs.com/wday/cxs/arienscompany/External/jobs'
                        ...
                        for rd in data:
                            ...
                            try:
                                if rd not in jobtitles:
                                    ...
                                    url = "https://arienscompany.wd5.myworkdayjobs.com/wday/cxs/arienscompany/External" + str(rd['externalPath'])
                                    jobObj['url'] = url

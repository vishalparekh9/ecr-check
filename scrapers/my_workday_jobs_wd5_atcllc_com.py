...
# Token
token = 'MY_WORKDAY_JOBS_WD5_ATCLLC_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://atcllc.wd5.myworkdayjobs.com/wday/cxs/atcllc/atcllc/jobs'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://atcllc.wd5.myworkdayjobs.com/wday/cxs/atcllc/atcllc/jobs'
                        ...
                        for rd in data:
                            ...
                            try:
                                if rd not in jobtitles:
                                    ...
                                    url = "https://atcllc.wd5.myworkdayjobs.com/wday/cxs/atcllc/atcllc" + str(rd['externalPath'])
                                    jobObj['url'] = url

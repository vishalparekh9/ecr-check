...
# Token
token = 'MY_WORKDAY_JOBS_WD5_BADGERMETER_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://badgermeter.wd5.myworkdayjobs.com/wday/cxs/badgermeter/badger_meter_europe/jobs'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://badgermeter.wd5.myworkdayjobs.com/wday/cxs/badgermeter/badger_meter_europe/jobs'
                        ...
                        for rd in data:
                            ...
                            try:
                                if rd not in jobtitles:
                                    ...
                                    url = "https://badgermeter.wd5.myworkdayjobs.com/wday/cxs/badgermeter/badger_meter_europe" + str(rd['externalPath'])
                                    jobObj['url'] = url

...
# Token
token = 'MY_WORKDAY_JOBS_WD5_BEAUMONT_ORG'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://spectrumhealth.wd5.myworkdayjobs.com/wday/cxs/spectrumhealth/SpectrumHealthCareers/jobs'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://spectrumhealth.wd5.myworkdayjobs.com/wday/cxs/spectrumhealth/SpectrumHealthCareers/jobs'
                ...
                if isloaded:
                    ...
                    if len(data) > 0:
                        for rd in data:
                            ...
                            try:
                                if rd not in jobtitles:
                                    jobtitles.append(rd)
                                    jobObj['title'] = rd['title']
                                    jobObj['location'] = str(rd['locationsText'])
                                    url = "https://spectrumhealth.wd5.myworkdayjobs.com/wday/cxs/spectrumhealth/SpectrumHealthCareers" + str(rd['externalPath'])
                                    jobObj['url'] = url

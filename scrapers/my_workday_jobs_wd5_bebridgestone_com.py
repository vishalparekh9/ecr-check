...
# Token
token = 'MY_WORKDAY_JOBS_WD5_BEBRIDGESTONE_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://bridgestone.wd5.myworkdayjobs.com/wday/cxs/bridgestone/external/jobs'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://bridgestone.wd5.myworkdayjobs.com/wday/cxs/bridgestone/external/jobs'
                        ...
                        for rd in data:
                            ...
                            try:
                                if rd not in jobtitles:
                                    ...
                                    url = "https://bridgestone.wd5.myworkdayjobs.com/wday/cxs/bridgestone/external" + str(rd['externalPath'])
                                    jobObj['url'] = url

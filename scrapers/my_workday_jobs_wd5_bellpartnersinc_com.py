...
# Token
token = 'MY_WORKDAY_JOBS_WD5_BELLPARTNERSINC_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://bellpartnersinc.wd5.myworkdayjobs.com/wday/cxs/bellpartnersinc/Careers/jobs'
        ...
        self.domain = 'bellpartnersinc.com'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://bellpartnersinc.wd5.myworkdayjobs.com/wday/cxs/bellpartnersinc/Careers/jobs'
                        ...
                        for rd in data:
                            ...
                            try:
                                if rd not in jobtitles:
                                    ...
                                    url = "https://bellpartnersinc.wd5.myworkdayjobs.com/wday/cxs/bellpartnersinc/Careers" + str(rd['externalPath'])
                                    jobObj['url'] = url

...
# Token
token = 'MY_WORKDAY_JOBS_WD5_CAMPAIGNMONITOR_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://campaignmonitor.wd5.myworkdayjobs.com/wday/cxs/campaignmonitor/CM_Group/jobs'
        ...
        self.domain = 'campaignmonitor.com'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://campaignmonitor.wd5.myworkdayjobs.com/wday/cxs/campaignmonitor/CM_Group/jobs'
                        ...
                        for rd in data:
                            ...
                            try:
                                if rd not in jobtitles:
                                    ...
                                    url = "https://campaignmonitor.wd5.myworkdayjobs.com/wday/cxs/campaignmonitor/CM_Group" + str(rd['externalPath'])
                                    jobObj['url'] = url

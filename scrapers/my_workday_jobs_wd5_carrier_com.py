...
# Token
token = 'MY_WORKDAY_JOBS_WD5_CARRIER_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://carrier.wd5.myworkdayjobs.com/wday/cxs/carrier/jobs/jobs'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://carrier.wd5.myworkdayjobs.com/wday/cxs/carrier/jobs/jobs'
                        ...
                        for rd in data:
                            ...
                            try:
                                if rd not in jobtitles:
                                    ...
                                    url = "https://carrier.wd5.myworkdayjobs.com/wday/cxs/carrier/jobs" + str(rd['externalPath'])
                                    jobObj['url'] = url

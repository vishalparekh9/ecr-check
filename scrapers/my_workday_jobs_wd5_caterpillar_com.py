...
# Token
token = 'MY_WORKDAY_JOBS_WD5_CATERPILLAR_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://cat.wd5.myworkdayjobs.com/wday/cxs/cat/CaterpillarCareers/jobs'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://cat.wd5.myworkdayjobs.com/wday/cxs/cat/CaterpillarCareers/jobs'
                        ...
                        for rd in data:
                            ...
                            try:
                                if rd not in jobtitles:
                                    ...
                                    url = "https://cat.wd5.myworkdayjobs.com/wday/cxs/cat/CaterpillarCareers" + str(rd['externalPath'])
                                    print(url)
                                    jobObj['url'] = url

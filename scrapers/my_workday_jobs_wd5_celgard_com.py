...
# Token
token = 'MY_WORKDAY_JOBS_WD5_CELGARD_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://akamerica.wd5.myworkdayjobs.com/wday/cxs/akamerica/aka/jobs'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://akamerica.wd5.myworkdayjobs.com/wday/cxs/akamerica/aka/jobs'
                        ...
                        for rd in data:
                            ...
                            try:
                                if rd not in jobtitles:
                                    ...
                                    url = "https://akamerica.wd5.myworkdayjobs.com/wday/cxs/akamerica/aka" + str(rd['externalPath'])
                                    jobObj['url'] = url

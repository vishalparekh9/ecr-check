...
# Token
token = 'MY_WORKDAY_JOBS_WD5_CIGNA_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://cigna.wd5.myworkdayjobs.com/wday/cxs/cigna/cignacareers/jobs'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://cigna.wd5.myworkdayjobs.com/wday/cxs/cigna/cignacareers/jobs'
                        ...
                        for rd in data:
                            ...
                            try:
                                if rd not in jobtitles:
                                    ...
                                    url = "https://cigna.wd5.myworkdayjobs.com/wday/cxs/cigna/cignacareers" + str(rd['externalPath'])
                                    jobObj['url'] = url

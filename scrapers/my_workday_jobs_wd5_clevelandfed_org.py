...
# Token
token = 'MY_WORKDAY_JOBS_WD5_CLEVELANDFED_ORG'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://rb.wd5.myworkdayjobs.com/wday/cxs/rb/FRS/jobs'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://rb.wd5.myworkdayjobs.com/wday/cxs/rb/FRS/jobs'
                        ...
                        for rd in data:
                            ...
                            try:
                                if rd not in jobtitles:
                                    ...
                                    url = "https://rb.wd5.myworkdayjobs.com/wday/cxs/rb/FRS" + str(rd['externalPath'])
                                    jobObj['url'] = url

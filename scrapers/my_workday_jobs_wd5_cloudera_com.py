...
# Token
token = 'MY_WORKDAY_JOBS_WD5_CLOUDERA_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://cloudera.wd5.myworkdayjobs.com/wday/cxs/cloudera/External_Career/jobs'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://cloudera.wd5.myworkdayjobs.com/wday/cxs/cloudera/External_Career/jobs'
                        ...
                        for rd in data:
                            ...
                            try:
                                if rd not in jobtitles:
                                    ...
                                    url = "https://cloudera.wd5.myworkdayjobs.com/wday/cxs/cloudera/External_Career" + str(rd['externalPath'])
                                    jobObj['url'] = url

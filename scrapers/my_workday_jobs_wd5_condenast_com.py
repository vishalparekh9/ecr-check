...
# Token
token = 'MY_WORKDAY_JOBS_WD5_CONDENAST_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://condenast.wd5.myworkdayjobs.com/wday/cxs/condenast/CondeCareers/jobs'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://condenast.wd5.myworkdayjobs.com/wday/cxs/condenast/CondeCareers/jobs'
                        ...
                        for rd in data:
                            ...
                            try:
                                if rd not in jobtitles:
                                    ...
                                    url = "https://condenast.wd5.myworkdayjobs.com/wday/cxs/condenast/CondeCareers" + str(rd['externalPath'])
                                    jobObj['url'] = url

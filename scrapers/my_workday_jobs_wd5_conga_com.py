...
# Token
token = 'MY_WORKDAY_JOBS_WD5_CONGA_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://apttus.wd5.myworkdayjobs.com/wday/cxs/apttus/External/jobs'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://apttus.wd5.myworkdayjobs.com/wday/cxs/apttus/External/jobs'
                        ...
                        for rd in data:
                            ...
                            try:
                                if rd not in jobtitles:
                                    ...
                                    url = "https://apttus.wd5.myworkdayjobs.com/wday/cxs/apttus/External" + str(rd['externalPath'])
                                    jobObj['url'] = url

...
# Token
token = 'MY_WORKDAY_JOBS_WD5_DEALERSOCKET_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://solera.wd5.myworkdayjobs.com/wday/cxs/solera/Global_Career_Site/jobs'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://solera.wd5.myworkdayjobs.com/wday/cxs/solera/Global_Career_Site/jobs'
                        ...
                        for rd in data:
                            ...
                            try:
                                if rd not in jobtitles:
                                    ...
                                    url = "https://solera.wd5.myworkdayjobs.com/wday/cxs/solera/Global_Career_Site" + str(rd['externalPath'])
                                    jobObj['url'] = url

...
# Token
token = 'MY_WORKDAY_JOBS_WD5_DIVERSEY_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://diversey.wd5.myworkdayjobs.com/wday/cxs/diversey/Diversey/jobs'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://diversey.wd5.myworkdayjobs.com/wday/cxs/diversey/Diversey/jobs'
                        ...
                        for rd in data:
                            ...
                            try:
                                if rd not in jobtitles:
                                    ...
                                    url = "https://diversey.wd5.myworkdayjobs.com/wday/cxs/diversey/Diversey" + str(rd['externalPath'])
                                    jobObj['url'] = url

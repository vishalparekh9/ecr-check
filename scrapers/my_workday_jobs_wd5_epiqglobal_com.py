...
# Token
token = 'MY_WORKDAY_JOBS_WD5_EPIQGLOBAL_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://epiqsystems.wd5.myworkdayjobs.com/wday/cxs/epiqsystems/Epiq_Careers/jobs'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://epiqsystems.wd5.myworkdayjobs.com/wday/cxs/epiqsystems/Epiq_Careers/jobs'
                        ...
                        for rd in data:
                            ...
                            try:
                                if rd not in jobtitles:
                                    ...
                                    url = "https://epiqsystems.wd5.myworkdayjobs.com/wday/cxs/epiqsystems/Epiq_Careers" + str(rd['externalPath'])
                                    jobObj['url'] = url

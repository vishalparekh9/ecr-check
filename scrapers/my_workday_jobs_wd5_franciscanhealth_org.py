...
# Token
token = 'MY_WORKDAY_JOBS_WD5_FRANCISCANHEALTH_ORG'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://wd5.myworkdaysite.com/wday/cxs/franciscanalliance/FA_External_Career_Site/jobs'
        ...
        self.domain = 'franciscanhealth.org'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://wd5.myworkdaysite.com/wday/cxs/franciscanalliance/FA_External_Career_Site/jobs'
                        ...
                        for rd in data:
                            ...
                            try:
                                if rd not in jobtitles:
                                    ...
                                    url = "https://wd5.myworkdaysite.com/wday/cxs/franciscanalliance/FA_External_Career_Site" + str(rd['externalPath'])
                                    jobObj['url'] = url

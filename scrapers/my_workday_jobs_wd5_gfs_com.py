...
# Token
token = 'MY_WORKDAY_JOBS_WD5_GFS_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://gfs.wd5.myworkdayjobs.com/wday/cxs/gfs/usjobs-gen-gfs/jobs'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://gfs.wd5.myworkdayjobs.com/wday/cxs/gfs/usjobs-gen-gfs/jobs'
                        ...
                        for rd in data:
                            ...
                            try:
                                if rd not in jobtitles:
                                    ...
                                    url = "https://gfs.wd5.myworkdayjobs.com/wday/cxs/gfs/usjobs-gen-gfs" + str(rd['externalPath'])
                                    jobObj['url'] = url

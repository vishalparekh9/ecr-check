...
# Token
token = 'MY_WORKDAY_JOBS_WD5_GREENHILL_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://greenhill.wd5.myworkdayjobs.com/wday/cxs/greenhill/SearchJobs/jobs'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://greenhill.wd5.myworkdayjobs.com/wday/cxs/greenhill/SearchJobs/jobs'
                        ...
                        for rd in data:
                            ...
                            try:
                                if rd not in jobtitles:
                                    ...
                                    url = "https://greenhill.wd5.myworkdayjobs.com/wday/cxs/greenhill/SearchJobs" + str(rd['externalPath'])
                                    jobObj['url'] = url

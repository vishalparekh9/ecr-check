...
# Token
token = 'MY_WORKDAY_JOBS_WD5_GROUPONCAREERS_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://groupon.wd5.myworkdayjobs.com/wday/cxs/groupon/jobs/jobs'
        ...
        self.domain = 'grouponcareers.com'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://groupon.wd5.myworkdayjobs.com/wday/cxs/groupon/jobs/jobs'
                        ...
                        for rd in data:
                            ...
                            try:
                                if rd not in jobtitles:
                                    ...
                                    url = "https://groupon.wd5.myworkdayjobs.com/wday/cxs/groupon" + str(rd['externalPath'])
                                    jobObj['url'] = url

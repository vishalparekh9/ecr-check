...
# Token
token = 'MY_WORKDAY_JOBS_WD5_LIFEATEXPEDIAGROUP_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://expedia.wd5.myworkdayjobs.com/wday/cxs/expedia/search/jobs'
        ...
        self.domain = 'lifeatexpediagroup.com'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://expedia.wd5.myworkdayjobs.com/wday/cxs/expedia/search/jobs'
                        ...
                        for rd in data:
                            ...
                            try:
                                if rd not in jobtitles:
                                    ...
                                    url = "https://expedia.wd5.myworkdayjobs.com/wday/cxs/expedia/search" + str(rd['externalPath'])
                                    jobObj['url'] = url

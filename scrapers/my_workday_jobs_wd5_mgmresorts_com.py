...
# Token
token = 'MY_WORKDAY_JOBS_WD5_MGMRESORTS_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://mgmresorts.wd5.myworkdayjobs.com/wday/cxs/mgmresorts/MGMCareers/jobs'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://mgmresorts.wd5.myworkdayjobs.com/wday/cxs/mgmresorts/MGMCareers/jobs'
                        ...
                        for rd in data:
                            ...
                            try:
                                if rd not in jobtitles:
                                    ...
                                    url = "https://mgmresorts.wd5.myworkdayjobs.com/wday/cxs/mgmresorts/MGMCareers" + str(rd['externalPath'])
                                    jobObj['url'] = url

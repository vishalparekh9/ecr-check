...
# Token
token = 'MY_WORKDAY_JOBS_WD5_NEOGEN_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://neogen.wd5.myworkdayjobs.com/wday/cxs/neogen/neogencareers/jobs'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://neogen.wd5.myworkdayjobs.com/wday/cxs/neogen/neogencareers/jobs'
                        ...
                        for rd in data:
                            ...
                            try:
                                if rd not in jobtitles:
                                    ...
                                    url = "https://neogen.wd5.myworkdayjobs.com/wday/cxs/neogen/neogencareers" + str(rd['externalPath'])
                                    jobObj['url'] = url

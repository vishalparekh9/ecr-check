...
# Token
token = 'MY_WORKDAY_JOBS_WD5_SCI-CORP_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://sci.wd5.myworkdayjobs.com/wday/cxs/sci/SCI/jobs'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://sci.wd5.myworkdayjobs.com/wday/cxs/sci/SCI/jobs'
                        ...
                        for rd in data:
                            ...
                            try:
                                if rd not in jobtitles:
                                    ...
                                    url = "https://sci.wd5.myworkdayjobs.com/wday/cxs/sci/SCI" + str(rd['externalPath'])
                                    jobObj['url'] = url

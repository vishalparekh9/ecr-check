...
# Token
token = 'MY_WORKDAY_JOBS_WD5_WHOLEFOODSMARKET_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://wholefoods.wd5.myworkdayjobs.com/wday/cxs/wholefoods/wholefoods/jobs'
        ...
        self.domain = 'wholefoodsmarket.com'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://wholefoods.wd5.myworkdayjobs.com/wday/cxs/wholefoods/wholefoods/jobs'
                        ...
                        for rd in data:
                            ...
                            try:
                                if rd not in jobtitles:
                                    ...
                                    url = "https://wholefoods.wd5.myworkdayjobs.com/wday/cxs/wholefoods/wholefoods" + str(rd['externalPath'])
                                    jobObj['url'] = url

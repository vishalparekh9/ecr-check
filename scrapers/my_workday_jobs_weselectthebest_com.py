...
# Token
token = 'MY_WORKDAY_JOBS_WESELECTTHEBEST_COM'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://cswg.wd1.myworkdayjobs.com/wday/cxs/cswg/CS_Careers/jobs'
        ...
        self.domain = 'weselectthebest.com'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://cswg.wd1.myworkdayjobs.com/wday/cxs/cswg/CS_Careers/jobs'
                        ...
                        for rd in data:
                            ...
                            try:
                                if rd['title'] not in jobtitles:
                                    ...
                                    url = "https://cswg.wd1.myworkdayjobs.com/wday/cxs/cswg/CS_Careers" + str(rd['externalPath'])
                                    jobObj['url'] = url

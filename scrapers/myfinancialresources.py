...
#Token
token = 'MYFINANCIALRESOURCES'.upper()

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.myfinancialresources.org'
        ...
        self.domain = 'myfinancialresources.org'
    ...
    def process_logic(self):
        try:
            jobid = ""
            cid = 'a170b675-98ff-459a-b45c-348194847480'

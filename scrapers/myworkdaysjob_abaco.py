...
token = 'MYWORKDAYSJOB_ABACO'
class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://abaco.wd5.myworkdayjobs.com/abacocareersus/0/refreshFacet/318c8bb6f553100021d223d9780d30be'

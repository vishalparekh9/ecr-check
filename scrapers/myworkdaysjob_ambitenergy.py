...
token = 'MYWORKDAYSJOB_AMBITENERGY'
class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://vst.wd5.myworkdayjobs.com/vistra_careers/0/refreshFacet/318c8bb6f553100021d223d9780d30be'

...
token = 'MYWORKDAYSJOB_APPLIEDMATERIAL'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://amat.wd1.myworkdayjobs.com/External'
        ...
        self.domain = 'appliedmaterials.com'
    ...
    def process_logic(self):
        try:
            ...
            oldurl = ''
            while isdata:
                isloaded, res = self.post_request('https://amat.wd1.myworkdayjobs.com/wday/cxs/amat/External/jobs',
                                                  page)
                page = page + 20
                ...
                if len(objs) > 0:
                    if objs[0]['externalPath'] == oldurl:
                        isdata = False
                        break
                    else:
                        oldurl = objs[0]['externalPath']
                else:
                    isdata = False
                    break
                ...
                for obj in objs:
                    try:
                        ...
                        url = 'https://amat.wd1.myworkdayjobs.com/wday/cxs/amat/External' + obj['externalPath']
                        jobObj['url'] = 'https://amat.wd1.myworkdayjobs.com/en-US/External' + obj['externalPath']

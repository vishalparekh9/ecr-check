...
token = 'MYWORKDAYSJOB_AVANTORINC'
class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://vwr.wd1.myworkdayjobs.com/avantorJobs?utm_source=avantorinc.com&utm_medium=link&utm_campaign=AvantorCareers&utm_content=AvantorCareerPage-012018>'

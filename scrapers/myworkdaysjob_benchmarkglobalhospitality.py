...
token = 'MYWORKDAYSJOB_BENCHMARKGLOBALHOSPITALITY'
class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://benchmark.wd1.myworkdayjobs.com/Benchmark_Careers'
        ...
        self.domain = 'benchmarkglobalhospitality.com'

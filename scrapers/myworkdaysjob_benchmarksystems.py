...
token = 'MYWORKDAYSJOB_BENCHMARKSYSTEMS'
class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://benchmark.wd1.myworkdayjobs.com/Benchmark_Careers?_ga-ft=1XpZgE.0.0.0.0.XG69Pc-1P0a5Cb.0.0'
        ...
        self.domain = 'benchmark-systems.com'

...
token = 'MYWORKDAYSJOB_BLOOMBERGINDUSTRY'
class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://bloomberg.wd1.myworkdayjobs.com/Bloombergindustrygroup_External_Career_Site'
        ...
        self.domain = 'bloombergindustry.com'

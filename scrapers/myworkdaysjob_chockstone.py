...
token = 'MYWORKDAYSJOB_CHOCKSTONE'
class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://tsys.wd1.myworkdayjobs.com/HeartlandCareers/21/refreshFacet/318c8bb6f553100021d223d9780d30be'

...
token = 'MYWORKDAYSJOB_COLLIERSENIORRESOURCES'
class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://colliers.wd3.myworkdayjobs.com/Colliers-External-Career-Site'
        ...
        self.domain = 'collierseniorresources.org'

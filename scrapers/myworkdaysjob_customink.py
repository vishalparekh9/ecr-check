...
token = 'MYWORKDAYSJOB_CUSTOMINK'
class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://customink.wd5.myworkdayjobs.com/CustomInk/0/refreshFacet/318c8bb6f553100021d223d9780d30be'

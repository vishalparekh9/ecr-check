...
token = 'MYWORKDAYSJOB_CWPS'
class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://redriver.wd5.myworkdayjobs.com/redrivercareers/0/refreshFacet/318c8bb6f553100021d223d9780d30be'

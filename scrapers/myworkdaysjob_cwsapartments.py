...
token = 'MYWORKDAYSJOB_CWSAPARTMENTS'
class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://cwsapartments.wd5.myworkdayjobs.com/External-CWS/0/refreshFacet/318c8bb6f553100021d223d9780d30be'

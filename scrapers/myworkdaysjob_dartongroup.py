...
token = 'MYWORKDAYSJOB_DARTONGROUP'
class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://cliftonlarsonallen.wd1.myworkdayjobs.com/CLA/0/refreshFacet/318c8bb6f553100021d223d9780d30be'

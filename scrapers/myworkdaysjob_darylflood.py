...
token = 'MYWORKDAYSJOB_DARYLFLOOD'
class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://suddath.wd5.myworkdayjobs.com/Suddath/0/refreshFacet/318c8bb6f553100021d223d9780d30be'

...
token = 'MYWORKDAYSJOB_DJOGLOBAL'
class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://colfax.wd5.myworkdayjobs.com/djocareers/4/refreshFacet/318c8bb6f553100021d223d9780d30be'

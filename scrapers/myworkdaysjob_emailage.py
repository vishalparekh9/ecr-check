...
token = 'MYWORKDAYSJOB_EMAILAGE'
class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://relx.wd3.myworkdayjobs.com/RiskSolutions/0/refreshFacet/318c8bb6f553100021d223d9780d30be'

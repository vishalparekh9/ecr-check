...
token = 'MYWORKDAYSJOB_ENTERPRISEBANK'
class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://osv-enterprise.wd1.myworkdayjobs.com/en-US/EnterpriseBankTrust_Jobs'
        ...
        self.domain = 'enterprisebank.com'

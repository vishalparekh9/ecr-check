...
token = 'MYWORKDAYSJOB_ENTRUST'
class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://entrust.wd1.myworkdayjobs.com/EntrustCareers?_ga=2.10981684.1292938467.1640864091-1720186796.1640864091'

...
token = 'MYWORKDAYSJOB_FERGUSON'
class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://ferguson.wd1.myworkdayjobs.com/Ferguson_Experienced?icid=cont_ftr_bsns_careers_-career-opportunities-apply-now--text#xd_co_f=N2U0Yjk0YzAtZWI5NS00NzhlLThhZTctYTJhMzAxYjAzOTU2~'

...
token = 'MYWORKDAYSJOB_FIRSTORION'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://firstorion.wd1.myworkdayjobs.com/First_Orion'
    ...
    def process_logic(self):
        try:
            ...
            urls = []
            while isdata:
                isloaded, res = self.post_request('https://firstorion.wd1.myworkdayjobs.com/wday/cxs/firstorion/First_Orion/jobs',
                                                  page)
                page = page + 20
                ...
                for obj in objs:
                    try:
                        ...
                        url = 'https://firstorion.wd1.myworkdayjobs.com/wday/cxs/firstorion/First_Orion' + obj['externalPath']
                        jobObj['url'] = 'https://firstorion.wd1.myworkdayjobs.com/en-US/First_Orion' + obj['externalPath']
                        try:

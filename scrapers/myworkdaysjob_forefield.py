...
token = 'MYWORKDAYSJOB_FOREFIELD'
class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://broadridge.wd5.myworkdayjobs.com/Careers/0/refreshFacet/318c8bb6f553100021d223d9780d30be'

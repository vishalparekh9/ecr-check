...
token = 'MYWORKDAYSJOB_FRESENIUSKABI'
class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://fkusa.wd1.myworkdayjobs.com/FK_Careers/0/refreshFacet/318c8bb6f553100021d223d9780d30be'

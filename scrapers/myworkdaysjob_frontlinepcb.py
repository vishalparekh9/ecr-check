...
token = 'MYWORKDAYSJOB_FRONTLINEPCB'
class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://kla.wd1.myworkdayjobs.com/Search/0/refreshFacet/318c8bb6f553100021d223d9780d30be'

...
token = 'MYWORKDAYSJOB_GABLES'
class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://gables.wd5.myworkdayjobs.com/Gables_Careers/0/refreshFacet/318c8bb6f553100021d223d9780d30be'

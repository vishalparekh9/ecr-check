...
token = 'MYWORKDAYSJOB_GENTEX'
class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://gentex.wd5.myworkdayjobs.com/Gentex/0/refreshFacet/318c8bb6f553100021d223d9780d30be'

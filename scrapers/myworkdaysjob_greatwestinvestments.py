...
token = 'MYWORKDAYSJOB_GREATWESTINVESTMENTS'
class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://empowerretirement.wd5.myworkdayjobs.com/empowerretirement'
        ...
        self.domain = 'greatwestinvestments.com'

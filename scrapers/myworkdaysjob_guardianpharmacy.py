...
token = 'MYWORKDAYSJOB_GUARDIANPHARMACY'
class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://guardianpharmacy.wd5.myworkdayjobs.com/Guardian_Pharmacy/0/refreshFacet/318c8bb6f553100021d223d9780d30be'
        ...
        self.domain = 'guardianpharmacy.net'

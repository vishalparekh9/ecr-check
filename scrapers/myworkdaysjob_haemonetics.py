...
token = 'MYWORKDAYSJOB_HAEMONETICS'
class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://haemonetics.wd5.myworkdayjobs.com/HAE/0/refreshFacet/318c8bb6f553100021d223d9780d30be'

...
token = 'MYWORKDAYSJOB_HAGERTY'
class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://hagerty.wd5.myworkdayjobs.com/hagerty/0/refreshFacet/318c8bb6f553100021d223d9780d30be'

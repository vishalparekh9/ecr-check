...
token = 'MYWORKDAYSJOB_HEEQUIPMENT'
class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://heequipment.wd5.myworkdayjobs.com/careers/0/refreshFacet/318c8bb6f553100021d223d9780d30be'

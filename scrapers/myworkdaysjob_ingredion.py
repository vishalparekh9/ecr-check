...
token = 'MYWORKDAYSJOB_INGREDION'
class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://ingredion.wd1.myworkdayjobs.com/IngredionCareers/13/refreshFacet/318c8bb6f553100021d223d9780d30be'

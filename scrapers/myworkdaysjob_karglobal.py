...
token = 'MYWORKDAYSJOB_KARGLOBAL'
class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://kar.wd1.myworkdayjobs.com/KAR_Careers/0/refreshFacet/318c8bb6f553100021d223d9780d30be'

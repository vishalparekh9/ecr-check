...
token = 'MYWORKDAYSJOB_KRUX'
class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://salesforce.wd1.myworkdayjobs.com/External_Career_Site/0/refreshFacet/318c8bb6f553100021d223d9780d30be?d=cta-hm-sjb-1'

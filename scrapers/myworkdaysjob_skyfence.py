...
token = 'MYWORKDAYSJOB_SKYFENCE'
class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://forcepoint.wd1.myworkdayjobs.com/external-careers/0/refreshFacet/318c8bb6f553100021d223d9780d30be'

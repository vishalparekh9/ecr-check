...
token = 'MYWORKDAYSJOB_STJUDE'
class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://alsacstjude.wd1.myworkdayjobs.com/en-US/careersalsacstjude//?sc_icid=alsac-jobs-hero-btn-jobs'

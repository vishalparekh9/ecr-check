...
token = 'MYWORKDAYSJOB_STOKE'
class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://mavenir.wd1.myworkdayjobs.com/Mavenir_Careers/0/refreshFacet/318c8bb6f553100021d223d9780d30be'

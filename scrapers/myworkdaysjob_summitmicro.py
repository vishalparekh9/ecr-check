...
token = 'MYWORKDAYSJOB_SUMMITMICRO'
class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://qualcomm.wd5.myworkdayjobs.com/External/0/refreshFacet/318c8bb6f553100021d223d9780d30be'

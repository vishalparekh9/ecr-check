...
token = 'MYWORKDAYSJOB_ZOOM'
class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://zoom.wd5.myworkdayjobs.com/Zoom'
    ...
    def process_logic(self):
        try:
            ...
            oldurl = ''
            while isdata:
                isloaded, res = self.post_request('https://zoom.wd5.myworkdayjobs.com/wday/cxs/zoom/Zoom/jobs', page)
                page = page + 20
                ...
                for obj in objs:
                    ...
                    url = 'https://zoom.wd5.myworkdayjobs.com/wday/cxs/zoom/Zoom' + obj['externalPath']
                    jobObj['url'] = 'https://zoom.wd5.myworkdayjobs.com/en-US/Zoom' + obj['externalPath']

...
# Token
token = 'NEPTUNERETAILSOLUTIONS'

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://neptuneretailsolutions.bamboohr.com/jobs/embed2.php?version=1.0.0'
        ...
        self.domain = 'neptuneretailsolutions.com'
    ...
    def process_logic(self):
        try:
            url = 'https://neptuneretailsolutions.bamboohr.com/jobs/embed2.php?version=1.0.0'

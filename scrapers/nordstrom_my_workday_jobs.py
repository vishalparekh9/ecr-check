...
# Token
token = 'NORDSTROM_WORKDAY_JOBS_CAREER_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.nordstrom.com'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://nordstrom.wd5.myworkdayjobs.com/wday/cxs/nordstrom/nordstrom_careers/jobs'
                ...
                if isloaded:
                    ...
                    if len(data) > 0:
                        for rd in data:
                            ...
                            url = "https://nordstrom.wd5.myworkdayjobs.com/nordstrom_careers" + str(rd['externalPath'])
                            jobObj['url'] = url

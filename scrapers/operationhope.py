...
#Token
token = 'OPERATIONHOPE'.upper()

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.operationhope.org'
    ...
    def process_logic(self):
        try:
            jobid = ""
            cid = 'e5473248-83f6-482e-b8ca-801346538bc8'
            icids = '2811586144_3278'

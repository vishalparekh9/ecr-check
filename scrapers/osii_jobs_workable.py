...
token = 'MYWORKDAYSJOB_ASPENTECH_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://aspentech.wd5.myworkdayjobs.com/aspentech'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://aspentech.wd5.myworkdayjobs.com/wday/cxs/aspentech/aspentech/jobs'
                    ...
                    if len(data) > 0:
                        for rd in data:
                            ...
                            try:
                                ...
                                jobObj['location'] = 'USA'
                                pass
                            url = "https://aspentech.wd5.myworkdayjobs.com/en-US/aspentech" + str(rd['externalPath'])
                            jobObj['url'] = url
                            print(url)
                            if url in urls:
                                print("broke")
                            ...
                            if isloaded:
                                try:
                                    ...
                                    for jobs in jobDetails.find_all("script", {"type": "application/ld+json"}):
                                        try:
                                            jsonJobDesc = json.loads(str(jobs.text))
                                            if 'description' in jsonJobDesc:

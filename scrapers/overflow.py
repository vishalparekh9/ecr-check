...
class CRAWLER(object):
    ...
    def process_logic(self):
        try:
            url = 'https://boards-api.greenhouse.io/v1/boards/'+str("overflow")+'/jobs'
                    ...
                    for data in res.json()["jobs"]:
                        if data:
                            ...
                            if 'gh_jid=' in str(url):                        
                                isloaded, res = self.get_request('https://boards.greenhouse.io/embed/job_app?for=overflow&token='+str(url).split('gh_jid=')[1])
                                ...
                                isloaded, res = self.get_request('https://boards.greenhouse.io/embed/job_app?for=overflow&token='+str(url).split('/jobs/')[1])

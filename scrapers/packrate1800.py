...
class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.indeed.com/cmp/1--800--pack--rat,-LLC/jobs' 
    ...
    def process_logic(self):
        try:
            ...
            if isloaded:
                ...
                divs = data.find('ul',{'data-testid':'jobList'}).find_all('li')
                for div in divs:
                    ...
                    if isloaded and 'data' in res.json():
                        ...
                        for link in res.json()['data']['jobData']['results']:
                            ...
                            url = 'https://www.indeed.com/cmp/1--800--pack--rat,-LLC/jobs?jk='+ str(keyid) + '&start=0'
                            jobObj['url'] = url

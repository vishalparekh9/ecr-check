...
# Token
token = 'ZIPSCARWASH_PAYCOMONLINE'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.zipscarwash.com/new-hire-onboarding'
    ...
    def process_logic(self):
        try:
            url = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=D4E7EC2F12A25A23C260044428F969E1#'

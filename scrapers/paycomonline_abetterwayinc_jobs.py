...
# Token
token = 'PAYCOMONLINE_ABETTERWAYINC_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=56D6C3C41972E2E3FE0EFF5F27172E77'

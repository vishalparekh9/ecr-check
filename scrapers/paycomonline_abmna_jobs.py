...
# Token
token = 'PAYCOMONLINE_ABMNA_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=534DE5FFD3F3B80B8118299FD0E666F0'

...
# Token
token = 'PAYCOMONLINE_AERONET_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=352C366B27AF6313BBBA01CD4D4612E9'

...
# Token
token = 'PAYCOMONLINE_AGRIINDUSTRIALPLASTICS_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=F17131B94A48004BCE4B46BCBF0174F5'
        ...
        self.domain = 'agriindustrialplastics.com'

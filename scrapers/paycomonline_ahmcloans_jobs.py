...
# Token
token = 'PAYCOMONLINE_AHMCLOANS_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=D3ECB3FD7BD762A663A7456ADF832467'

...
# Token
token = 'PAYCOMONLINE_ALLYALIGN_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=FD747FC6C500BF65E131105B9BAA198B'

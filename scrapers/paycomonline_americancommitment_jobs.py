...
# Token
token = 'PAYCOMONLINE_AMERICANCOMMITMENT_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=58AA089E0E2C786B7FE4217373F3BCBD'
        ...
        self.domain = 'americancommitment.org'

...
# Token
token = 'PAYCOMONLINE_AMPROD_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=9F088BB1E1149A9830144DBA3AAE1732'

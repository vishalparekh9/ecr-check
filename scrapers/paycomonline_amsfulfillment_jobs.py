...
# Token
token = 'PAYCOMONLINE_AMSFULFILLMENT_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=D7BC238327F495746F4FBD4D45A1C3EC'
        ...
        self.domain = 'amsfulfillment.com'

...
# Token
token = 'PAYCOMONLINE_ANKROMMOISAN_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=977F25CDFE7CF2F863519D7DC99440C4'

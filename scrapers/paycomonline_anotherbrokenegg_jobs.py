...
# Token
token = 'PAYCOMONLINE_ANOTHERBROKENEGG_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=C32A5FF73AD2281A15C3FAAF5DD8B29A'
        ...
        self.domain = 'anotherbrokenegg.com'

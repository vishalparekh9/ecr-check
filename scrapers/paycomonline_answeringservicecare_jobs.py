...
# Token
token = 'PAYCOMONLINE_ANSWERINGSERVICECARE_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=8839194A20ABF96F683B08D5273AC086'
        ...
        self.domain = 'answeringservicecare.net'

...
# Token
token = 'PAYCOMONLINE_APEXNETWORKPT_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=A896A1054C6EDA9984F519F029EFCDA0#'

...
# Token
token = 'PAYCOMONLINE_APPALACHIANWIRELESS_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=6CEBCA3FD18B200606F0B38FD2697062'
        ...
        self.domain = 'appalachianwireless.com'

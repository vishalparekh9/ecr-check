...
# Token
token = 'PAYCOMONLINE_APPLEBUSCOMPANY_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=4D2F02DAE0A6EE359BFD1C4465548359'
        ...
        self.domain = 'applebuscompany.com'

...
# Token
token = 'PAYCOMONLINE_ARMORWORKS_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=93955CF7E9CE1E2E8DF0B571BC9135FA'

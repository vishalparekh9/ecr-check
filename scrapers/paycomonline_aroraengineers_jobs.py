...
# Token
token = 'PAYCOMONLINE_ARORAENGINEERS_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=51901FF2F92533C69CB65266F4016A5C'
        ...
        self.domain = 'aroraengineers.com'

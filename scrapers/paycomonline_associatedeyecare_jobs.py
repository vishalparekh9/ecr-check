...
# Token
token = 'PAYCOMONLINE_ASSOCIATEDEYECARE_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=2DB8ACA77B2AEE62EF602D47BB64AF2A'
        ...
        self.domain = 'associatedeyecare.com'

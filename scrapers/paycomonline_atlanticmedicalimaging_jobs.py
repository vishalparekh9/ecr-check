...
# Token
token = 'PAYCOMONLINE_ATLANTICMEDICALIMAGING_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=C15177DFF78DA5C866792C86E50183E5'
        ...
        self.domain = 'atlanticmedicalimaging.com'

...
# Token
token = 'PAYCOMONLINE_ATLINKSERVICES_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=FC68F77795A427887F3A41B7BE7C0F04'
        ...
        self.domain = 'atlinkservices.com'

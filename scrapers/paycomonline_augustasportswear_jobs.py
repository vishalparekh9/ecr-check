...
# Token
token = 'PAYCOMONLINE_AUGUSTASPORTSWEAR_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=666553572663EC7F7F3472C2CF94B117'
        ...
        self.domain = 'augustasportswear.com'

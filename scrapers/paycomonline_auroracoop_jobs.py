...
# Token
token = 'PAYCOMONLINE_AURORACOOP_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=8AA4723458C6B1229A2EC56168DC56A5'

...
# Token
token = 'PAYCOMONLINE_AVIDAC_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=9FE9EFF66621F72A681A3AC9BC9A0BEB'

...
# Token
token = 'PAYCOMONLINE_BACR_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=A803A748FC73776EA39DEB21687D0B92'

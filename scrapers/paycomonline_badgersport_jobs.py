...
# Token
token = 'PAYCOMONLINE_BADGERSPORT_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=BD06216D92A896C2E0C16BD20CE82531'

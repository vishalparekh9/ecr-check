...
# Token
token = 'PAYCOMONLINE_BAKERINSTALLATIONS_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=46883818E20842304879F28CBF50649E'
        ...
        self.domain = 'baker-installations.com'

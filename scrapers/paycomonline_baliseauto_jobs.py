...
# Token
token = 'PAYCOMONLINE_BALISEAUTO_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=A9970757A43AC65989C3C408851591A0'

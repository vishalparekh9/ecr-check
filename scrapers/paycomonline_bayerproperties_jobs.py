...
# Token
token = 'PAYCOMONLINE_BAYERPROPERTIES_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=5410FFBC03F49713DE1EF693C8052831'
        ...
        self.domain = 'bayerproperties.com'

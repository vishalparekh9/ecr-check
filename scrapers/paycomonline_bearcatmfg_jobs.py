...
# Token
token = 'PAYCOMONLINE_BEARCATMFG_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=F92437004E1413140E5C85EC0D81E8EC'

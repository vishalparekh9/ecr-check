...
# Token
token = 'PAYCOMONLINE_BETAHG_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=451336BBA1508535CB28A46AA24E8C5E'

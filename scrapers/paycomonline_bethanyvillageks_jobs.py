...
# Token
token = 'PAYCOMONLINE_BETHANYVILLAGEKS_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=C536C0096A2740BC17F53A28833CD81E'
        ...
        self.domain = 'bethanyvillageks.com'

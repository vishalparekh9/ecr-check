...
# Token
token = 'PAYCOMONLINE_BETHESDASENIORLIVING_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=029BCA9B92A6BC868140106C18B3A1AE'
        ...
        self.domain = 'bethesdaseniorliving.com'

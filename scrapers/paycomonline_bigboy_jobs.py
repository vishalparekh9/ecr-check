...
# Token
token = 'PAYCOMONLINE_BIGBOY_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=B0A24807440CD83A90CF5C85FBEE3F2C'

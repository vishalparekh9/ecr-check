...
# Token
token = 'PAYCOMONLINE_BIGFOOTBEVERAGES_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=59364742FAA623C54577B3BAB2DB92C3'
        ...
        self.domain = 'bigfootbeverages.com'

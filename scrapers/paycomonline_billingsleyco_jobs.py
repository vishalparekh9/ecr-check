...
# Token
token = 'PAYCOMONLINE_BILLINGSLEYCO_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=033C0C3EF09AF627AB4C8BC1E3AEED89'

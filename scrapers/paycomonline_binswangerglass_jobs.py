...
# Token
token = 'PAYCOMONLINE_BINSWANGERGLASS_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=254915752576A4B4D143A28200DBDFA7'
        ...
        self.domain = 'binswangerglass.com'

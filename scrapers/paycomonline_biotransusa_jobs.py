...
# Token
token = 'PAYCOMONLINE_BIOTRANSUSA_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=109A98727CB472FBBEA6DD8677F42CE3'

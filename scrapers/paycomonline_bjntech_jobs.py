...
# Token
token = 'PAYCOMONLINE_BJNTECH_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=AC18037DAC01E5979DA39DD0C4BB125E'

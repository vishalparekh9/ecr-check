...
# Token
token = 'PAYCOMONLINE_BRANDYWINEREALTY_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=5C2812AF7A6EC43FACF35CE08D54FC98'
        ...
        self.domain = 'brandywinerealty.com'

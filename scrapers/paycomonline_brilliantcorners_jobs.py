...
# Token
token = 'PAYCOMONLINE_BRILLIANTCORNERS_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=328CA110FE6180352843AB25D98FDA3F'
        ...
        self.domain = 'brilliantcorners.org'

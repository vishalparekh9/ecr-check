...
# Token
token = 'PAYCOMONLINE_BROTHERSPRODUCE_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=6207FBA20B1E7A94F460C9FB406F3D3D'
        ...
        self.domain = 'brothersproduce.com'

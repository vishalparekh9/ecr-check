...
# Token
token = 'PAYCOMONLINE_BUTLERMEDICALTRANSPORT_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=598AE7BC6518317721547DD42E0FD2D2'
        ...
        self.domain = 'butlermedicaltransport.com'

...
# Token
token = 'PAYCOMONLINE_CAPITOLUT_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=90BDFB396B40E9EEB8DB2631CC8E436F'

...
# Token
token = 'PAYCOMONLINE_CARMAX_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=98B7BE7E9588D97417EDDD6B19A2ADA6'

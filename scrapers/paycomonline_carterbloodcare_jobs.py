...
# Token
token = 'PAYCOMONLINE_CARTERBLOODCARE_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=24BA8E74AC6AB442018CAD41B75AE0F7'
        ...
        self.domain = 'carterbloodcare.org'

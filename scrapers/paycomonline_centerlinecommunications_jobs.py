...
# Token
token = 'PAYCOMONLINE_CENTERLINECOMMUNICATIONS_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=5065FE279068C1E4E14D703E83295A94'
        ...
        self.domain = 'centerlinecommunications.com'

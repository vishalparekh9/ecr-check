...
# Token
token = 'PAYCOMONLINE_CENTRALFLORIDAHOMELESS_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=29FCD070533B445C6C9EF742154EB453'
        ...
        self.domain = 'centralfloridahomeless.org'

...
# Token
token = 'PAYCOMONLINE_CERITYPARTNERS_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=B67982FD87D370A5C05CA9E73408447C'
        ...
        self.domain = 'ceritypartners.com'

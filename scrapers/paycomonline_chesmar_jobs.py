...
# Token
token = 'PAYCOMONLINE_CHESMAR_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=A8C03FB29CDEE2E033DFA3DE73609813'

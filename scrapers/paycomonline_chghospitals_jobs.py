...
# Token
token = 'PAYCOMONLINE_CHGHOSPITALS_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=2EB9B000F35D6F83318B8954B5277092'

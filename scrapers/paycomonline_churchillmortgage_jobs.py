...
# Token
token = 'PAYCOMONLINE_CHURCHILLMORTGAGE_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=9F13E422256279B9045237D1B3F8E165'
        ...
        self.domain = 'churchillmortgage.com'

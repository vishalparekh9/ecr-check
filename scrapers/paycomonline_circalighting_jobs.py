...
# Token
token = 'PAYCOMONLINE_CIRCALIGHTING_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=DBB46D02B06AE4A9FF5DE3CAE42123D7'

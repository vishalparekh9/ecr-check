...
# Token
token = 'PAYCOMONLINE_CLIPPERPETROLEUM_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=BB6044F72BD6F293F0EC586CFDC6E8AD'
        ...
        self.domain = 'clipperpetroleum.com'

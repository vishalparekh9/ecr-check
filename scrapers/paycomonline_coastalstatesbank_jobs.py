...
# Token
token = 'PAYCOMONLINE_COASTALSTATESBANK_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=8D6F4174B7FDCE4CD96A1C3DBCEE4D96'
        ...
        self.domain = 'coastalstatesbank.com'

...
# Token
token = 'PAYCOMONLINE_COLLABFORCHILDREN_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=3AB45E716DE57973E80006B9DEF8D349'
        ...
        self.domain = 'collabforchildren.org'

...
# Token
token = 'PAYCOMONLINE_COLORTECH_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=4772B050B5C6CDB7F069E4A9A5904C26'

...
# Token
token = 'PAYCOMONLINE_COPECOMMUNITYSERVICES_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=46785B3E19DA9C6546C99320F56F484C'
        ...
        self.domain = 'copecommunityservices.org'

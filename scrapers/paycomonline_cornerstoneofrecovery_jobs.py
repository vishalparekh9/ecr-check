...
# Token
token = 'PAYCOMONLINE_CORNERSTONEOFRECOVERY_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=F99BA2879BD43971A39A901011F4AEA0'
        ...
        self.domain = 'cornerstoneofrecovery.com'

...
# Token
token = 'PAYCOMONLINE_CORNERSTONESYSTEMS_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=823EAEA4766C4B93AC0EA68470038B8C'
        ...
        self.domain = 'cornerstone-systems.com'

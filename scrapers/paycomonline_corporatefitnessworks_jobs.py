...
# Token
token = 'PAYCOMONLINE_CORPORATEFITNESSWORKS_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=23DE5214D03E9514B08A8C25DE289B7C'
        ...
        self.domain = 'corporatefitnessworks.com'

...
# Token
token = 'PAYCOMONLINE_CORSICANABEDDING_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=36AC209306E5C967641609ED998A9457'
        ...
        self.domain = 'corsicanabedding.com'

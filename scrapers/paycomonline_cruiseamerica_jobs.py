...
# Token
token = 'PAYCOMONLINE_CRUISEAMERICA_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=8F2A4D7DE97EFD6678765D259C514C70'

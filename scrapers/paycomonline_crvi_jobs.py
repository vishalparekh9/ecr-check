...
# Token
token = 'PAYCOMONLINE_CRVI_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=D5AB93D52AE354502B6927528D7D7EE4'

...
# Token
token = 'PAYCOMONLINE_CSSCHECK360_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=1D6DBCE1E8A4C52E4BD052378D59DB1E'

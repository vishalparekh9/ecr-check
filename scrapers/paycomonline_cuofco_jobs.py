...
# Token
token = 'PAYCOMONLINE_CUOFCO_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=C9238A0564CC6A0731D539992ADDDEA7'

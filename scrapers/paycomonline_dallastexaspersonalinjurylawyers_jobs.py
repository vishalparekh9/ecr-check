...
# Token
token = 'PAYCOMONLINE_DALLASTEXASPERSONALINJURYLAWYERS_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=89DF2FA8ABBFDE0DDA65FAA982DAA55E'
        ...
        self.domain = 'dallastexaspersonalinjurylawyers.com'

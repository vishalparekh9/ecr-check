...
# Token
token = 'PAYCOMONLINE_DONERIGHTMERCHANDISING_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=BFEE0F2556335A56BAA793216E742945'
        ...
        self.domain = 'donerightmerchandising.com'

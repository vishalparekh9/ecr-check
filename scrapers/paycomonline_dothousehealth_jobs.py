...
# Token
token = 'PAYCOMONLINE_DOTHOUSEHEALTH_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=965D46839E02802DF2C3F2067C37FC06'
        ...
        self.domain = 'dothousehealth.org'

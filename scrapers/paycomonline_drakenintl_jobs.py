...
# Token
token = 'PAYCOMONLINE_DRAKENINTL_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=C236407623A0DF989D668EE189C1F642'

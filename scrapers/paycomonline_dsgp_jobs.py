...
# Token
token = 'PAYCOMONLINE_DSGP_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=810C9AF4D26A3F4896357E064D9DCC74'

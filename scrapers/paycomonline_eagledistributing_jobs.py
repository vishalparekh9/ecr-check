...
# Token
token = 'PAYCOMONLINE_EAGLEDISTRIBUTING_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=72F0ECC13EAD6E82F35B2BB3D968A959'
        ...
        self.domain = 'eagledistributing.com'

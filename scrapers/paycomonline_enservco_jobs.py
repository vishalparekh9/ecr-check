...
# Token
token = 'PAYCOMONLINE_ENSERVCO_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=07AFC8ABDC20B4D9A7CC051E34FD0E4F'

...
# Token
token = 'PAYCOMONLINE_EQDEPOT_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=B38E004F17E260CC9A2761B7F6E6221F'

...
# Token
token = 'PAYCOMONLINE_FATTUESDAY_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=D68B11C345921771792AADEB2866DC90'

...
# Token
token = 'PAYCOMONLINE_FAULTLESSBRANDS_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=FD8A264E0ECEA699E9F7E393EE7DB847'
        ...
        self.domain = 'faultlessbrands.com'

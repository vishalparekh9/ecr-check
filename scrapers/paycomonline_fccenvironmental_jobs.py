...
# Token
token = 'PAYCOMONLINE_FCCENVIRONMENTAL_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=2B05648D4DA1ED6F5FF329A164C87C31'
        ...
        self.domain = 'fccenvironmental.com'

...
# Token
token = 'PAYCOMONLINE_FEDITC_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=DD69255AD3638E0C3B1E73E47CDA0FF3'

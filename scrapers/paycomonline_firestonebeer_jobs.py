...
# Token
token = 'PAYCOMONLINE_FIRESTONEBEER_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=ABFB006B3220E9B2865C92866DD1E539'

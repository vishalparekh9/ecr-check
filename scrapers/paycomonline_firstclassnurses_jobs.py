...
# Token
token = 'PAYCOMONLINE_FIRSTCLASSNURSES_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=5B3F9F2C0E7DB5F1EC70FB311F1054B8'
        ...
        self.domain = 'firstclassnurses.net'

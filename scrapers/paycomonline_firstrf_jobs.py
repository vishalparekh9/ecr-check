...
# Token
token = 'PAYCOMONLINE_FIRSTRF_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=95300CA217ECE57491FFA8394F1D24C9'

...
# Token
token = 'PAYCOMONLINE_FLOGISTIX_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=A3C28DBDE153F37AE36EE874CCA58355'

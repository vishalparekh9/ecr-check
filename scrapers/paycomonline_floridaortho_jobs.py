...
# Token
token = 'PAYCOMONLINE_FLORIDAORTHO_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=E6F08C38C05A691EE45CB177278159AD'

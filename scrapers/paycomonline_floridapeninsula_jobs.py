...
# Token
token = 'PAYCOMONLINE_FLORIDAPENINSULA_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=C3878693EC478B16CC35EF062D82438E'
        ...
        self.domain = 'floridapeninsula.com'

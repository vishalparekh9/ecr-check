...
# Token
token = 'PAYCOMONLINE_FORTISSOLUTIONSGROUP_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=9237C81021B07195BD00009846DBC5BB#'
        ...
        self.domain = 'fortissolutionsgroup.com'

...
# Token
token = 'PAYCOMONLINE_FRIEDMANREALESTATE_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=E7AFC238855AE6440BAD77FBF1FE15DE'
        ...
        self.domain = 'friedmanrealestate.com'

...
# Token
token = 'PAYCOMONLINE_FSFCU_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=78FD324182CC06D264518F65047A541B'

...
# Token
token = 'PAYCOMONLINE_FSSPEOPLE_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=34579C0DA0132DEDF3625F63D1FA424A'

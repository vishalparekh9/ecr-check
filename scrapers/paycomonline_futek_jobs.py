...
# Token
token = 'PAYCOMONLINE_FUTEK_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=5AA9970AFB7E7320DA597F2CF00E6958'

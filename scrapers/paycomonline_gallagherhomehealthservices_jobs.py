...
# Token
token = 'PAYCOMONLINE_GALLAGHERHOMEHEALTHSERVICES_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=114EF78936C247A52868C5043590C95C'
        ...
        self.domain = 'gallagherhomehealthservices.com'

...
# Token
token = 'PAYCOMONLINE_GATEWAYSHOSPITAL_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=0E4AC8A6FD7D2375CD64614217F0D1D9'
        ...
        self.domain = 'gatewayshospital.org'

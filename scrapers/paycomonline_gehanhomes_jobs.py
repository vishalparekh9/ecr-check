...
# Token
token = 'PAYCOMONLINE_GEHANHOMES_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=645316836E7CA22819B4BCED9ECA1A13'

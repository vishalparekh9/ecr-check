...
# Token
token = 'PAYCOMONLINE_GENESISPRODUCTSINC_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=CC327F10CD201F34F7E5F801DAC4D395'
        ...
        self.domain = 'genesisproductsinc.com'

...
# Token
token = 'PAYCOMONLINE_GILEADCS_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=76C6FC26105D374636D60E15D2179214'

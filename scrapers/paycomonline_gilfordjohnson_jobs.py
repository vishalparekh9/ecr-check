...
# Token
token = 'PAYCOMONLINE_GILFORDJOHNSON_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=9822718E420C3CC76A37187C1B91073C'
        ...
        self.domain = 'gilfordjohnson.com'

...
# Token
token = 'PAYCOMONLINE_GLADERUN_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=C876C397E6CD2C37D955A292A62112FC'

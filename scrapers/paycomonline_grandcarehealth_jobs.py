...
# Token
token = 'PAYCOMONLINE_GRANDCAREHEALTH_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=470D316B4E5012E6B7138D36ACD69B0A'
        ...
        self.domain = 'grandcarehealth.com'

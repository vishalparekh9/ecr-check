...
# Token
token = 'PAYCOMONLINE_GREENBERGFARROW_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=13E0F08179C3215D58F8AD5E774C2EA5'
        ...
        self.domain = 'greenbergfarrow.com'

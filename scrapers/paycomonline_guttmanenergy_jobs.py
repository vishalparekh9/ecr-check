...
# Token
token = 'PAYCOMONLINE_GUTTMANENERGY_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=F4F9C47B4BFA1ABF44DBD605FEB6FE41'

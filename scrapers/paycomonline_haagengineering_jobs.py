...
# Token
token = 'PAYCOMONLINE_HAAGENGINEERING_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=F6B7C78F90301F4B7C30E0C53D62D918'
        ...
        self.domain = 'haagengineering.com'

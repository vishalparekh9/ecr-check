...
# Token
token = 'PAYCOMONLINE_HANANIAAUTOS_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=7C263A9986B7E7F4F7A5F235E5DA97AA'

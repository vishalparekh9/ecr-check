...
# Token
token = 'PAYCOMONLINE_HAPPYHILLER_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=936EBAF5FFABE47A05CE5D72DF85FCEB'

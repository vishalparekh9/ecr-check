...
# Token
token = 'PAYCOMONLINE_HARFORDBANK_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=F61DA433C8C60161320DD1773F4BB816'

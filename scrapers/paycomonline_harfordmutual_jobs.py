...
# Token
token = 'PAYCOMONLINE_HARFORDMUTUAL_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=DA1F0353DF40AEF4913949E3C99E8711'

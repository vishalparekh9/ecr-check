...
# Token
token = 'PAYCOMONLINE_HAVENHOMEHEALTHLLC_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=CD19BD88B2E912033C26C5C7F56B1401'
        ...
        self.domain = 'havenhomehealthllc.com'

...
# Token
token = 'PAYCOMONLINE_HBGCOLUMNS_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=f0921be4ef6e5878dfdd216e03c24f89'

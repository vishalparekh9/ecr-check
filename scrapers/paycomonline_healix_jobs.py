...
# Token
token = 'PAYCOMONLINE_HEALIX_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=BAD22900A40085997BC831E5B0318BDC'

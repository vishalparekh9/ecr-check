...
# Token
token = 'PAYCOMONLINE_HEALTHWESTINC_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=D5220BDC1F8E162CEA7ED98679F910A3'

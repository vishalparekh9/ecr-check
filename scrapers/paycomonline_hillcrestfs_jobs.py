...
# Token
token = 'PAYCOMONLINE_HILLCRESTFS_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=EF0C0046E887715593788B10ECA20C71'

...
# Token
token = 'PAYCOMONLINE_HISCO_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=3A1A622D10845D52EDA5EBA1608FBA36'

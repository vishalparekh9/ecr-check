...
# Token
token = 'PAYCOMONLINE_HOMESTARFC_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=A83851B5ED339A2C4B6369BB56BE46F2'

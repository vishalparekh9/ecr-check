...
# Token
token = 'PAYCOMONLINE_HONSTEINOIL_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=2544D346CB30242A5ED829C1F43F4183'

...
# Token
token = 'PAYCOMONLINE_HOOSIERGASKET_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=FA1AA3585FDCDF70C40153F840F373BB'

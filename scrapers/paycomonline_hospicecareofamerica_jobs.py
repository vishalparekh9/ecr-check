...
# Token
token = 'PAYCOMONLINE_HOSPICECAREOFAMERICA_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=F5AA1DEC7F484D295175C045F93928F8'
        ...
        self.domain = 'hospicecareofamerica.com'

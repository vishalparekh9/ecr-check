...
# Token
token = 'PAYCOMONLINE_HOSPICESAVANNAH_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=0B826BAAAF4CD569F193E47E4154A05B'
        ...
        self.domain = 'hospicesavannah.org'

...
# Token
token = 'PAYCOMONLINE_HYPHENSOLUTIONS_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=E1A56CAEB442F41D05B6582BBD26389A'
        ...
        self.domain = 'hyphensolutions.com'

...
# Token
token = 'PAYCOMONLINE_LANDMARKHOSPITALITY_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=68542C4DC051EA3E16188065648857AF'
        ...
        self.domain = 'landmarkhospitality.com'

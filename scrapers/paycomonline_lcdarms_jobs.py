...
# Token
token = 'PAYCOMONLINE_LCDARMS_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=E25FCA9BFD22FAA616831B8AED92D700'

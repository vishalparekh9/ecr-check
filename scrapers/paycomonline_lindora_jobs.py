...
# Token
token = 'PAYCOMONLINE_LINDORA_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=7C2FD06DC9796903D360BDCDBB202753'

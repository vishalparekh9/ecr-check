...
# Token
token = 'PAYCOMONLINE_LINDSAYPRECAST_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=CFE2F34239FC30E5E85694B9324165CD'
        ...
        self.domain = 'lindsayprecast.com'

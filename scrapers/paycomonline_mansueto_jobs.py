...
# Token
token = 'PAYCOMONLINE_MANSUETO_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=391EBE62C932313F6770254E23DA9DF2'

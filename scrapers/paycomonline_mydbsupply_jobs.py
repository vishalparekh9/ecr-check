...
# Token
token = 'PAYCOMONLINE_MYDBSUPPLY_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=56AB60B8D60898375C7395227E546F0F'

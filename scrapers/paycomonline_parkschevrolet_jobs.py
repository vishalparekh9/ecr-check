...
# Token
token = 'PAYCOMONLINE_PARKSCHEVROLET_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=49C4683688F1961B2E4AF236113C8B5E'
        ...
        self.domain = 'parkschevrolet.com'

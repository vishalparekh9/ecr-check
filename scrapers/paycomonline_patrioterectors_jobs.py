...
# Token
token = 'PAYCOMONLINE_PATRIOTERECTORS_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=6CD4174E4F3BAD78E0B5BB5C30F00D90'
        ...
        self.domain = 'patrioterectors.com'

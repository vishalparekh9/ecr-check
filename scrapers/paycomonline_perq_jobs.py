...
# Token
token = 'PAYCOMONLINE_PERQ_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=C13F4ED005E3D2AE4B1155E95902388F'

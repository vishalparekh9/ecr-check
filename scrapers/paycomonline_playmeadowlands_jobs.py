...
# Token
token = 'PAYCOMONLINE_PLAYMEADOWLANDS_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=3221D6BBD940C4E384C952CF1395051B'
        ...
        self.domain = 'playmeadowlands.com'

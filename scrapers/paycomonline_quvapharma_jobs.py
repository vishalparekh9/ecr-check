...
# Token
token = 'PAYCOMONLINE_QUVAPHARMA_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=C04788861FD4212512B07979B26CF9E7'

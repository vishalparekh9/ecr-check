...
# Token
token = 'PAYCOMONLINE_SFELLC_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=40ECDEE422E918980ADA9A2F8255B2B0'

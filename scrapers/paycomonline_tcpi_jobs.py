...
# Token
token = 'PAYCOMONLINE_TCPI_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=918F732CE276B1C76EB6CDA860ECBC6F'

...
# Token
token = 'PAYCOMONLINE_THORACIC_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=D2CD6047F1A35FEE11067BC3A85A4800'

...
# Token
token = 'PAYCOMONLINE_TRANSAXLE_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=0DBE05367361709B93DF262FCF3C9BE2'

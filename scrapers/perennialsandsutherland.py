...
#Token
token = 'PERENNIALSANDSUTHERLAND'.upper()

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'http://perennialsandsutherland.com'
        ...
        self.domain = 'perennialsandsutherland.com'
    ...
    def process_logic(self):
        try:
            jobid = ""
            cid = '1f1cc29e-a484-4c54-b2c3-1743446e08a0'

...
token = 'PERSONIFY_CORP_BREEZY_HR_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://personify-corp.breezy.hr/'
    ...
    def process_logic(self):
        try:
            url = 'https://personify-corp.breezy.hr/'
            ...
            if isloaded:
                ...
                if links:
                    for link in links:
                        ...
                        url = str("https://personify-corp.breezy.hr") + str(link.find('a').get('href'))
                        jobObj['url'] = url

...
class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://apply.workable.com/pollfish/'
        ...
        try:
            ...
            if isloaded:
                ...
                while True:
                    ...
                    url = 'https://apply.workable.com/api/v3/accounts/pollfish/jobs'
                    ...
                    if isloaded:
                        ...
                        for link in links:
                            ...
                            jobObj['url'] = 'https://apply.workable.com/pollfish/j/' + str(link['shortcode']) + '/'
                            jobObj['title'] = link['title']
                            jobObj['location'] = link['location']['city'] +', ' + link['location']['region']
                            url = 'https://apply.workable.com/api/v2/accounts/pollfish/jobs/' + str(link['shortcode'])

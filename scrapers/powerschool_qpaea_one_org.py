...
# Token
token = 'POWERSCHOOL_QPAEA_ONE_ORG'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.qpaea.org'
    ...
    def process_logic(self):
        try:
            url = 'https://ats5.atenterprise.powerschool.com/ats/job_board?COMPANY_ID=JA002638&REPRESENTATIVE_COMPANY_ID=JA003124'
            print(url)

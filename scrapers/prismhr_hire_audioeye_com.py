...
# Token
token = 'JOB_BOARD_PRISMHR_HIRE_AUDIOEYE_CAREER_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://audioeye.com/'
    ...
    def process_logic(self):
        try:
            url = 'https://audioeye-inc.prismhr-hire.com'
                ...
                if links:
                    for link in links:
                        if link.find("a") is not None:
                            ...
                            url = "https://audioeye-inc.prismhr-hire.com" + link.find("a").get("href")
                            jobObj['url'] = url

...
# Token
token = 'JOB_BOARD_PRISMHR_HIRE_AXIOSINCORPORATED_CAREER_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://axiosincorporated.com/'
        ...
        self.domain = 'axiosincorporated.com'
    ...
    def process_logic(self):
        try:
            url = 'https://axioshr.prismhr-hire.com'
                ...
                if links:
                    for link in links:
                        if link.find("a") is not None:
                            ...
                            url = "https://axioshr.prismhr-hire.com" + link.find("a").get("href")
                            jobObj['url'] = url

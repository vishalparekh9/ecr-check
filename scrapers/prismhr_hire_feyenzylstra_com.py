...
# Token
token = 'JOB_BOARD_PRISMHR_HIRE_FEYENZYLSTRA_CAREER_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://feyenzylstra.com/'
                ...
                if links:
                    for link in links:
                        if link.find("a") is not None:
                            ...
                            url = "https://fz.prismhr-hire.com" + link.find("a").get("href")
                            jobObj['url'] = url

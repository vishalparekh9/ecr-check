...
# Token
token = 'JOB_BOARD_PRISMHR_HIRE_PONDURANCE_CAREER_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://pondurance.com/'
    ...
    def process_logic(self):
        try:
            url = 'https://pondurance-llc.prismhr-hire.com'
                ...
                if links:
                    for link in links:
                        if link.find("a") is not None:
                            ...
                            url = "https://pondurance-llc.prismhr-hire.com" + link.find("a").get("href")
                            jobObj['url'] = url

...
# Token
token = 'JOB_BOARD_PRISMHR_HIRE_TEXALLERGY_CAREER_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://texallergy.com/'
    ...
    def process_logic(self):
        try:
            url = 'https://allergy-ent-associates-p-a.prismhr-hire.com'
                ...
                if links:
                    for link in links:
                        if link.find("a") is not None:
                            ...
                            url = "https://allergy-ent-associates-p-a.prismhr-hire.com" + link.find("a").get("href")
                            jobObj['url'] = url

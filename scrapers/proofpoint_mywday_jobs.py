...
# Token
token = 'PROOFPOINT_WORKDAY_JOBS_CAREER_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.proofpoint.com'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://proofpoint.wd5.myworkdayjobs.com/wday/cxs/proofpoint/ProofpointCareers/jobs'
                ...
                if isloaded:
                    ...
                    if len(data) > 0:
                        for rd in data:
                            ...
                            url = "https://proofpoint.wd5.myworkdayjobs.com/en-US/ProofpointCareers" + str(rd['externalPath'])
                            jobObj['url'] = url

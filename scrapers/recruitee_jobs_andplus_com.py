...
# Token
token = 'RECRUITEE_CAREER_JOBS_ANDPLUS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.andplus.com'
    ...
    def process_logic(self):
        try:
            url = f'https://andplus.recruitee.com/sitemap.xml'
            print(url)
                ...
                if len(links) > 0:
                    for link in links:
                        try:
                            ...
                            if url != "https://andplus.recruitee.com":
                                isloaded, res = self.get_request(url)
                                if isloaded:
                                    jobObj['url'] = url
                                    data = BeautifulSoup(res.text, "lxml")

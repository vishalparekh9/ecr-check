...
#Token
token = '2020RESEARCH_JOBS'

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://recruiting.paylocity.com/Recruiting/Jobs/All/69039844-fa2b-44a5-aa26-2e507bd51112/Schlesinger-Central-Processing' 

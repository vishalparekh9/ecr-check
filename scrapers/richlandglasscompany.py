...
# Token
token = 'RICHLANDGLASSCOMPANY'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://recruitingbypaycor.com/career/CareerHomeSearch.action?clientId=8a7883d074274b7d01744b8e5a280ecf'
        ...
        self.getHeaders = {
            ...
            'clientId': '8a7883d074274b7d01744b8e5a280ecf',
            'parentUrl': 'https://recruitingbypaycor.com/career/',
            'gns': '',
        }
        self.session = requests.session()
        self.domain = 'richlandglass.com'
    ...
    def process_logic(self):
        try:
            url = 'https://recruitingbypaycor.com/career/CareerHomeSearch.action?clientId=8a7883d074274b7d01744b8e5a280ecf'

...
# Token
token = 'RIPCORDS_JOBS_GH'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.ripcord.com/'
    ...
    def process_logic(self):
        try:
            url = 'https://boards-api.greenhouse.io/v1/boards/ripcord/jobs'
                    ...
                    for data in res.json()["jobs"]:
                        if data:
                            try:
                                ...
                                isloaded, res = self.get_request(data['absolute_url'])

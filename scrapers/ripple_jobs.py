...
class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://boards-api.greenhouse.io/v1/boards/ripple/offices?render_as=tree' 
                ...
                for office in res.json()['offices']:
                    ...
                    for department in office['departments']:
                        ...
                        for job in department['jobs']:
                            ...
                            url = 'https://boards-api.greenhouse.io/v1/boards/ripple/jobs/' + str(job['id'])

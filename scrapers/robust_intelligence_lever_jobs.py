...
# Token
token = 'ROBUST_INTELLIGENCE_JOBS_LEVER'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.robustintelligence.com'
        ...
        self.domain = 'robustintelligence.com'
    ...
    def process_logic(self):
        try:
            url = 'https://jobs.lever.co/robustintelligence'

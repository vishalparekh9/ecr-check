...
class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://recruitingbypaycor.com/career/CareerHomeSearch.action?clientId=8a42a12b3538c68501353a3b0cad2928'
        ...
        self.getHeaders = {
            ...
            'clientId': '8a42a12b3538c68501353a3b0cad2928',
            'parentUrl': 'https://recruitingbypaycor.com/career/',
            'gns': '',
        }
        self.session = requests.session()
        self.domain = 'rotary.com'
    ...
    def process_logic(self):
        try:
            url = 'https://recruitingbypaycor.com/career/CareerHomeSearch.action?clientId=8a42a12b3538c68501353a3b0cad2928'

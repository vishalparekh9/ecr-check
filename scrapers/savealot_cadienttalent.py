...
# Token
token = 'SAVEALOT_DAYFORCEHCM_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://us61e2.dayforcehcm.com/CandidatePortal/en-US/savealot?'
        ...
        try:
            ...
            while isPage:
                ...
                isloaded, res = self.get_request(
                    f'https://us61e2.dayforcehcm.com/CandidatePortal/en-US/savealot?page={page}')
                if isloaded:
                        ...
                        for postTitle in titleDiv:
                            ...
                            if isloaded:
                                ...
                                jobObj['description'] = str(
                                    jobDetails.find_all('div', {'class': 'job-posting-section'})).replace("[", "").replace("]", "").strip()

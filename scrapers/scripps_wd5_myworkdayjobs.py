...
# Token
token = 'SCRIPPS_WORKDAY_JOBS_CAREER_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://scripps.wd5.myworkdayjobs.com/Scripps_Careers'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://scripps.wd5.myworkdayjobs.com/wday/cxs/scripps/Scripps_Careers/jobs'
                ...
                if isloaded:
                    ...
                    if len(data) > 0:
                        for rd in data:
                            ...
                            url = "https://scripps.wd5.myworkdayjobs.com/Scripps_Careers" + str(rd['externalPath'])
                            jobObj['url'] = url

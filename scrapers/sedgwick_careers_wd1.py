...
# Token
token = 'SEDGWICK_WORKDAY_JOBS_CAREER_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.sedgwick.com'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://sedgwick.wd1.myworkdayjobs.com/wday/cxs/sedgwick/Sedgwick/jobs'
                ...
                if isloaded:
                    ...
                    if len(data) > 0:
                        for rd in data:
                            ...
                            url = "https://sedgwick.wd1.myworkdayjobs.com/en-US/Sedgwick" + str(rd['externalPath'])
                            jobObj['url'] = url

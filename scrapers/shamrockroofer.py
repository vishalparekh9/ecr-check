...
# Token
token = 'SHAMROCKROOFER'

class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://shamrockroofer.bamboohr.com/jobs/embed2.php?version=1.0.0'
        ...
        self.domain = 'shamrockroofer.com'
    ...
    def process_logic(self):
        try:
            url = 'https://shamrockroofer.bamboohr.com/jobs/embed2.php?version=1.0.0'

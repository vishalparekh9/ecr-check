...
# Token
token = 'SIRIUSXM_CAREER_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://jobs.jobvite.com/siriusxm/jobs/viewall'
    ...
    def process_logic(self):
        try:
            ...
            if isloaded:
                ...
                # print(data)
                jobDataChunk = data.find('div', {'class': 'jv-job-list'})
                if jobDataChunk:

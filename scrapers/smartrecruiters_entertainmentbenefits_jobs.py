...
# Token
token = 'SMARTRECRUITERS_ENTERTAINMENTBENEFITS_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.suburl = 'EntertainmentBenefitsGroup/entertainment-benefits-group-careers-aug-2021'
        ...
        self.domain = 'entertainmentbenefits.com'

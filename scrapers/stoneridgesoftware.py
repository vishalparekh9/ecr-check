...
# Token
token = 'STONERIDGESOFTWARE'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://stoneridgesoftware.com/about-us/careers/'
        ...
        self.domain = 'stoneridgesoftware.com'
    ...
    def process_logic(self):
        try:
            url = 'https://jobs.lever.co/stoneridgesoftware'

...
# Token
token = 'SUPERIOREXECUTIVEANDLEGALRECRUITING'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'http://superiorexecutiveandlegalrecruiting.com/'
        ...
        self.domain = 'superiorexecutiveandlegalrecruiting.com'
    ...
    def process_logic(self):
        try:
            url = 'https://jobs.lever.co/superiorexecutiveandlegalrecruiting'

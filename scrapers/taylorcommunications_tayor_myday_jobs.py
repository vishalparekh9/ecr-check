...
# Token
token = 'TAYLOR_COMMUNICATIONS_WORKDAY_JOBS_CAREER_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://taylorcommunications.com'
        ...
        self.domain = 'taylorcommunications.com'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://taylor.wd1.myworkdayjobs.com/wday/cxs/taylor/External/jobs'
                ...
                if isloaded:
                    ...
                    if len(data) > 0:
                        for rd in data:
                            ...
                            url = "https://taylor.wd1.myworkdayjobs.com/en-US/External" + str(rd['externalPath'])
                            jobObj['url'] = url

...
# Token
token = 'TEAM_WORK_ONLINE_CAREER_JOBS_ANAHEIMDUCKS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.anaheimducks.com'
    ...
    def process_logic(self):
        try:
            url = f'https://www.teamworkonline.com/hockey-jobs/hockeyjobs/anaheim-ducks-hockey-club'
            print(url)

...
# Token
token = 'TEAM_WORK_ONLINE_CAREER_JOBS_G4TV'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.g4tv.com'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                page = page + 1
                url = f'https://www.teamworkonline.com/jobs-in-sports?employment_opportunity_search%5Bquery%5D=g4&commit=Search&page={page}'
                print(url)

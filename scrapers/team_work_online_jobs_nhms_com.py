...
# Token
token = 'TEAM_WORK_ONLINE_CAREER_JOBS_NHMS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.nhms.com'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                page = page + 1
                url = f'https://www.teamworkonline.com/jobs-in-sports?employment_opportunity_search%5Bquery%5D=Speedway+Motorsports%2FTexas+Motor+Speedway&commit=Search&page={page}'
                print(url)

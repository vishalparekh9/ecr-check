...
# Token
token = 'TEAM_WORK_ONLINE_CAREER_JOBS_TEAMWORKONLINE'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.teamworkonline.com'
        ...
        self.domain = 'teamworkonline.com'
    ...
    def process_logic(self):
        try:
            url = f'https://www.teamworkonline.com/baseball-jobs/gsg/greenberg-sports-group'
            print(url)

...
# Token
token = 'TEDSBULLETIN_JOBS_EFFICIENTAPPLY'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.tedsbulletin.com'
    ...
    def process_logic(self):
        try:
            url = f'https://tedsbulletin.efficientapply.com/jobs/'
            print(url)

...
# Token
token = 'THEEXTERIORCOMPANY'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://theexteriorcompany.com/company/locations/lancaster-roofing/'
        ...
        self.domain = 'theexteriorcompany.com'
    ...
    def process_logic(self):
        try:
            url = 'https://jobs.lever.co/theexteriorcompany'

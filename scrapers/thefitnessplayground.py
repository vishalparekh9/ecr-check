...
# Token
token = 'THEFITNESSPLAYGROUND'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'http://www.thefitnessplayground.com.au'
        ...
        self.domain = 'thefitnessplayground.com.au'
    ...
    def process_logic(self):
        try:
            url = 'https://jobs.lever.co/thefitnessplayground'

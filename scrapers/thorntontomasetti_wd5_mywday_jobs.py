...
# Token
token = 'THORNTONTO_MASETTI_WORKDAY_JOBS_CAREER_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://tt.wd5.myworkdayjobs.com/ThorntonTomasetti'
        ...
        self.domain = 'thorntontomasetti.com'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://tt.wd5.myworkdayjobs.com/wday/cxs/tt/ThorntonTomasetti/jobs'
                ...
                if isloaded:
                    ...
                    if len(data) > 0:
                        for rd in data:
                            ...
                            url = "https://tt.wd5.myworkdayjobs.com/ThorntonTomasetti" + str(rd['externalPath'])
                            jobObj['url'] = url

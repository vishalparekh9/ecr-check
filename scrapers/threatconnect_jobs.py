...
token = 'THREATCONNECT_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://apply.workable.com/threatconnect/'
        ...
        try:
            ...
            if isloaded:
                ...
                while isdata:
                    ...
                    url = 'https://apply.workable.com/api/v3/accounts/threatconnect/jobs'
                    params = '{"token":"' + str(
                    ...
                    if isloaded:
                        ...
                        for link in links:
                            ...
                            try:
                                jobObj['url'] = 'https://apply.workable.com/threatconnect/j/' + str(link['shortcode']) + '/'
                                jobObj['title'] = link['title']
                                jobObj['location'] = link['location']['city'] + ', ' + link['location']['region']
                                url = 'https://apply.workable.com/api/v2/accounts/threatconnect/jobs/' + str(
                                    link['shortcode'])

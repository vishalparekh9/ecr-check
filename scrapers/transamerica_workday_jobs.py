...
# Token
token = 'TRANS_AMERICA_WORKDAY_JOBS_CAREER_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.transamerica.com'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = 'https://transamerica.wd5.myworkdayjobs.com/wday/cxs/transamerica/US/jobs'
                ...
                if isloaded:
                    ...
                    if len(data) > 0:
                        for rd in data:
                            ...
                            url = "https://transamerica.wd5.myworkdayjobs.com/en-US/US" + str(rd['externalPath'])
                            print(url)
                            jobObj['url'] = url

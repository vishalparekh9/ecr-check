...
# Token
token = 'JOB_BOARD_TRINETHIRE_ATRIS_CAREER_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://atris.com/'
    ...
    def process_logic(self):
        try:
            url = 'https://app.trinethire.com/companies/21159-atris-technology-llc/jobs'

...
# Token
token = 'JOB_BOARD_TRINETHIRE_AUDITANALYTICS_CAREER_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://auditanalytics.com/'
        ...
        self.domain = 'auditanalytics.com'
    ...
    def process_logic(self):
        try:
            url = 'https://app.trinethire.com/companies/14663-ives-group-inc/jobs'

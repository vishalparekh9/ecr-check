...
# Token
token = 'JOB_BOARD_TRINETHIRE_BIOMERICA_CAREER_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://biomerica.com/'
    ...
    def process_logic(self):
        try:
            url = 'https://app.trinethire.com/companies/35097-biomerica-inc/jobs'

...
# Token
token = 'JOB_BOARD_TRINETHIRE_CREDITNINJA_CAREER_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://creditninja.com/'
    ...
    def process_logic(self):
        try:
            url = 'https://app.trinethire.com/companies/30425-creditninja/jobs'

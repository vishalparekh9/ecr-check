...
# Token
token = 'JOB_BOARD_TRINETHIRE_ENSEO_CAREER_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://enseo.com/'
    ...
    def process_logic(self):
        try:
            url = 'https://app.trinethire.com/companies/30364-enseo-inc/jobs/49007-enterprise-systems-administrator'

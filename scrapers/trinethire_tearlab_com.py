...
# Token
token = 'JOB_BOARD_TRINETHIRE_TEARLAB_CAREER_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://tearlab.com/'
    ...
    def process_logic(self):
        try:
            url = 'https://app.trinethire.com/companies/32066-tearlab-corporation/jobs'

...
# Token
token = 'UNIVERSALENGINEERINGSCIENCES'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://universalengineering.com/'
        ...
        self.domain = 'universalengineering.com'
    ...
    def process_logic(self):
        try:
            url = 'https://jobs.lever.co/universalengineeringsciences'

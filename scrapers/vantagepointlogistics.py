...
# Token
token = 'VANTAGEPOINTLOGISTICS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.vantagepointlogistics.com/'
        ...
        self.domain = 'vantagepointlogistics.com'
    ...
    def process_logic(self):
        try:
            url = 'https://jobs.lever.co/vantagepointlogistics'

...
# Token
token = 'VIACOM_CBS_SPORTS_NETWORK_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://cbssportsnetwork.com'
        ...
        self.domain = 'cbssportsnetwork.com'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                page = page + 25
                url = 'https://careers.viacomcbs.com/tile-search-results/category/8716000/&startrow=' + str(
                    page) + ''

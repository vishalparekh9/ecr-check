...
class CRAWLER(object):
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                page = page + 25
                url = 'https://careers.viacomcbs.com/tile-search-results/?q=&sortColumn=referencedate&sortDirection=desc&startrow=' + str(
                    page) + ''

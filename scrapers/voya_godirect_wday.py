...
# Token
token = 'VOYA_GODIRECT_JOBS_WORKDAY_JOBS_CAREER_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://godirect.wd5.myworkdayjobs.com/voya_jobs'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://godirect.wd5.myworkdayjobs.com/wday/cxs/godirect/voya_jobs/jobs'
                ...
                if isloaded:
                    ...
                    if len(data) > 0:
                        for rd in data:
                            ...
                            url = "https://godirect.wd5.myworkdayjobs.com/voya_jobs" + str(rd['externalPath'])
                            jobObj['url'] = url

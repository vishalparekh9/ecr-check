...
# Token
token = 'WALLICK_DAYFORCEHCM_CAREER_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://us61e2.dayforcehcm.com/CandidatePortal/en-US/wallick?'
        ...
        try:
            ...
            while isPage:
                ...
                isloaded, res = self.get_request(
                    f'https://us61e2.dayforcehcm.com/CandidatePortal/en-US/wallick?page={page}')
                if isloaded:
                        ...
                        for postTitle in titleDiv:
                            ...
                            if isloaded:
                                ...
                                jobObj['description'] = str(
                                    jobDetails.find_all('div', {'class': 'job-posting-section'})[0])

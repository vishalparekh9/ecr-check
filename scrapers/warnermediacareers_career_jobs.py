...
# Token
token = 'WARNERMEDIACAREERS_WORKDAY_JOBS_CAREER_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://warnermediacareers.com'
        ...
        self.domain = 'warnermediacareers.com'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://warnerbros.wd5.myworkdayjobs.com/wday/cxs/warnerbros/global/jobs'
                ...
                if isloaded:
                    ...
                    if len(data) > 0:
                        for rd in data:
                            ...
                            url = "https://warnerbros.wd5.myworkdayjobs.com/en-US/global" + str(rd['externalPath'])
                            jobObj['url'] = url

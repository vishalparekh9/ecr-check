...
# Token
token = 'WEFLORIDA_FINANCIAL_ADP_CAREER_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.wefloridafinancial.com'
        ...
        self.domain = 'wefloridafinancial.com'
    ...
    def process_logic(self):
        try:
            jobid = ""
            cid = '44b93167-8481-4636-9879-0bcd69483336'

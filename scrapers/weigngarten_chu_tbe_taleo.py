...
# Token
token = 'WEINGARTEN_TALEO'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://weingarten.com'
    ...
    def process_logic(self):
        try:
            url = 'https://chu.tbe.taleo.net/chu01/ats/careers/v2/searchResults?org=WEINGARTEN&cws=38'

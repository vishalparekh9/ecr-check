...
# Token
token = 'CAREERS_WESTERNSOUTHERN_ICIMS_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://careers-westernsouthern.icims.com/jobs/search?ss=1&hashed=-435653992'
        ...
        self.domain = 'westernsouthern.com'
    ...
    def process_logic(self):
        try:
            url = 'https://careers-westernsouthern.icims.com/jobs/search?pr=1&in_iframe=1'

...
# Token
token = 'JOBS_SELECTMINDS_COM_WFCAREERS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://wfcareers.referrals.selectminds.com/jobs'
    ...
    def process_logic(self):
        try:
            url = f'https://wfcareers.referrals.selectminds.com/jobs'

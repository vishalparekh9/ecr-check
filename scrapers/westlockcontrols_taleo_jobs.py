...
# Token
token = 'WESTLOCKCONTROLS_TALEO'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://westlockcontrols.com'
        ...
        self.domain = 'westlockcontrols.com'
    ...
    def process_logic(self):
        try:
            url = 'https://phf.tbe.taleo.net/phf01/ats/careers/v2/searchResults?org=CRANEAE&cws=53'

...
# Token
token = 'ADP_WEST_STAR_AVIATION_CARRIERS_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://recruiting.adp.com/srccar/public/RTI.home?c=1177415&d=WSACareerSiteEXT#/'
        ...
        self.domain = 'westerncarriers.com'
    ...
    def post_request(self, page):
        try:
            url = 'https://recruiting.adp.com/srccar/public/rest/1/1429515/search/'

...
# Token
token = 'WILLIAMSBURGLEARNING'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.williamsburglearning.com/'
        ...
        self.domain = 'williamsburglearning.com'
    ...
    def process_logic(self):
        try:
            url = 'https://jobs.lever.co/williamsburglearning'

...
# Token
token = 'WINNER_AVIATION_PAYCOR'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://winner-aviation.com/careers/'
        ...
        self.getHeaders = {
            ...
            'clientId': '8a7883d0688e28aa01689fcfa864029e',
            'parentUrl': 'https://www.aauw.org/about/careers/',
            'gns': '',
        }
        self.session = requests.session()
        self.domain = 'winner-aviation.com'
        self.allJobs = []
    ...
    def process_logic(self):
        try:
            jobid = ""
            url = 'https://recruitingbypaycor.com/career/CareerHome.action?clientId=8a7883d0688e28aa01689fcfa864029e&parentUrl=https://winner-aviation.com/careers/&gns='

...
# Token
token = 'WISTAR_DAY_FORCE_HCM_CAREER_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://us62e2.dayforcehcm.com/CandidatePortal/en-US/Wistar?'
        ...
        try:
            ...
            while isPage:
                ...
                isloaded, res = self.get_request(
                    f'https://us62e2.dayforcehcm.com/CandidatePortal/en-US/Wistar?page={page}')
                if isloaded:
                    ...
                    if jobDataChunk:
                        ...
                        for postTitle in titleDiv:
                            ...
                            token = aTag.get('href')
                            url = 'https://us62e2.dayforcehcm.com' + str(token)
                            jobObj['url'] = url

...
token = 'WITHIN_THREE_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://apply.workable.com/within3/'
        ...
        try:
            ...
            if isloaded:
                ...
                while True:
                    ...
                    url = 'https://apply.workable.com/api/v3/accounts/within3/jobs'
                    params = '{"token":"' + str(
                    ...
                    if isloaded:
                        ...
                        for link in links:
                            ...
                            jobObj['url'] = 'https://apply.workable.com/within3/j/' + str(link['shortcode']) + '/'
                            jobObj['title'] = link['title']
                            jobObj['location'] = link['location']['city'] + ', ' + link['location']['region']
                            url = 'https://apply.workable.com/api/v2/accounts/within3/jobs/' + str(link['shortcode'])

...
# Token
token = 'WK_WORKDAY_JOBS_CAREER_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.wolterskluwer.com'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://wk.wd3.myworkdayjobs.com/wday/cxs/wk/External/jobs'
                ...
                if isloaded:
                    ...
                    if len(data) > 0:
                        for rd in data:
                            ...
                            url = "https://wk.wd3.myworkdayjobs.com/en-US/External" + str(rd['externalPath'])
                            jobObj['url'] = url
                            ...
                            if isloaded:
                                try:
                                    ...
                                    if jobObj['title'] != '' and jobObj['url'] != '':
                                        ...
                                        print(jobObj)
                                except (Exception, KeyError, IndexError, AttributeError, ValueError) as ex:
                                    pass
                    else:
                        print("No Jobs")
                        isPage = False

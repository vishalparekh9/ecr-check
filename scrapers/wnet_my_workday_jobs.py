...
# Token
token = 'WNET_WORKDAY_JOBS_CAREER_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.wnet.org'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://wnet.wd1.myworkdayjobs.com/wday/cxs/wnet/WNETCareers/jobs'
                ...
                if isloaded:
                    ...
                    if len(data) > 0:
                        for rd in data:
                            ...
                            url = "https://wnet.wd1.myworkdayjobs.com/en-US/WNETCareers" + str(rd['externalPath'])
                            jobObj['url'] = url

...
# Token
token = 'WOLFEINC_OUR_CAREER_PAGES'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://wolfeinc.ourcareerpages.com/WebServices/ccp_jobs.aspx?AutoGenerate=yes&GroupBy=&CCPCode=ClearVisionOptical&InAccountID=0&ElementID=BDHRJobListingsCustom&JobOrderBy='
            ...
            if isloaded:
                ...
                for link in jsn['CategoryList']:
                    ...
                    for job in link['JobList']:
                        ...
                        url = 'https://wolfeinc.ourcareerpages.com/job/' + str(job['ID'])
                        jobObj['url'] = url

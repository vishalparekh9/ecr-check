...
# Token
token = 'WOLFSPEED_WORKDAY_JOBS_CAREER_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.wolfspeed.com'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://cree.wd5.myworkdayjobs.com/wday/cxs/cree/EXT/jobs'
                ...
                if isloaded:
                    ...
                    if len(data) > 0:
                        for rd in data:
                            ...
                            url = "https://cree.wd5.myworkdayjobs.com/en-US/EXT" + str(rd['externalPath'])
                            jobObj['url'] = url

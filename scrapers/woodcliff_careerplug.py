...
# Token
token = 'WWH_WOODCLIFF_CAREER_PLUG_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://wwh-woodcliff.careerplug.com/jobs#job_filters'
        ...
        try:
            ...
            if isloaded:
                ...
                for link in aTag:
                    ...
                    jobUrl = 'https://wwh-woodcliff.careerplug.com' + str(tokens)
                    jobObj['url'] = jobUrl

...
# Token
token = 'WORKFORCE_ADP_HIGHLIGHTS_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'http://www.zaner-bloser.com'
    ...
    def process_logic(self):
        try:
            jobid = ""
            cid = '4a8a08f1-ff6c-4d60-8308-4b09a199dd38'
            ...
            if isloaded:
                for data in res.json()['jobRequisitions']:
                    ...
                    if isloaded:
                        ...
                        jobObj[
                            'url'] = f"https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid={cid}&ccId={icids}&jobId={jobid}&lang=en_US&source=LI"

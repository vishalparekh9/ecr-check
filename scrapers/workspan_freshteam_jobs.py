...
# Token
token = 'FRESHTEAM_WORKSPAN_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'http://workspan.com'
    ...
    def process_logic(self):
        try:
            url = f'https://workspan.freshteam.com/jobs'
            print(url)
                ...
                if len(links) > 0:
                    for link in links:
                        try:
                            ...
                            url = f"https://workspan.freshteam.com" + str(link.get("href"))

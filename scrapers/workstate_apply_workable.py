...
token = 'WORKABLE_WORKSTATE_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.site_name = 'workstate'
                ...
                while True:
                    ...
                    if isloaded:
                        ...
                        for link in links:
                            ...
                            jobObj['url'] = 'https://apply.workable.com/' + self.site_name + '/j/' + str(
                                link['shortcode']) + '/'
                            jobObj['title'] = link['title']
                            jobObj['location'] = link['location']['city'] + ', ' + link['location']['region']
                            url = 'https://apply.workable.com/api/v2/accounts/' + self.site_name + '/jobs/' + str(
                                link['shortcode'])

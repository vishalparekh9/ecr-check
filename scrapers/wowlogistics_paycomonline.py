...
# Token
token = 'WOW_LOGISTICS_PAYCOMONLINE'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.wowlogistics.com'
    ...
    def process_logic(self):
        try:
            url = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=2D0F56FDBBE41A872F7F6F61A2870DF3#'

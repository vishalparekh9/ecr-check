...
class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://wpengine.wd1.myworkdayjobs.com/WP_Engine'
    ...
    def process_logic(self):
        try:
            ...
            oldurl = ''
            while isdata:
                isloaded, res = self.post_request('https://wpengine.wd1.myworkdayjobs.com/wday/cxs/wpengine/WP_Engine/jobs',
                                                  page)
                page = page + 20
                ...
                for obj in objs:
                    try:
                        ...
                        url = 'https://wpengine.wd1.myworkdayjobs.com/wday/cxs/wpengine/WP_Engine' + obj['externalPath']
                        jobObj['url'] = 'https://wpengine.wd1.myworkdayjobs.com/en-US/WP_Engine' + obj['externalPath']

...
token = 'MYWORKDAYSJOB_WYNDHAMCAPITAL_CAREER_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://wyndhamcapital.wd1.myworkdayjobs.com/wyndhamcapitalcareers'
        ...
        self.domain = 'wyndhamcapital.com'
                    ...
                    if 'listItems' in res.json()['body']['children'][0]['children'][0]:
                        ...
                        for link in lis:
                            ...
                            try:
                                ...
                                jobObj['description'] = jobDetails.find("meta", {"property": "og:description"}).get("content")

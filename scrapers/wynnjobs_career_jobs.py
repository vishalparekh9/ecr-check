...
# Token
token = 'WYNNJOBS_CAREER_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://wynnjobs.com'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                page = page + 1
                url = f'https://www.wynnjobs.com/en-US/Page/it?pagenumber={page}'
                    ...
                    if len(links) > 0:
                        for link in links:
                            if link.find('a') is not None:
                                ...
                                url = "https://www.wynnjobs.com" + link.find('a').get('href')
                                jobObj['url'] = url

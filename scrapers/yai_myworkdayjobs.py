...
# Token
token = 'YAI_WORKDAY_JOBS_CAREER_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://yai.org'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://yai.wd5.myworkdayjobs.com/wday/cxs/yai/Careers/jobs'
                ...
                if isloaded:
                    ...
                    if len(data) > 0:
                        for rd in data:
                            ...
                            url = "https://yai.wd5.myworkdayjobs.com/en-US/Careers" + str(rd['externalPath'])
                            jobObj['url'] = url

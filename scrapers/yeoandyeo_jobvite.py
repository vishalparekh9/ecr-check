...
# Token
token = 'YEOANDYEO_CAREER_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://jobs.jobvite.com/yeoandyeo/?nl=1&fr=false'
    ...
    def process_logic(self):
        try:
            ...
            if isloaded:
                ...
                # print(data)
                jobDataChunk = data.find('table', {'class': 'jv-job-list'})
                if jobDataChunk:
                    ...
                    for link in aTag:
                        ...
                        if isloaded:
                            ...
                            for loc in jobDetails.find('p', {'class': 'jv-job-detail-meta'}).text.split('\n')[2:]:
                                if loc:
                                    jobObj['location'] += loc.replace('\n', '').strip() + " "

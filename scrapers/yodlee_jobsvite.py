...
# Token
token = 'YODLEE_JOBSVITE'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://jobs.jobvite.com/yodlee/search?l=&c=&t=&q='
    ...
    def process_logic(self):
        try:
            ...
            if isloaded:
                ...
                jobDataChunk = data.find('table', {'class': 'jv-job-list jv-search-list'}).find_all('a')

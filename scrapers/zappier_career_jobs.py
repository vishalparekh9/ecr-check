...
# Token
token = 'ZAPIER_CAREERS_GH'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.zapier.com/'
                    ...
                    for data in res.json()["jobs"]:
                        if data:
                            ...
                            if 'gh_jid=' in str(url):
                                isloaded, res = self.get_request(f'https://boards.greenhouse.io/embed/job_app?for=zapier&token={url.split("gh_jid=")[1]}')
                                if isloaded:
                                ...
                                isloaded, res = self.get_request(f'https://boards.greenhouse.io/embed/job_app?for=zapier&token={url.split("/jobs/")[1]}')

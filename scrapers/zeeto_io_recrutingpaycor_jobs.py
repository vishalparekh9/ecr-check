...
# Token
token = 'ZEETO_IO_RECRUTING_PAYCOR_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://recruitingbypaycor.com/career/CareerHomeSearch.action?clientId=8a7883c66005ecf00160143db18c0e11'
        ...
        self.getHeaders = {
            ...
            'clientId': '8a7883c66005ecf00160143db18c0e11',
            'parentUrl': 'https://recruitingbypaycor.com/career/',
            'gns': '',
        }
        self.session = requests.session()
        self.domain = 'zeeto.io'
    ...
    def process_logic(self):
        try:
            url = 'https://recruitingbypaycor.com/career/CareerHomeSearch.action?clientId=8a7883c66005ecf00160143db18c0e11'

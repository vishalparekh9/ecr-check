...
# Token
token = 'ZELIS_WORKDAY_JOBS_CAREER_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.zelis.com'
    ...
    def process_logic(self):
        try:
            ...
            while isPage:
                ...
                url = f'https://zelis.wd1.myworkdayjobs.com/wday/cxs/zelis/ZelisCareers/jobs'
                ...
                if isloaded:
                    ...
                    if len(data) > 0:
                        for rd in data:
                            ...
                            url = "https://zelis.wd1.myworkdayjobs.com/en-US/ZelisCareers" + str(rd['externalPath'])
                            jobObj['url'] = url

...
# Token
token = 'ZERO_CARTER_JOBS_GH'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://www.zerocater.com/'
    ...
    def process_logic(self):
        try:
            url = 'https://boards-api.greenhouse.io/v1/boards/zerocater/jobs'
                    ...
                    for data in res.json()["jobs"]:
                        if data:
                            ...
                            if 'gh_jid=' in str(url):
                                isloaded, res = self.get_request('https://boards.greenhouse.io/embed/job_app?for=zerocater&token='+str(url).split('gh_jid=')[1]+'')

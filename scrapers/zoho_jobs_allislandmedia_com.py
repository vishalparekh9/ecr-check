...
# Token
token = 'ALLISLANDMEDIA_ZOHO_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://allislandmedia.zohorecruit.com/careers'
        ...
        self.domain = 'allislandmedia.com'
        ...
        try:
            ...
            if isloaded:
                ...
                for link in links:
                    ...
                    url = "https://allislandmedia.zohorecruit.com" + str(link.find("a", {"class": "jobdetail"}).get("href"))
                    jobObj['url'] = url

...
# Token
token = 'BLUERIVERPETCARE_ZOHO_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://brplp.zohorecruit.com/careers'
        ...
        self.domain = 'blueriverpetcare.com'
        ...
        try:
            ...
            if isloaded:
                ...
                for link in links:
                    ...
                    url = "https://brplp.zohorecruit.com" + str(link.find("a", {"class": "jobdetail"}).get("href"))
                    jobObj['url'] = url

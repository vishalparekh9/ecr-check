...
# Token
token = 'CLEANAIR_ZOHO_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://cleanair.zohorecruit.com/careers'
        ...
        try:
            ...
            if isloaded:
                ...
                for link in links:
                    ...
                    url = "https://cleanair.zohorecruit.com" + str(link.find("a", {"class": "jobdetail"}).get("href"))
                    jobObj['url'] = url

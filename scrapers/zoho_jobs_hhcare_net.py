...
# Token
token = 'HHCARE_ZOHO_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://hhcare.zohorecruit.com/careers'
        ...
        try:
            ...
            if isloaded:
                ...
                for link in links:
                    ...
                    url = "https://hhcare.zohorecruit.com" + str(link.find("a", {"class": "jobdetail"}).get("href"))
                    jobObj['url'] = url

...
# Token
token = 'WORKPLACEOPTIONS_ZOHO_JOBS'


class CRAWLER(object):
    def __init__(self):
        self.baseUrl = 'https://workplaceoptions.zohorecruit.com/careers'
        ...
        self.domain = 'workplaceoptions.com'
        ...
        try:
            ...
            if isloaded:
                ...
                for link in links:
                    ...
                    url = "https://workplaceoptions.zohorecruit.com" + str(link.find("a", {"class": "jobdetail"}).get("href"))
                    jobObj['url'] = url
